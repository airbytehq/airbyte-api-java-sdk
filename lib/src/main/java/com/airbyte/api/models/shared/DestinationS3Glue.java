...
public class DestinationS3Glue {
    ...
    @JsonProperty("airbyte-destination-name")public DestinationS3GlueS3GlueEnum airbyteDestinationName;
     ...
     */
    @JsonProperty("glue_database")public String glueDatabase;
     ...
     */
    @JsonProperty("glue_serialization_library")public DestinationS3GlueSerializationLibraryEnum glueSerializationLibrary;
     ...
     */
    @JsonProperty("s3_bucket_region")public DestinationS3GlueS3BucketRegionEnum s3BucketRegion;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("s3_endpoint")public String s3Endpoint;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("s3_path_format")public String s3PathFormat;
