...
/**
 * DestinationOracleTunnelMethodSSHKeyAuthentication - Whether to initiate an SSH tunnel before connecting to the database, and if so, which kind of authentication to use.
 */
public class DestinationOracleTunnelMethodSSHKeyAuthentication {
     ...
     */
    @JsonProperty("tunnel_method")public DestinationOracleTunnelMethodSSHKeyAuthenticationTunnelMethodEnum tunnelMethod;
