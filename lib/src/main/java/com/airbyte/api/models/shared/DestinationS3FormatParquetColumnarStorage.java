...
public class DestinationS3FormatParquetColumnarStorage {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("compression_codec")public DestinationS3FormatParquetColumnarStorageCompressionCodecEnum compressionCodec;
    ...
    @JsonProperty("format_type")public DestinationS3FormatParquetColumnarStorageFormatTypeEnum formatType;
