 ...
 */
public enum SourceMssqlReplicationMethodLogicalReplicationCDCDataToSync {
    ...
    private SourceMssqlReplicationMethodLogicalReplicationCDCDataToSync(String value) {
        this.value = value;
    }
}
