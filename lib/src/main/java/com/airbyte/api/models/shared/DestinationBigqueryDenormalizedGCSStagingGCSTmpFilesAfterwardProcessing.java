 ...
 */
public enum DestinationBigqueryDenormalizedGCSStagingGCSTmpFilesAfterwardProcessing {
    ...
    private DestinationBigqueryDenormalizedGCSStagingGCSTmpFilesAfterwardProcessing(String value) {
        this.value = value;
    }
}
