...
public class SourceS3FormatJsonl {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("filetype")public SourceS3FormatJsonlFiletypeEnum filetype;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("unexpected_field_behavior")public SourceS3FormatJsonlUnexpectedFieldBehaviorEnum unexpectedFieldBehavior;
