...
public class SourceNetsuite {
    @JsonProperty("airbyte-source-name")public SourceNetsuiteNetsuiteEnum airbyteSourceName;
     ...
     */
    @JsonProperty("consumer_secret")public String consumerSecret;
    ...
    @JsonProperty("object_types")public String[] objectTypes;
     ...
     */
    @JsonProperty("realm")public String realm;
     ...
     */
    @JsonProperty("start_datetime")public String startDatetime;
     ...
     * Access token key
     */
    @JsonProperty("token_key")public String tokenKey;
     ...
     * Access token secret
     */
    @JsonProperty("token_secret")public String tokenSecret;
