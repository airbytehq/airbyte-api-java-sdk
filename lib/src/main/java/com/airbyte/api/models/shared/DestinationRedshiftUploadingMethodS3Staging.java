...
public class DestinationRedshiftUploadingMethodS3Staging {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("file_buffer_count")public Long fileBufferCount;
    ...
    @JsonProperty("method")public DestinationRedshiftUploadingMethodS3StagingMethodEnum method;
     ...
     */
    @JsonProperty("s3_bucket_region")public DestinationRedshiftUploadingMethodS3StagingS3BucketRegionEnum s3BucketRegion;
