...
public class SourceAlloydbTunnelMethodSSHKeyAuthentication {
    ...
    public SourceAlloydbTunnelMethodSSHKeyAuthenticationTunnelMethod tunnelMethod;

    public SourceAlloydbTunnelMethodSSHKeyAuthentication withTunnelMethod(SourceAlloydbTunnelMethodSSHKeyAuthenticationTunnelMethod tunnelMethod) {
    ...
    public SourceAlloydbTunnelMethodSSHKeyAuthentication(@JsonProperty("ssh_key") String sshKey, @JsonProperty("tunnel_host") String tunnelHost, @JsonProperty("tunnel_method") SourceAlloydbTunnelMethodSSHKeyAuthenticationTunnelMethod tunnelMethod, @JsonProperty("tunnel_user") String tunnelUser) {
        this.sshKey = sshKey;
        this.tunnelHost = tunnelHost;
        this.tunnelMethod = tunnelMethod;
        this.tunnelUser = tunnelUser;
