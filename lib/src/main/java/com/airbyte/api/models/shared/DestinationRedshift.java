...
public class DestinationRedshift {
    @JsonProperty("airbyte-destination-name")public DestinationRedshiftRedshiftEnum airbyteDestinationName;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("uploading_method")public Object uploadingMethod;
