...
public class SourceOrb {
    @JsonProperty("airbyte-source-name")public SourceOrbOrbEnum airbyteSourceName;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("numeric_event_properties_keys")public String[] numericEventPropertiesKeys;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("string_event_properties_keys")public String[] stringEventPropertiesKeys;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("subscription_usage_grouping_key")public String subscriptionUsageGroupingKey;
