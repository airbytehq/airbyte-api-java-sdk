...
public class SourceQuickbooksOAuth20 {
    ...
    public SourceQuickbooksOAuth20AuthType authType;

    public SourceQuickbooksOAuth20 withAuthType(SourceQuickbooksOAuth20AuthType authType) {
