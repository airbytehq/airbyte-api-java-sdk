...
public class SourceExchangeRates {
    ...
    @JsonProperty("airbyte-source-name")public SourceExchangeRatesExchangeRatesEnum airbyteSourceName;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("ignore_weekends")public Boolean ignoreWeekends;
