...
public class DestinationMysqlTunnelMethodSSHKeyAuthentication {
    ...
    public DestinationMysqlTunnelMethodSSHKeyAuthenticationTunnelMethod tunnelMethod;

    public DestinationMysqlTunnelMethodSSHKeyAuthentication withTunnelMethod(DestinationMysqlTunnelMethodSSHKeyAuthenticationTunnelMethod tunnelMethod) {
    ...
    public DestinationMysqlTunnelMethodSSHKeyAuthentication(@JsonProperty("ssh_key") String sshKey, @JsonProperty("tunnel_host") String tunnelHost, @JsonProperty("tunnel_method") DestinationMysqlTunnelMethodSSHKeyAuthenticationTunnelMethod tunnelMethod, @JsonProperty("tunnel_user") String tunnelUser) {
        this.sshKey = sshKey;
        this.tunnelHost = tunnelHost;
        this.tunnelMethod = tunnelMethod;
        this.tunnelUser = tunnelUser;
