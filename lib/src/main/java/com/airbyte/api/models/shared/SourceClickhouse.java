...
public class SourceClickhouse {
    ...
    public SourceClickhouse(@JsonProperty("database") String database, @JsonProperty("host") String host, @JsonProperty("sourceType") SourceClickhouseClickhouse sourceType, @JsonProperty("username") String username) {
        this.database = database;
        this.host = host;
        this.sourceType = sourceType;
        this.username = username;
