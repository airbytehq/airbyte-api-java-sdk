...
public class DestinationS3FormatCSVCommaSeparatedValues {
     ...
     */
    @JsonProperty("flattening")public DestinationS3FormatCSVCommaSeparatedValuesFlatteningEnum flattening;
    ...
    @JsonProperty("format_type")public DestinationS3FormatCSVCommaSeparatedValuesFormatTypeEnum formatType;
