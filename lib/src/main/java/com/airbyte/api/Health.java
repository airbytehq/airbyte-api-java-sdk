...
public class Health {
     ...
     */
    public com.airbyte.api.models.operations.GetHealthCheckResponse getHealthCheck() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.airbyte.api.models.operations.GetHealthCheckResponse getHealthCheck(String serverURL) throws Exception {
        String baseUrl = GET_HEALTH_CHECK_SERVERS[0];
        if (serverURL != null && !serverURL.isBlank()) {
            baseUrl = serverURL;
        }
        
        String url = com.airbyte.api.utils.Utils.generateURL(baseUrl, "/health");
        ...
        com.airbyte.api.models.operations.GetHealthCheckResponse res = new com.airbyte.api.models.operations.GetHealthCheckResponse() {{
        }};
