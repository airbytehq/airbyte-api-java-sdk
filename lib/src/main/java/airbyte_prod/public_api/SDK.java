...
public class SDK {
	...
	public static class Builder {
		...
		private airbyte_prod.public_api.models.shared.Security security;
		 ...
		 * @return The builder instance.
		 */
		public Builder setSecurity(airbyte_prod.public_api.models.shared.Security security) {
	...
	private SDK(HTTPClient client, airbyte_prod.public_api.models.shared.Security security, String serverUrl, java.util.Map<String, String> params) throws Exception {
		...
		if (security != null) {
			...
			this._securityClient = airbyte_prod.public_api.utils.Utils.configureSecurityClient(this._defaultClient, this._security);
		}
		...
		if (serverUrl != null && !serverUrl.isBlank()) {
			this._serverUrl = airbyte_prod.public_api.utils.Utils.templateUrl(serverUrl, params);
		}
