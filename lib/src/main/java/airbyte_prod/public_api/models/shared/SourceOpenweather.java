...
public class SourceOpenweather {
    @JsonProperty("airbyte-source-name")public SourceOpenweatherOpenweatherEnum airbyteSourceName;
    ...
    @JsonProperty("lang")public SourceOpenweatherLanguageEnum lang;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("units")public SourceOpenweatherUnitsEnum units;
