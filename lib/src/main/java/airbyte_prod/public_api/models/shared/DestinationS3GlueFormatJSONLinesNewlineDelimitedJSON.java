...
public class DestinationS3GlueFormatJSONLinesNewlineDelimitedJSON {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("flatten_data")public Boolean flattenData;
    ...
    @JsonProperty("format_type")public DestinationS3GlueFormatJSONLinesNewlineDelimitedJSONFormatTypeEnum formatType;
