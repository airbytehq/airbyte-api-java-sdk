...
public class SourceAmazonAds {
    @JsonProperty("airbyte-source-name")public SourceAmazonAdsAmazonAdsEnum airbyteSourceName;
    ...
    @JsonProperty("auth_type")public SourceAmazonAdsAuthTypeEnum authType;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("look_back_window")public Long lookBackWindow;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("profiles")public Long[] profiles;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("region")public SourceAmazonAdsRegionEnum region;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("state_filter")public SourceAmazonAdsStateFilterEnum[] stateFilter;
