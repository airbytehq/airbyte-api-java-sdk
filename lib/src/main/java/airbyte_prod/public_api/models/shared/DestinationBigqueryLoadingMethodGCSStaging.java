...
public class DestinationBigqueryLoadingMethodGCSStaging {
    ...
    @JsonProperty("keep_files_in_gcs-bucket")public DestinationBigqueryLoadingMethodGCSStagingGCSTmpFilesAfterwardProcessingEnum keepFilesInGcsBucket;
    ...
    @JsonProperty("method")public DestinationBigqueryLoadingMethodGCSStagingMethodEnum method;
