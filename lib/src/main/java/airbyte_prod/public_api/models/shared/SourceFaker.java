...
public class SourceFaker {
    @JsonProperty("airbyte-source-name")public SourceFakerFakerEnum airbyteSourceName;
    ...
    @JsonProperty("parallelism")public Long parallelism;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("records_per_slice")public Long recordsPerSlice;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("records_per_sync")public Long recordsPerSync;
