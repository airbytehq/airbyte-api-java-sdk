...
public class SourceGoogleAds {
    @JsonProperty("airbyte-source-name")public SourceGoogleAdsGoogleAdsEnum airbyteSourceName;
    ...
    @JsonProperty("conversion_window_days")public Long conversionWindowDays;
    public SourceGoogleAds withConversionWindowDays(Long conversionWindowDays) {
        this.conversionWindowDays = conversionWindowDays;
        return this;
    }
    
    @JsonProperty("credentials")public SourceGoogleAdsGoogleCredentials credentials;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("custom_queries")public SourceGoogleAdsCustomQueries[] customQueries;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("login_customer_id")public String loginCustomerId;
