...
public class SourceTiktokMarketing {
    @JsonProperty("airbyte-source-name")public SourceTiktokMarketingTiktokMarketingEnum airbyteSourceName;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("report_granularity")public SourceTiktokMarketingReportAggregationGranularityEnum reportGranularity;
