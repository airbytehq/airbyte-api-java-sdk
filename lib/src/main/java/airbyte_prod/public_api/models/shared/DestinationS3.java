...
public class DestinationS3 {
    ...
    @JsonProperty("airbyte-destination-name")public DestinationS3S3Enum airbyteDestinationName;
     ...
     */
    @JsonProperty("s3_bucket_region")public DestinationS3S3BucketRegionEnum s3BucketRegion;
