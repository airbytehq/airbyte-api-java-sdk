...
public class DestinationAzureBlobStorageFormatCSVCommaSeparatedValues {
     ...
     */
    @JsonProperty("flattening")public DestinationAzureBlobStorageFormatCSVCommaSeparatedValuesNormalizationFlatteningEnum flattening;
    ...
    @JsonProperty("format_type")public DestinationAzureBlobStorageFormatCSVCommaSeparatedValuesFormatTypeEnum formatType;
