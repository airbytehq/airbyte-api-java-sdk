...
public class SourceMysqlReplicationMethodLogicalReplicationCDC {
    ...
    @JsonProperty("method")public SourceMysqlReplicationMethodLogicalReplicationCDCMethodEnum method;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("server_time_zone")public String serverTimeZone;
