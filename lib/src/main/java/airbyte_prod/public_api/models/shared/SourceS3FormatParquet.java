...
public class SourceS3FormatParquet {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("buffer_size")public Long bufferSize;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("columns")public String[] columns;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("filetype")public SourceS3FormatParquetFiletypeEnum filetype;
