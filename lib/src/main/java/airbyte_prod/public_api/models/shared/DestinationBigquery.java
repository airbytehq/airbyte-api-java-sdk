...
public class DestinationBigquery {
    @JsonProperty("airbyte-destination-name")public DestinationBigqueryBigqueryEnum airbyteDestinationName;
     ...
     */
    @JsonProperty("dataset_location")public DestinationBigqueryDatasetLocationEnum datasetLocation;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("transformation_priority")public DestinationBigqueryTransformationQueryRunTypeEnum transformationPriority;
