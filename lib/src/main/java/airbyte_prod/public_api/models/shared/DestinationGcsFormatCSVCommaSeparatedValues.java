...
public class DestinationGcsFormatCSVCommaSeparatedValues {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("flattening")public DestinationGcsFormatCSVCommaSeparatedValuesNormalizationEnum flattening;
    ...
    @JsonProperty("format_type")public DestinationGcsFormatCSVCommaSeparatedValuesFormatTypeEnum formatType;
