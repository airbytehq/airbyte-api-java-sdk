...
/**
 * DestinationSnowflakeLoadingMethodAWSS3StagingS3BucketRegionEnum - Enter the region where your S3 bucket resides
 */
public enum DestinationSnowflakeLoadingMethodAWSS3StagingS3BucketRegionEnum {
    UNKNOWN(""),
    US_EAST1("us-east-1"),
    US_EAST2("us-east-2"),
    US_WEST1("us-west-1"),
    ...
    private DestinationSnowflakeLoadingMethodAWSS3StagingS3BucketRegionEnum(String value) {
        this.value = value;
    }
}
