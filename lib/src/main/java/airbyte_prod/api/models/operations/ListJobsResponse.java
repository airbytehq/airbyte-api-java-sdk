...
public class ListJobsResponse {
    ...
    public airbyte_prod.api.models.shared.JobsResponse jobsResponse;
    public ListJobsResponse withJobsResponse(airbyte_prod.api.models.shared.JobsResponse jobsResponse) {
