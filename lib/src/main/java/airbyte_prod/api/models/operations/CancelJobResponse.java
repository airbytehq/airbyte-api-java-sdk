...
public class CancelJobResponse {
    ...
    public airbyte_prod.api.models.shared.JobResponse jobResponse;
    public CancelJobResponse withJobResponse(airbyte_prod.api.models.shared.JobResponse jobResponse) {
