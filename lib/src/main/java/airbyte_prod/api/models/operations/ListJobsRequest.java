...
public class ListJobsRequest {
    ...
    public airbyte_prod.api.models.shared.JobTypeEnumEnum jobType;
    public ListJobsRequest withJobType(airbyte_prod.api.models.shared.JobTypeEnumEnum jobType) {
