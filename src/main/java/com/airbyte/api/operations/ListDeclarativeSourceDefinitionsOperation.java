...
public class ListDeclarativeSourceDefinitionsOperation implements RequestOperation<ListDeclarativeSourceDefinitionsRequest, ListDeclarativeSourceDefinitionsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public ListDeclarativeSourceDefinitionsOperation(SDKConfiguration sdkConfiguration) {
