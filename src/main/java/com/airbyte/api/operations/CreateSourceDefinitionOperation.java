...
public class CreateSourceDefinitionOperation implements RequestOperation<CreateSourceDefinitionRequest, CreateSourceDefinitionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateSourceDefinitionOperation(SDKConfiguration sdkConfiguration) {
