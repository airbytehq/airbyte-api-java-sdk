...
public class GetPermission {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPermissionRequest, GetPermissionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPermissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPermissionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPermissionRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "403", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public GetPermissionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPermissionResponse.Builder resBuilder =
            ...
            GetPermissionResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "403", "404", "422", "4XX")) {
                // no content
                throw new SDKError(
                        response,
                        response.statusCode(),
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPermissionRequest, com.airbyte.api.models.operations.async.GetPermissionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPermissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPermissionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPermissionRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "403", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetPermissionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetPermissionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetPermissionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetPermissionResponse res = resBuilder.build();
