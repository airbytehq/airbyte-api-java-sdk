...
public class CreateDestination {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends DestinationCreateRequest> request) throws Exception {
        ...
        @Override
        public CreateDestinationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DestinationResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDestinationResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends DestinationCreateRequest> request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "403", "404", "4XX", "5XX")) {
