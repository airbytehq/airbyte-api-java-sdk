...
public class CreateDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends DestinationCreateRequest>, CreateDestinationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Optional<? extends DestinationCreateRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends DestinationCreateRequest>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends DestinationCreateRequest> request) {
        ...
        @Override
        public CreateDestinationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDestinationResponse.Builder resBuilder =
            ...
            CreateDestinationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDestinationResponse(Utils.unmarshal(response, new TypeReference<DestinationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends DestinationCreateRequest>, com.airbyte.api.models.operations.async.CreateDestinationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends DestinationCreateRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends DestinationCreateRequest>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends DestinationCreateRequest> request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreateDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreateDestinationResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreateDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreateDestinationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DestinationResponse>() {})
                            .thenApply(res::withDestinationResponse);
                } else {
