...
public class GetWorkspace {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkspaceRequest, GetWorkspaceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetWorkspaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceRequest request) {
        ...
        @Override
        public GetWorkspaceResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetWorkspaceRequest, com.airbyte.api.models.operations.async.GetWorkspaceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetWorkspaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetWorkspaceRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetWorkspaceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetWorkspaceResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetWorkspaceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetWorkspaceResponse res = resBuilder.build();
