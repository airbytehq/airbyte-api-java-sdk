...
public class CreateDestinationDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDestinationDefinitionRequest, CreateDestinationDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDestinationDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDestinationDefinitionRequest.class, new TypeReference<CreateDestinationDefinitionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDestinationDefinitionRequest request) {
        ...
        @Override
        public CreateDestinationDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDestinationDefinitionResponse.Builder resBuilder =
            ...
            CreateDestinationDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDestinationDefinitionRequest, com.airbyte.api.models.operations.async.CreateDestinationDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDestinationDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDestinationDefinitionRequest.class, new TypeReference<CreateDestinationDefinitionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDestinationDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreateDestinationDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreateDestinationDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreateDestinationDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreateDestinationDefinitionResponse res = resBuilder.build();
