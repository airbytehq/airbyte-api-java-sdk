...
public class DeleteOrganizationOAuthCredentials {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteOrganizationOAuthCredentialsRequest, DeleteOrganizationOAuthCredentialsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteOrganizationOAuthCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteOrganizationOAuthCredentialsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteOrganizationOAuthCredentialsRequest request) {
        ...
        @Override
        public DeleteOrganizationOAuthCredentialsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteOrganizationOAuthCredentialsResponse.Builder resBuilder =
            ...
            DeleteOrganizationOAuthCredentialsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteOrganizationOAuthCredentialsRequest, com.airbyte.api.models.operations.async.DeleteOrganizationOAuthCredentialsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteOrganizationOAuthCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteOrganizationOAuthCredentialsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteOrganizationOAuthCredentialsRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteOrganizationOAuthCredentialsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteOrganizationOAuthCredentialsResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteOrganizationOAuthCredentialsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteOrganizationOAuthCredentialsResponse res = resBuilder.build();
