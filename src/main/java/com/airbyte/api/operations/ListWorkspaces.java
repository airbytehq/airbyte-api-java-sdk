...
public class ListWorkspaces {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListWorkspacesRequest request) throws Exception {
        ...
        @Override
        public ListWorkspacesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    WorkspacesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWorkspacesResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
