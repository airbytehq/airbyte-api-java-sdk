...
public class ListWorkspaces {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListWorkspacesRequest, ListWorkspacesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListWorkspacesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListWorkspacesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListWorkspacesRequest request) {
        ...
        @Override
        public ListWorkspacesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListWorkspacesResponse.Builder resBuilder =
            ...
            ListWorkspacesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWorkspacesResponse(Utils.unmarshal(response, new TypeReference<WorkspacesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListWorkspacesRequest, com.airbyte.api.models.operations.async.ListWorkspacesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListWorkspacesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListWorkspacesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListWorkspacesRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.ListWorkspacesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.ListWorkspacesResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.ListWorkspacesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.ListWorkspacesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WorkspacesResponse>() {})
                            .thenApply(res::withWorkspacesResponse);
                } else {
