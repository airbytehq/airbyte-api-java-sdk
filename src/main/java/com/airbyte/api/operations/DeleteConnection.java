...
public class DeleteConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteConnectionRequest, DeleteConnectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteConnectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteConnectionRequest request) throws Exception {
        ...
        @Override
        public DeleteConnectionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteConnectionResponse.Builder resBuilder =
            ...
            DeleteConnectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteConnectionRequest, com.airbyte.api.models.operations.async.DeleteConnectionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteConnectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteConnectionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteConnectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteConnectionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteConnectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteConnectionResponse res = resBuilder.build();
