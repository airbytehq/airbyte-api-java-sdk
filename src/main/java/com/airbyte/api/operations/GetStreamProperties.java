...
public class GetStreamProperties {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStreamPropertiesRequest, GetStreamPropertiesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetStreamPropertiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStreamPropertiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStreamPropertiesRequest request) {
        ...
        @Override
        public GetStreamPropertiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetStreamPropertiesResponse.Builder resBuilder =
            ...
            GetStreamPropertiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStreamPropertiesResponse(Utils.unmarshal(response, new TypeReference<List<StreamProperties>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStreamPropertiesRequest, com.airbyte.api.models.operations.async.GetStreamPropertiesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetStreamPropertiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStreamPropertiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetStreamPropertiesRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetStreamPropertiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetStreamPropertiesResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetStreamPropertiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetStreamPropertiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<StreamProperties>>() {})
                            .thenApply(res::withStreamPropertiesResponse);
                } else {
