...
public class GetStreamProperties {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStreamPropertiesRequest request) throws Exception {
        ...
        @Override
        public GetStreamPropertiesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<StreamProperties> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withStreamPropertiesResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
