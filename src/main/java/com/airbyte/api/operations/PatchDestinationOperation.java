...
public class PatchDestinationOperation implements RequestOperation<PatchDestinationRequest, PatchDestinationResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public PatchDestinationOperation(SDKConfiguration sdkConfiguration) {
