...
public class DeleteSourceDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSourceDefinitionRequest, DeleteSourceDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSourceDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSourceDefinitionRequest request) {
        ...
        @Override
        public DeleteSourceDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSourceDefinitionRequest, com.airbyte.api.models.operations.async.DeleteSourceDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSourceDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSourceDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteSourceDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteSourceDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteSourceDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteSourceDefinitionResponse res = resBuilder.build();
