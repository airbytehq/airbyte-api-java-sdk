...
public class UpdateTagOperation implements RequestOperation<UpdateTagRequest, UpdateTagResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public UpdateTagOperation(SDKConfiguration sdkConfiguration) {
