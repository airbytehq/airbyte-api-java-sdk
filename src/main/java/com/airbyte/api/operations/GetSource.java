...
public class GetSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSourceRequest, GetSourceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSourceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSourceRequest request) {
        ...
        @Override
        public GetSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSourceResponse.Builder resBuilder =
                    GetSourceResponse
                            .builder()
            ...
            GetSourceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSourceRequest, com.airbyte.api.models.operations.async.GetSourceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSourceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSourceRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetSourceResponse.Builder resBuilder =
            ...
            com.airbyte.api.models.operations.async.GetSourceResponse res = resBuilder.build();
