...
public class PutSourceOperation implements RequestOperation<PutSourceRequest, PutSourceResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public PutSourceOperation(SDKConfiguration sdkConfiguration) {
