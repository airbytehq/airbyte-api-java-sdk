...
public class GetDestinationDefinitionOperation implements RequestOperation<GetDestinationDefinitionRequest, GetDestinationDefinitionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetDestinationDefinitionOperation(SDKConfiguration sdkConfiguration) {
