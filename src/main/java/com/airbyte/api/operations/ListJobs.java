...
public class ListJobs {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListJobsRequest, ListJobsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListJobsRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListJobsRequest, com.airbyte.api.models.operations.async.ListJobsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListJobsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListJobsRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "403", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.ListJobsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.ListJobsResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.ListJobsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.ListJobsResponse res = resBuilder.build();
