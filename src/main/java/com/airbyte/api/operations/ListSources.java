...
public class ListSources {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSourcesRequest, ListSourcesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSourcesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSourcesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSourcesRequest request) {
        ...
        @Override
        public ListSourcesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSourcesResponse.Builder resBuilder =
                    ListSourcesResponse
                            .builder()
            ...
            ListSourcesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSourcesResponse(Utils.unmarshal(response, new TypeReference<SourcesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSourcesRequest, com.airbyte.api.models.operations.async.ListSourcesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSourcesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSourcesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSourcesRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.ListSourcesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.ListSourcesResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.ListSourcesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.ListSourcesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SourcesResponse>() {})
                            .thenApply(res::withSourcesResponse);
                } else {
