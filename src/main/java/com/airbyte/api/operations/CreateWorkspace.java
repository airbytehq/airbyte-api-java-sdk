...
public class CreateWorkspace {
    ...
    public static class Sync extends Base
            implements RequestOperation<WorkspaceCreateRequest, CreateWorkspaceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(WorkspaceCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<WorkspaceCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(WorkspaceCreateRequest request) {
        ...
        @Override
        public CreateWorkspaceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateWorkspaceResponse.Builder resBuilder =
            ...
            CreateWorkspaceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<WorkspaceCreateRequest, com.airbyte.api.models.operations.async.CreateWorkspaceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(WorkspaceCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<WorkspaceCreateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(WorkspaceCreateRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreateWorkspaceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreateWorkspaceResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreateWorkspaceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreateWorkspaceResponse res = resBuilder.build();
