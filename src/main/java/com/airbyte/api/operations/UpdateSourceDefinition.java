...
public class UpdateSourceDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSourceDefinitionRequest, UpdateSourceDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSourceDefinitionRequest.class, new TypeReference<UpdateSourceDefinitionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSourceDefinitionRequest request) {
        ...
        @Override
        public UpdateSourceDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSourceDefinitionRequest, com.airbyte.api.models.operations.async.UpdateSourceDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSourceDefinitionRequest.class, new TypeReference<UpdateSourceDefinitionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSourceDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.UpdateSourceDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.UpdateSourceDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.UpdateSourceDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.UpdateSourceDefinitionResponse res = resBuilder.build();
