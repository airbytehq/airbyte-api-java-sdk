...
public class DeleteSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSourceRequest, DeleteSourceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSourceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSourceRequest request) throws Exception {
        ...
        @Override
        public DeleteSourceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteSourceResponse.Builder resBuilder =
            ...
            DeleteSourceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSourceRequest, com.airbyte.api.models.operations.async.DeleteSourceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSourceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSourceRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteSourceResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteSourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteSourceResponse res = resBuilder.build();
