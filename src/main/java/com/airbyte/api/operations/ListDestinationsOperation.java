...
public class ListDestinationsOperation implements RequestOperation<ListDestinationsRequest, ListDestinationsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public ListDestinationsOperation(SDKConfiguration sdkConfiguration) {
