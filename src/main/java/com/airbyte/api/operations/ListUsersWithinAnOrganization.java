...
public class ListUsersWithinAnOrganization {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUsersWithinAnOrganizationRequest request) {
        ...
        @Override
        public ListUsersWithinAnOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUsersResponse(Utils.unmarshal(response, new TypeReference<UsersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.airbyte.api.models.operations.async.ListUsersWithinAnOrganizationResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UsersResponse>() {})
                            .thenApply(res::withUsersResponse);
                } else {
