...
public class PatchConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchConnectionRequest, PatchConnectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchConnectionRequest.class, new TypeReference<PatchConnectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchConnectionRequest request) {
        ...
        @Override
        public PatchConnectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchConnectionResponse.Builder resBuilder =
            ...
            PatchConnectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchConnectionRequest, com.airbyte.api.models.operations.async.PatchConnectionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchConnectionRequest.class, new TypeReference<PatchConnectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchConnectionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.PatchConnectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.PatchConnectionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.PatchConnectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.PatchConnectionResponse res = resBuilder.build();
