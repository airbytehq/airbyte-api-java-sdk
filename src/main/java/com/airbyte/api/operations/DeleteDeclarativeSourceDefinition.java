...
public class DeleteDeclarativeSourceDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDeclarativeSourceDefinitionRequest, DeleteDeclarativeSourceDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteDeclarativeSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDeclarativeSourceDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDeclarativeSourceDefinitionRequest request) {
        ...
        @Override
        public DeleteDeclarativeSourceDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDeclarativeSourceDefinitionResponse.Builder resBuilder =
            ...
            DeleteDeclarativeSourceDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteDeclarativeSourceDefinitionRequest, com.airbyte.api.models.operations.async.DeleteDeclarativeSourceDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteDeclarativeSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDeclarativeSourceDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteDeclarativeSourceDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteDeclarativeSourceDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteDeclarativeSourceDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteDeclarativeSourceDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteDeclarativeSourceDefinitionResponse res = resBuilder.build();
