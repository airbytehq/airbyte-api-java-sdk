...
public class GetPermissionOperation implements RequestOperation<GetPermissionRequest, GetPermissionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetPermissionOperation(SDKConfiguration sdkConfiguration) {
