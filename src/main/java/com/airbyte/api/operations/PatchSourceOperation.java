...
public class PatchSourceOperation implements RequestOperation<PatchSourceRequest, PatchSourceResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public PatchSourceOperation(SDKConfiguration sdkConfiguration) {
