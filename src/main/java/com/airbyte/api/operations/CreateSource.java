...
public class CreateSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends SourceCreateRequest>, CreateSourceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Optional<? extends SourceCreateRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends SourceCreateRequest>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends SourceCreateRequest> request) {
        ...
        @Override
        public CreateSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSourceResponse.Builder resBuilder =
            ...
            CreateSourceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSourceResponse(Utils.unmarshal(response, new TypeReference<SourceResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends SourceCreateRequest>, com.airbyte.api.models.operations.async.CreateSourceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends SourceCreateRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends SourceCreateRequest>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends SourceCreateRequest> request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreateSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreateSourceResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreateSourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreateSourceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SourceResponse>() {})
                            .thenApply(res::withSourceResponse);
                } else {
