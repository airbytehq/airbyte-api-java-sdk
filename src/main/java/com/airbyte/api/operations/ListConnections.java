...
public class ListConnections {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListConnectionsRequest, ListConnectionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListConnectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListConnectionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListConnectionsRequest request) {
        ...
        @Override
        public ListConnectionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListConnectionsResponse.Builder resBuilder =
            ...
            ListConnectionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnectionsResponse(Utils.unmarshal(response, new TypeReference<ConnectionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListConnectionsRequest, com.airbyte.api.models.operations.async.ListConnectionsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListConnectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListConnectionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListConnectionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.ListConnectionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.ListConnectionsResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.ListConnectionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.ListConnectionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ConnectionsResponse>() {})
                            .thenApply(res::withConnectionsResponse);
                } else {
