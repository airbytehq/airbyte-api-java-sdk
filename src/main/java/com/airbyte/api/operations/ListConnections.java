...
public class ListConnections {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListConnectionsRequest request) throws Exception {
        ...
        @Override
        public ListConnectionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ConnectionsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnectionsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
