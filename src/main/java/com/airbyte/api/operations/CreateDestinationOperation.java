...
public class CreateDestinationOperation implements RequestOperation<Optional<? extends DestinationCreateRequest>, CreateDestinationResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateDestinationOperation(SDKConfiguration sdkConfiguration) {
