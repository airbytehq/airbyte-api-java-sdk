...
public class GetDestinationOperation implements RequestOperation<GetDestinationRequest, GetDestinationResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetDestinationOperation(SDKConfiguration sdkConfiguration) {
