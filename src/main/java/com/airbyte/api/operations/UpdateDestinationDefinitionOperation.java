...
public class UpdateDestinationDefinitionOperation implements RequestOperation<UpdateDestinationDefinitionRequest, UpdateDestinationDefinitionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public UpdateDestinationDefinitionOperation(SDKConfiguration sdkConfiguration) {
