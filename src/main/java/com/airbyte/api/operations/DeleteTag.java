...
public class DeleteTag {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteTagRequest, DeleteTagResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteTagRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteTagRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteTagRequest request) throws Exception {
        ...
        @Override
        public DeleteTagResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteTagResponse.Builder resBuilder =
                    DeleteTagResponse
                            .builder()
            ...
            DeleteTagResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteTagRequest, com.airbyte.api.models.operations.async.DeleteTagResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteTagRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteTagRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteTagRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteTagResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteTagResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteTagResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteTagResponse res = resBuilder.build();
