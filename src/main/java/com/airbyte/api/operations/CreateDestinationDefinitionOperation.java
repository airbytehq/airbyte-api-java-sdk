...
public class CreateDestinationDefinitionOperation implements RequestOperation<CreateDestinationDefinitionRequest, CreateDestinationDefinitionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateDestinationDefinitionOperation(SDKConfiguration sdkConfiguration) {
