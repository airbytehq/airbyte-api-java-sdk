...
public class ListSourcesOperation implements RequestOperation<ListSourcesRequest, ListSourcesResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public ListSourcesOperation(SDKConfiguration sdkConfiguration) {
