...
public class PatchDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchDestinationRequest, PatchDestinationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDestinationRequest.class, new TypeReference<PatchDestinationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchDestinationRequest request) {
        ...
        @Override
        public PatchDestinationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchDestinationResponse.Builder resBuilder =
            ...
            PatchDestinationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchDestinationRequest, com.airbyte.api.models.operations.async.PatchDestinationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDestinationRequest.class, new TypeReference<PatchDestinationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchDestinationRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.PatchDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.PatchDestinationResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.PatchDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.PatchDestinationResponse res = resBuilder.build();
