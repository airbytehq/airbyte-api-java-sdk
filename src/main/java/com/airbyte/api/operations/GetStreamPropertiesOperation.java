...
public class GetStreamPropertiesOperation implements RequestOperation<GetStreamPropertiesRequest, GetStreamPropertiesResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetStreamPropertiesOperation(SDKConfiguration sdkConfiguration) {
