...
public class DeleteWorkspaceOperation implements RequestOperation<DeleteWorkspaceRequest, DeleteWorkspaceResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteWorkspaceOperation(SDKConfiguration sdkConfiguration) {
