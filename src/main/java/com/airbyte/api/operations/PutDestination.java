...
public class PutDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutDestinationRequest, PutDestinationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutDestinationRequest.class, new TypeReference<PutDestinationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutDestinationRequest request) {
        ...
        @Override
        public PutDestinationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutDestinationResponse.Builder resBuilder =
            ...
            PutDestinationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutDestinationRequest, com.airbyte.api.models.operations.async.PutDestinationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutDestinationRequest.class, new TypeReference<PutDestinationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutDestinationRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.PutDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.PutDestinationResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.PutDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.PutDestinationResponse res = resBuilder.build();
