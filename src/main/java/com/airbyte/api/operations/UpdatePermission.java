...
public class UpdatePermission {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePermissionRequest request) {
        ...
        @Override
        public UpdatePermissionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPermissionResponse(Utils.unmarshal(response, new TypeReference<PermissionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.airbyte.api.models.operations.async.UpdatePermissionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PermissionResponse>() {})
                            .thenApply(res::withPermissionResponse);
                } else {
