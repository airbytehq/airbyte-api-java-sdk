...
public class UpdatePermission {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePermissionRequest, UpdatePermissionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePermissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePermissionRequest.class, new TypeReference<UpdatePermissionRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePermissionRequest, com.airbyte.api.models.operations.async.UpdatePermissionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePermissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePermissionRequest.class, new TypeReference<UpdatePermissionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePermissionRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "403", "404", "422", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.UpdatePermissionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.UpdatePermissionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.UpdatePermissionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.UpdatePermissionResponse res = resBuilder.build();
