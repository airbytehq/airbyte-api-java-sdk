...
public class CreateJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<JobCreateRequest, CreateJobResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(JobCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<JobCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(JobCreateRequest request) {
        ...
        @Override
        public CreateJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateJobResponse.Builder resBuilder =
                    CreateJobResponse
                            .builder()
            ...
            CreateJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withJobResponse(Utils.unmarshal(response, new TypeReference<JobResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<JobCreateRequest, com.airbyte.api.models.operations.async.CreateJobResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(JobCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<JobCreateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(JobCreateRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreateJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreateJobResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreateJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreateJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<JobResponse>() {})
                            .thenApply(res::withJobResponse);
                } else {
