...
public class GetConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetConnectionRequest, GetConnectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetConnectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConnectionRequest request) {
        ...
        @Override
        public GetConnectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetConnectionResponse.Builder resBuilder =
            ...
            GetConnectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetConnectionRequest, com.airbyte.api.models.operations.async.GetConnectionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetConnectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetConnectionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetConnectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetConnectionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetConnectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetConnectionResponse res = resBuilder.build();
