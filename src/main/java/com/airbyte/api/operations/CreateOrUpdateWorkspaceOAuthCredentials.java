...
public class CreateOrUpdateWorkspaceOAuthCredentials {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateOrUpdateWorkspaceOAuthCredentialsRequest, CreateOrUpdateWorkspaceOAuthCredentialsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateOrUpdateWorkspaceOAuthCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateOrUpdateWorkspaceOAuthCredentialsRequest.class, new TypeReference<CreateOrUpdateWorkspaceOAuthCredentialsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateOrUpdateWorkspaceOAuthCredentialsRequest request) throws Exception {
        ...
        @Override
        public CreateOrUpdateWorkspaceOAuthCredentialsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateOrUpdateWorkspaceOAuthCredentialsResponse.Builder resBuilder =
            ...
            CreateOrUpdateWorkspaceOAuthCredentialsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateOrUpdateWorkspaceOAuthCredentialsRequest, com.airbyte.api.models.operations.async.CreateOrUpdateWorkspaceOAuthCredentialsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateOrUpdateWorkspaceOAuthCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateOrUpdateWorkspaceOAuthCredentialsRequest.class, new TypeReference<CreateOrUpdateWorkspaceOAuthCredentialsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateOrUpdateWorkspaceOAuthCredentialsRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreateOrUpdateWorkspaceOAuthCredentialsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreateOrUpdateWorkspaceOAuthCredentialsResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreateOrUpdateWorkspaceOAuthCredentialsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreateOrUpdateWorkspaceOAuthCredentialsResponse res = resBuilder.build();
