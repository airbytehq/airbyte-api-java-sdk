...
public class DeleteDestinationDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDestinationDefinitionRequest, DeleteDestinationDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteDestinationDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDestinationDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDestinationDefinitionRequest request) {
        ...
        @Override
        public DeleteDestinationDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDestinationDefinitionResponse.Builder resBuilder =
            ...
            DeleteDestinationDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteDestinationDefinitionRequest, com.airbyte.api.models.operations.async.DeleteDestinationDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteDestinationDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDestinationDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteDestinationDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteDestinationDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteDestinationDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteDestinationDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteDestinationDefinitionResponse res = resBuilder.build();
