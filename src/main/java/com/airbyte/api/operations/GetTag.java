...
public class GetTag {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTagRequest, GetTagResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTagRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTagRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTagRequest request) {
        ...
        @Override
        public GetTagResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTagResponse.Builder resBuilder =
                    GetTagResponse
                            .builder()
            ...
            GetTagResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTagRequest, com.airbyte.api.models.operations.async.GetTagResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTagRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTagRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTagRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetTagResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetTagResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetTagResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetTagResponse res = resBuilder.build();
