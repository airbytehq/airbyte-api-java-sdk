...
public class CancelJobOperation implements RequestOperation<CancelJobRequest, CancelJobResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CancelJobOperation(SDKConfiguration sdkConfiguration) {
