...
public class GetDeclarativeSourceDefinitionOperation implements RequestOperation<GetDeclarativeSourceDefinitionRequest, GetDeclarativeSourceDefinitionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetDeclarativeSourceDefinitionOperation(SDKConfiguration sdkConfiguration) {
