...
public class ListDestinations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDestinationsRequest request) throws Exception {
        ...
        @Override
        public ListDestinationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DestinationsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDestinationsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
