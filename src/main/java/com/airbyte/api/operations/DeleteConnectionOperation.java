...
public class DeleteConnectionOperation implements RequestOperation<DeleteConnectionRequest, DeleteConnectionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteConnectionOperation(SDKConfiguration sdkConfiguration) {
