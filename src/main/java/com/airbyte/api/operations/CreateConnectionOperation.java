...
public class CreateConnectionOperation implements RequestOperation<ConnectionCreateRequest, CreateConnectionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateConnectionOperation(SDKConfiguration sdkConfiguration) {
