...
public class DeleteTagOperation implements RequestOperation<DeleteTagRequest, DeleteTagResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteTagOperation(SDKConfiguration sdkConfiguration) {
