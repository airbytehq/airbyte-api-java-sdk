...
public class PutSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutSourceRequest, PutSourceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutSourceRequest.class, new TypeReference<PutSourceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutSourceRequest request) {
        ...
        @Override
        public PutSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutSourceResponse.Builder resBuilder =
                    PutSourceResponse
                            .builder()
            ...
            PutSourceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutSourceRequest, com.airbyte.api.models.operations.async.PutSourceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutSourceRequest.class, new TypeReference<PutSourceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutSourceRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.PutSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.PutSourceResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.PutSourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.PutSourceResponse res = resBuilder.build();
