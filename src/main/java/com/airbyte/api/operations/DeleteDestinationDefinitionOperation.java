...
public class DeleteDestinationDefinitionOperation implements RequestOperation<DeleteDestinationDefinitionRequest, DeleteDestinationDefinitionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteDestinationDefinitionOperation(SDKConfiguration sdkConfiguration) {
