...
public class UpdateDeclarativeSourceDefinitionOperation implements RequestOperation<UpdateDeclarativeSourceDefinitionRequest, UpdateDeclarativeSourceDefinitionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public UpdateDeclarativeSourceDefinitionOperation(SDKConfiguration sdkConfiguration) {
