...
public class CreateJobOperation implements RequestOperation<JobCreateRequest, CreateJobResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateJobOperation(SDKConfiguration sdkConfiguration) {
