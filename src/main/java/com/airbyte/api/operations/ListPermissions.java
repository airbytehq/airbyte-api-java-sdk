...
public class ListPermissions {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListPermissionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPermissionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPermissionsRequest request) {
        ...
        @Override
        public ListPermissionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPermissionsResponse.Builder resBuilder =
            ...
            ListPermissionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPermissionsResponse(Utils.unmarshal(response, new TypeReference<PermissionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPermissionsRequest, com.airbyte.api.models.operations.async.ListPermissionsResponse> {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.ListPermissionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.ListPermissionsResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.ListPermissionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.ListPermissionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PermissionsResponse>() {})
                            .thenApply(res::withPermissionsResponse);
                } else {
