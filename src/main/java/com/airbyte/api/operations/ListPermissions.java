...
public class ListPermissions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public ListPermissionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PermissionsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPermissionsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
