...
public class ListDestinationDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDestinationDefinitionsRequest, ListDestinationDefinitionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListDestinationDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDestinationDefinitionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDestinationDefinitionsRequest request) {
        ...
        @Override
        public ListDestinationDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDefinitionsResponse(Utils.unmarshal(response, new TypeReference<DefinitionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDestinationDefinitionsRequest, com.airbyte.api.models.operations.async.ListDestinationDefinitionsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDestinationDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDestinationDefinitionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDestinationDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.ListDestinationDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.ListDestinationDefinitionsResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.ListDestinationDefinitionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.ListDestinationDefinitionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DefinitionsResponse>() {})
                            .thenApply(res::withDefinitionsResponse);
                } else {
