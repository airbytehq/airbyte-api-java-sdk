...
public class DeleteWorkspaceOAuthCredentials {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/workspaces/{workspaceId}/oauthCredentials/{actorType}/{name}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteWorkspaceOAuthCredentialsRequest, DeleteWorkspaceOAuthCredentialsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteWorkspaceOAuthCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteWorkspaceOAuthCredentialsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteWorkspaceOAuthCredentialsRequest request) {
        ...
        @Override
        public DeleteWorkspaceOAuthCredentialsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteWorkspaceOAuthCredentialsResponse.Builder resBuilder =
            ...
            DeleteWorkspaceOAuthCredentialsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteWorkspaceOAuthCredentialsRequest, com.airbyte.api.models.operations.async.DeleteWorkspaceOAuthCredentialsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteWorkspaceOAuthCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteWorkspaceOAuthCredentialsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteWorkspaceOAuthCredentialsRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteWorkspaceOAuthCredentialsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteWorkspaceOAuthCredentialsResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteWorkspaceOAuthCredentialsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteWorkspaceOAuthCredentialsResponse res = resBuilder.build();
