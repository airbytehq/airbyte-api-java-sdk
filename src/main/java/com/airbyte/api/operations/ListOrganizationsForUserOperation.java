...
public class ListOrganizationsForUserOperation implements RequestlessOperation<ListOrganizationsForUserResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public ListOrganizationsForUserOperation(SDKConfiguration sdkConfiguration) {
