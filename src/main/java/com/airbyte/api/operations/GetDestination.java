...
public class GetDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDestinationRequest, GetDestinationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDestinationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDestinationRequest request) {
        ...
        @Override
        public GetDestinationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDestinationResponse.Builder resBuilder =
            ...
            GetDestinationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDestinationRequest, com.airbyte.api.models.operations.async.GetDestinationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDestinationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDestinationRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetDestinationResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetDestinationResponse res = resBuilder.build();
