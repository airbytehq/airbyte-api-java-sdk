...
public class CreateDeclarativeSourceDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDeclarativeSourceDefinitionRequest, CreateDeclarativeSourceDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDeclarativeSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDeclarativeSourceDefinitionRequest.class, new TypeReference<CreateDeclarativeSourceDefinitionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDeclarativeSourceDefinitionRequest request) {
        ...
        @Override
        public CreateDeclarativeSourceDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeclarativeSourceDefinitionResponse(Utils.unmarshal(response, new TypeReference<DeclarativeSourceDefinitionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDeclarativeSourceDefinitionRequest, com.airbyte.api.models.operations.async.CreateDeclarativeSourceDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDeclarativeSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDeclarativeSourceDefinitionRequest.class, new TypeReference<CreateDeclarativeSourceDefinitionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDeclarativeSourceDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreateDeclarativeSourceDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreateDeclarativeSourceDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreateDeclarativeSourceDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreateDeclarativeSourceDefinitionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeclarativeSourceDefinitionResponse>() {})
                            .thenApply(res::withDeclarativeSourceDefinitionResponse);
                } else {
