...
public class CreatePermissionOperation implements RequestOperation<PermissionCreateRequest, CreatePermissionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreatePermissionOperation(SDKConfiguration sdkConfiguration) {
