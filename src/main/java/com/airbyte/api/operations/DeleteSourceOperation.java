...
public class DeleteSourceOperation implements RequestOperation<DeleteSourceRequest, DeleteSourceResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteSourceOperation(SDKConfiguration sdkConfiguration) {
