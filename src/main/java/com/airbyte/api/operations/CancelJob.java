...
public class CancelJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelJobRequest, CancelJobResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CancelJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelJobRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelJobRequest request) {
        ...
        @Override
        public CancelJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelJobResponse.Builder resBuilder =
                    CancelJobResponse
                            .builder()
            ...
            CancelJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelJobRequest, com.airbyte.api.models.operations.async.CancelJobResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CancelJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelJobRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CancelJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CancelJobResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CancelJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CancelJobResponse res = resBuilder.build();
