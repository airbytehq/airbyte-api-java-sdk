...
public class DeletePermission {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePermissionRequest, DeletePermissionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeletePermissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePermissionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePermissionRequest request) throws Exception {
        ...
        @Override
        public DeletePermissionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePermissionResponse.Builder resBuilder =
            ...
            DeletePermissionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePermissionRequest, com.airbyte.api.models.operations.async.DeletePermissionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletePermissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePermissionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePermissionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeletePermissionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeletePermissionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeletePermissionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeletePermissionResponse res = resBuilder.build();
