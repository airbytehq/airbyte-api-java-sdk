...
public class ListPermissionsOperation implements RequestOperation<ListPermissionsRequest, ListPermissionsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public ListPermissionsOperation(SDKConfiguration sdkConfiguration) {
