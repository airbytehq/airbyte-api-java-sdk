...
public class ListOrganizationsForUser {
    ...
    public static class Sync extends Base
        ...
        @Override
        public ListOrganizationsForUserResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrganizationsResponse(Utils.unmarshal(response, new TypeReference<OrganizationsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.airbyte.api.models.operations.async.ListOrganizationsForUserResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<OrganizationsResponse>() {})
                            .thenApply(res::withOrganizationsResponse);
                } else {
