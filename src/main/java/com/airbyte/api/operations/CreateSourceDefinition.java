...
public class CreateSourceDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSourceDefinitionRequest, CreateSourceDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSourceDefinitionRequest.class, new TypeReference<CreateSourceDefinitionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSourceDefinitionRequest request) {
        ...
        @Override
        public CreateSourceDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSourceDefinitionResponse.Builder resBuilder =
            ...
            CreateSourceDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSourceDefinitionRequest, com.airbyte.api.models.operations.async.CreateSourceDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSourceDefinitionRequest.class, new TypeReference<CreateSourceDefinitionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSourceDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreateSourceDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreateSourceDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreateSourceDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreateSourceDefinitionResponse res = resBuilder.build();
