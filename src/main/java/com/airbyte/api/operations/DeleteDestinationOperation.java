...
public class DeleteDestinationOperation implements RequestOperation<DeleteDestinationRequest, DeleteDestinationResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteDestinationOperation(SDKConfiguration sdkConfiguration) {
