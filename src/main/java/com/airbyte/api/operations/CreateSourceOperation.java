...
public class CreateSourceOperation implements RequestOperation<Optional<? extends SourceCreateRequest>, CreateSourceResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateSourceOperation(SDKConfiguration sdkConfiguration) {
