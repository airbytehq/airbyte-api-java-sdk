...
public class GetSourceDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSourceDefinitionRequest, GetSourceDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSourceDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSourceDefinitionRequest request) {
        ...
        @Override
        public GetSourceDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSourceDefinitionResponse.Builder resBuilder =
            ...
            GetSourceDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSourceDefinitionRequest, com.airbyte.api.models.operations.async.GetSourceDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSourceDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSourceDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetSourceDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetSourceDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetSourceDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetSourceDefinitionResponse res = resBuilder.build();
