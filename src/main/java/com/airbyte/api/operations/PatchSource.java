...
public class PatchSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchSourceRequest, PatchSourceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSourceRequest.class, new TypeReference<PatchSourceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchSourceRequest request) {
        ...
        @Override
        public PatchSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchSourceResponse.Builder resBuilder =
                    PatchSourceResponse
                            .builder()
            ...
            PatchSourceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchSourceRequest, com.airbyte.api.models.operations.async.PatchSourceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSourceRequest.class, new TypeReference<PatchSourceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchSourceRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.PatchSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.PatchSourceResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.PatchSourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.PatchSourceResponse res = resBuilder.build();
