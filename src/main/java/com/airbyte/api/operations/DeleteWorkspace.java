...
public class DeleteWorkspace {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteWorkspaceRequest, DeleteWorkspaceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteWorkspaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteWorkspaceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteWorkspaceRequest request) throws Exception {
        ...
        @Override
        public DeleteWorkspaceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteWorkspaceResponse.Builder resBuilder =
            ...
            DeleteWorkspaceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteWorkspaceRequest, com.airbyte.api.models.operations.async.DeleteWorkspaceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteWorkspaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteWorkspaceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteWorkspaceRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteWorkspaceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteWorkspaceResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteWorkspaceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteWorkspaceResponse res = resBuilder.build();
