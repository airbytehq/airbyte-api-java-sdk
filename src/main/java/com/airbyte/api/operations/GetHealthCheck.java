...
public class GetHealthCheck {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetHealthCheckResponse> {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.airbyte.api.models.operations.async.GetHealthCheckResponse> {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetHealthCheckResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetHealthCheckResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetHealthCheckResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetHealthCheckResponse res = resBuilder.build();
