...
public class ListWorkspacesOperation implements RequestOperation<ListWorkspacesRequest, ListWorkspacesResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public ListWorkspacesOperation(SDKConfiguration sdkConfiguration) {
