...
public class CreatePermission {
    ...
    public static class Sync extends Base
            implements RequestOperation<PermissionCreateRequest, CreatePermissionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PermissionCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PermissionCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PermissionCreateRequest request) {
        ...
        @Override
        public CreatePermissionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePermissionResponse.Builder resBuilder =
            ...
            CreatePermissionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PermissionCreateRequest, com.airbyte.api.models.operations.async.CreatePermissionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PermissionCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PermissionCreateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PermissionCreateRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreatePermissionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreatePermissionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreatePermissionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreatePermissionResponse res = resBuilder.build();
