...
public class CreateTag {
    ...
    public static class Sync extends Base
            implements RequestOperation<TagCreateRequest, CreateTagResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(TagCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<TagCreateRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TagCreateRequest, com.airbyte.api.models.operations.async.CreateTagResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(TagCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<TagCreateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TagCreateRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "403", "409", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.CreateTagResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.CreateTagResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.CreateTagResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.CreateTagResponse res = resBuilder.build();
