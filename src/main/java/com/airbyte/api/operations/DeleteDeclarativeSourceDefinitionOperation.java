...
public class DeleteDeclarativeSourceDefinitionOperation implements RequestOperation<DeleteDeclarativeSourceDefinitionRequest, DeleteDeclarativeSourceDefinitionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteDeclarativeSourceDefinitionOperation(SDKConfiguration sdkConfiguration) {
