...
public class UpdateDestinationDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDestinationDefinitionRequest, UpdateDestinationDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateDestinationDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDestinationDefinitionRequest.class, new TypeReference<UpdateDestinationDefinitionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDestinationDefinitionRequest request) {
        ...
        @Override
        public UpdateDestinationDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDestinationDefinitionResponse.Builder resBuilder =
            ...
            UpdateDestinationDefinitionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDefinitionResponse(Utils.unmarshal(response, new TypeReference<DefinitionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDestinationDefinitionRequest, com.airbyte.api.models.operations.async.UpdateDestinationDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDestinationDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDestinationDefinitionRequest.class, new TypeReference<UpdateDestinationDefinitionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDestinationDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.UpdateDestinationDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.UpdateDestinationDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.UpdateDestinationDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.UpdateDestinationDefinitionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DefinitionResponse>() {})
                            .thenApply(res::withDefinitionResponse);
                } else {
