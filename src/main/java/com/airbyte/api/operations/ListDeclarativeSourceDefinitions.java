...
public class ListDeclarativeSourceDefinitions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDeclarativeSourceDefinitionsRequest request) throws Exception {
        ...
        @Override
        public ListDeclarativeSourceDefinitionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeclarativeSourceDefinitionsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeclarativeSourceDefinitionsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
