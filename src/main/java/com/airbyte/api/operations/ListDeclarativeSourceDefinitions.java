...
public class ListDeclarativeSourceDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDeclarativeSourceDefinitionsRequest, ListDeclarativeSourceDefinitionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListDeclarativeSourceDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDeclarativeSourceDefinitionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDeclarativeSourceDefinitionsRequest request) {
        ...
        @Override
        public ListDeclarativeSourceDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDeclarativeSourceDefinitionsResponse.Builder resBuilder =
            ...
            ListDeclarativeSourceDefinitionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeclarativeSourceDefinitionsResponse(Utils.unmarshal(response, new TypeReference<DeclarativeSourceDefinitionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDeclarativeSourceDefinitionsRequest, com.airbyte.api.models.operations.async.ListDeclarativeSourceDefinitionsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDeclarativeSourceDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDeclarativeSourceDefinitionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDeclarativeSourceDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.ListDeclarativeSourceDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.ListDeclarativeSourceDefinitionsResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.ListDeclarativeSourceDefinitionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.ListDeclarativeSourceDefinitionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeclarativeSourceDefinitionsResponse>() {})
                            .thenApply(res::withDeclarativeSourceDefinitionsResponse);
                } else {
