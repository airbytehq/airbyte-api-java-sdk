...
public class ListUsersWithinAnOrganizationOperation implements RequestOperation<ListUsersWithinAnOrganizationRequest, ListUsersWithinAnOrganizationResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public ListUsersWithinAnOrganizationOperation(SDKConfiguration sdkConfiguration) {
