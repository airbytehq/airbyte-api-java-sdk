...
public class GetSourceDefinitionOperation implements RequestOperation<GetSourceDefinitionRequest, GetSourceDefinitionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetSourceDefinitionOperation(SDKConfiguration sdkConfiguration) {
