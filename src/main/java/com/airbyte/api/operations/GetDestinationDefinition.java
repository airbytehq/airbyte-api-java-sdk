...
public class GetDestinationDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDestinationDefinitionRequest, GetDestinationDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDestinationDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDestinationDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDestinationDefinitionRequest request) {
        ...
        @Override
        public GetDestinationDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDestinationDefinitionResponse.Builder resBuilder =
            ...
            GetDestinationDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDestinationDefinitionRequest, com.airbyte.api.models.operations.async.GetDestinationDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDestinationDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDestinationDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDestinationDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetDestinationDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetDestinationDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetDestinationDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetDestinationDefinitionResponse res = resBuilder.build();
