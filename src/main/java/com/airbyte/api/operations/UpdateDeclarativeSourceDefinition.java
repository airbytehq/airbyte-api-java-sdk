...
public class UpdateDeclarativeSourceDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDeclarativeSourceDefinitionRequest, UpdateDeclarativeSourceDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateDeclarativeSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDeclarativeSourceDefinitionRequest.class, new TypeReference<UpdateDeclarativeSourceDefinitionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDeclarativeSourceDefinitionRequest request) {
        ...
        @Override
        public UpdateDeclarativeSourceDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDeclarativeSourceDefinitionResponse.Builder resBuilder =
            ...
            UpdateDeclarativeSourceDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDeclarativeSourceDefinitionRequest, com.airbyte.api.models.operations.async.UpdateDeclarativeSourceDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDeclarativeSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDeclarativeSourceDefinitionRequest.class, new TypeReference<UpdateDeclarativeSourceDefinitionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDeclarativeSourceDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.UpdateDeclarativeSourceDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.UpdateDeclarativeSourceDefinitionResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.UpdateDeclarativeSourceDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.UpdateDeclarativeSourceDefinitionResponse res = resBuilder.build();
