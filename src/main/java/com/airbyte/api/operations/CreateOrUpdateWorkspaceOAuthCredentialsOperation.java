...
public class CreateOrUpdateWorkspaceOAuthCredentialsOperation implements RequestOperation<CreateOrUpdateWorkspaceOAuthCredentialsRequest, CreateOrUpdateWorkspaceOAuthCredentialsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateOrUpdateWorkspaceOAuthCredentialsOperation(SDKConfiguration sdkConfiguration) {
