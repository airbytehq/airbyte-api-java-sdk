...
public class ListSourceDefinitionsOperation implements RequestOperation<ListSourceDefinitionsRequest, ListSourceDefinitionsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public ListSourceDefinitionsOperation(SDKConfiguration sdkConfiguration) {
