...
public class ListTags {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTagsRequest, ListTagsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTagsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTagsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTagsRequest request) {
        ...
        @Override
        public ListTagsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTagsResponse.Builder resBuilder =
                    ListTagsResponse
                            .builder()
            ...
            ListTagsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTagsResponse(Utils.unmarshal(response, new TypeReference<TagsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTagsRequest, com.airbyte.api.models.operations.async.ListTagsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTagsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTagsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTagsRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.ListTagsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.ListTagsResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.ListTagsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.ListTagsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TagsResponse>() {})
                            .thenApply(res::withTagsResponse);
                } else {
