...
public class GetSourceOperation implements RequestOperation<GetSourceRequest, GetSourceResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetSourceOperation(SDKConfiguration sdkConfiguration) {
