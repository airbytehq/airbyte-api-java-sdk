...
public class UpdateWorkspace {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateWorkspaceRequest, UpdateWorkspaceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateWorkspaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateWorkspaceRequest.class, new TypeReference<UpdateWorkspaceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateWorkspaceRequest request) {
        ...
        @Override
        public UpdateWorkspaceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateWorkspaceResponse.Builder resBuilder =
            ...
            UpdateWorkspaceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWorkspaceResponse(Utils.unmarshal(response, new TypeReference<WorkspaceResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateWorkspaceRequest, com.airbyte.api.models.operations.async.UpdateWorkspaceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateWorkspaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateWorkspaceRequest.class, new TypeReference<UpdateWorkspaceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateWorkspaceRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.UpdateWorkspaceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.UpdateWorkspaceResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.UpdateWorkspaceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.UpdateWorkspaceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WorkspaceResponse>() {})
                            .thenApply(res::withWorkspaceResponse);
                } else {
