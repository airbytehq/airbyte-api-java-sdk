...
public class GetDeclarativeSourceDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDeclarativeSourceDefinitionRequest, GetDeclarativeSourceDefinitionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDeclarativeSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeclarativeSourceDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeclarativeSourceDefinitionRequest request) {
        ...
        @Override
        public GetDeclarativeSourceDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDeclarativeSourceDefinitionResponse.Builder resBuilder =
            ...
            GetDeclarativeSourceDefinitionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDeclarativeSourceDefinitionRequest, com.airbyte.api.models.operations.async.GetDeclarativeSourceDefinitionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDeclarativeSourceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeclarativeSourceDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDeclarativeSourceDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetDeclarativeSourceDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetDeclarativeSourceDefinitionResponse.Builder resBuilder =
            ...
            com.airbyte.api.models.operations.async.GetDeclarativeSourceDefinitionResponse res = resBuilder.build();
