...
public class ListSourceDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSourceDefinitionsRequest, ListSourceDefinitionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSourceDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSourceDefinitionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSourceDefinitionsRequest request) {
        ...
        @Override
        public ListSourceDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSourceDefinitionsResponse.Builder resBuilder =
            ...
            ListSourceDefinitionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSourceDefinitionsRequest, com.airbyte.api.models.operations.async.ListSourceDefinitionsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSourceDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSourceDefinitionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSourceDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.ListSourceDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.ListSourceDefinitionsResponse.Builder resBuilder =
            ...
            com.airbyte.api.models.operations.async.ListSourceDefinitionsResponse res = resBuilder.build();
