...
public class DeleteDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDestinationRequest, DeleteDestinationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDestinationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDestinationRequest request) throws Exception {
        ...
        @Override
        public DeleteDestinationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDestinationResponse.Builder resBuilder =
            ...
            DeleteDestinationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteDestinationRequest, com.airbyte.api.models.operations.async.DeleteDestinationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDestinationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteDestinationRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.DeleteDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.DeleteDestinationResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.DeleteDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.DeleteDestinationResponse res = resBuilder.build();
