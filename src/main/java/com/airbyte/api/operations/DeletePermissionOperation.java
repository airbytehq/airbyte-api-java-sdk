...
public class DeletePermissionOperation implements RequestOperation<DeletePermissionRequest, DeletePermissionResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeletePermissionOperation(SDKConfiguration sdkConfiguration) {
