...
public class GetJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetJobRequest, GetJobResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetJobRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetJobRequest request) {
        ...
        @Override
        public GetJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetJobResponse.Builder resBuilder =
                    GetJobResponse
                            .builder()
            ...
            GetJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetJobRequest, com.airbyte.api.models.operations.async.GetJobResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetJobRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.airbyte.api.models.operations.async.GetJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.airbyte.api.models.operations.async.GetJobResponse.Builder resBuilder =
                    com.airbyte.api.models.operations.async.GetJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.airbyte.api.models.operations.async.GetJobResponse res = resBuilder.build();
