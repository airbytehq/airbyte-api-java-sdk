...
public abstract class AirbyteException extends RuntimeException {

    private int code;
    private byte[] body;
    private HttpResponse<?> rawResponse;

    public AirbyteException(String message, int code, @Nullable byte[] body, HttpResponse<?> rawResponse, @Nullable Throwable cause) {
        super(message, cause);
    ...
    public AirbyteException withCode(int code) {
        this.code = code;
        return this;
    }
    
    public AirbyteException withBody(@Nullable byte[] body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }
    
    public AirbyteException withRawResponse(HttpResponse<?> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
