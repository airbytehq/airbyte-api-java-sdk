...
public class SourceGoogleDriveAvroFormat {
    ...
    public Optional<? extends SourceGoogleDriveFiletype> filetype() {
        return filetype;
    }
     ...
     * Whether to convert double fields to strings. This is recommended if you have decimal numbers with a high degree of precision because there can be a loss precision when handling floating point numbers.
     */
    public SourceGoogleDriveAvroFormat withDoubleAsString(Optional<? extends Boolean> doubleAsString) {
        Utils.checkNotNull(doubleAsString, "doubleAsString");
        this.doubleAsString = doubleAsString;
        return this;
    }
