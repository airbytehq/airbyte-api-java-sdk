...
public class DestinationConfiguration {
     ...
     * <li>{@code com.airbyte.api.models.shared.DestinationIceberg}</li>
    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationConfiguration> {
        ...
        public _Deserializer() {
            super(DestinationConfiguration.class, false,
                  ...
                  TypeReferenceWithShape.of(new TypeReference<DestinationS3Glue>() {}, JsonShape.DEFAULT),
                  ...
                  TypeReferenceWithShape.of(new TypeReference<DestinationIceberg>() {}, JsonShape.DEFAULT),
