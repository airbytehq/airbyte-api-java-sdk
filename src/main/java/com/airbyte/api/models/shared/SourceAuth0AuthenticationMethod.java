    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceAuth0AuthenticationMethod> {
        ...
        public _Deserializer() {
            super(SourceAuth0AuthenticationMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.OAuth2ConfidentialApplication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.OAuth2AccessToken>() {}, JsonShape.DEFAULT));
        }
    }
