...
public class SourceNotionAuthenticationMethod {
     ...
     * <ul>
     * <li>{@code com.airbyte.api.models.shared.SourceNotionOAuth20}</li>
     * <li>{@code com.airbyte.api.models.shared.SourceNotionAccessToken}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceNotionAuthenticationMethod> {

        public _Deserializer() {
            super(SourceNotionAuthenticationMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<SourceNotionOAuth20>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<SourceNotionAccessToken>() {}, JsonShape.DEFAULT));
        }
    }
