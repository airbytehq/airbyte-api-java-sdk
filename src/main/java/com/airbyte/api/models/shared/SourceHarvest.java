...
public class SourceHarvest {
    ...
    private Optional<? extends Object> credentials;
    ...
    public SourceHarvest(
            ...
            @JsonProperty("credentials") Optional<? extends Object> credentials,
    ...
    @JsonIgnore
    public Optional<Object> credentials() {
        return (Optional<Object>) credentials;
    }
     ...
     * Choose how to authenticate to Harvest.
     */
    public SourceHarvest withCredentials(Optional<? extends Object> credentials) {
        Utils.checkNotNull(credentials, "credentials");
        this.credentials = credentials;
        return this;
    }
     ...
     * UTC date and time in the format 2017-01-25T00:00:00Z. Any data after this date will not be replicated.
     */
    public SourceHarvest withReplicationEndDate(Optional<OffsetDateTime> replicationEndDate) {
        Utils.checkNotNull(replicationEndDate, "replicationEndDate");
        this.replicationEndDate = replicationEndDate;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends Object> credentials = Optional.empty();
         ...
         * Choose how to authenticate to Harvest.
         */
        public Builder credentials(Optional<? extends Object> credentials) {
            Utils.checkNotNull(credentials, "credentials");
            this.credentials = credentials;
            return this;
        }
