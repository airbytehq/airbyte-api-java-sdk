...
public class DestinationRedisSSLModes {
     ...
     * <ul>
     * <li>{@code com.airbyte.api.models.shared.DestinationRedisDisable}</li>
     * <li>{@code com.airbyte.api.models.shared.DestinationRedisVerifyFull}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationRedisSSLModes> {

        public _Deserializer() {
            super(DestinationRedisSSLModes.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationRedisVerifyFull>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationRedisDisable>() {}, JsonShape.DEFAULT));
        }
    }
