...
public class SourceAzureBlobStorage {
    ...
    private Optional<String> azureBlobStorageEndpoint;
    ...
    public SourceAzureBlobStorage(
            ...
            @JsonProperty("azure_blob_storage_endpoint") Optional<String> azureBlobStorageEndpoint,
            ...
            @JsonProperty("streams") List<FileBasedStreamConfig> streams) {
