...
public class SourceMicrosoftOnedriveParquetFormat {
    ...
    private Optional<? extends SourceMicrosoftOnedriveSchemasStreamsFormatFiletype> filetype;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<SourceMicrosoftOnedriveSchemasStreamsFormatFiletype> filetype() {
        return (Optional<SourceMicrosoftOnedriveSchemasStreamsFormatFiletype>) filetype;
    }
     ...
     * Whether to convert decimal fields to floats. There is a loss of precision when converting decimals to floats, so this is not recommended.
     */
    public SourceMicrosoftOnedriveParquetFormat withDecimalAsFloat(Optional<? extends Boolean> decimalAsFloat) {
        Utils.checkNotNull(decimalAsFloat, "decimalAsFloat");
        this.decimalAsFloat = decimalAsFloat;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends SourceMicrosoftOnedriveSchemasStreamsFormatFiletype>> _SINGLETON_VALUE_Filetype =
                new LazySingletonValue<>(
                        "filetype",
                        "\"parquet\"",
                        new TypeReference<Optional<? extends SourceMicrosoftOnedriveSchemasStreamsFormatFiletype>>() {});
    }
}
