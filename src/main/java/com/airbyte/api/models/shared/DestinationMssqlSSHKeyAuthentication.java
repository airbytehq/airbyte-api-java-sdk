...
public class DestinationMssqlSSHKeyAuthentication {
    ...
    private Optional<? extends DestinationMssqlSchemasTunnelMethod> tunnelMethod;
    ...
    public DestinationMssqlSSHKeyAuthentication(
            ...
            @JsonProperty("tunnel_method") Optional<? extends DestinationMssqlSchemasTunnelMethod> tunnelMethod,
    ...
    @JsonIgnore
    public Optional<DestinationMssqlSchemasTunnelMethod> tunnelMethod() {
        return (Optional<DestinationMssqlSchemasTunnelMethod>) tunnelMethod;
    }
    ...
    @JsonAnySetter
    public DestinationMssqlSSHKeyAuthentication withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public DestinationMssqlSSHKeyAuthentication withAdditionalProperties(Map<String, Object> additionalProperties) {
    ...
    public DestinationMssqlSSHKeyAuthentication withTunnelMethod(DestinationMssqlSchemasTunnelMethod tunnelMethod) {
        Utils.checkNotNull(tunnelMethod, "tunnelMethod");
    ...
    public DestinationMssqlSSHKeyAuthentication withTunnelMethod(Optional<? extends DestinationMssqlSchemasTunnelMethod> tunnelMethod) {
        Utils.checkNotNull(tunnelMethod, "tunnelMethod");
        this.tunnelMethod = tunnelMethod;
        return this;
    }
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationMssqlSSHKeyAuthentication withTunnelPort(Optional<Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder tunnelMethod(DestinationMssqlSchemasTunnelMethod tunnelMethod) {
            Utils.checkNotNull(tunnelMethod, "tunnelMethod");
            this.tunnelMethod = Optional.ofNullable(tunnelMethod);
            return this;
        }

        public Builder tunnelMethod(Optional<? extends DestinationMssqlSchemasTunnelMethod> tunnelMethod) {
            Utils.checkNotNull(tunnelMethod, "tunnelMethod");
            this.tunnelMethod = tunnelMethod;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<? extends DestinationMssqlSchemasTunnelMethod>> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_KEY_AUTH\"",
                        new TypeReference<Optional<? extends DestinationMssqlSchemasTunnelMethod>>() {});
