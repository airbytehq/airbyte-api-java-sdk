...
public class DestinationWeaviateProcessingConfigModel {
    ...
    private Optional<? extends java.util.List<DestinationWeaviateFieldNameMappingConfigModel>> fieldNameMappings;
    ...
    private Optional<? extends DestinationWeaviateTextSplitter> textSplitter;
    ...
    public DestinationWeaviateProcessingConfigModel(
            ...
            @JsonProperty("field_name_mappings") Optional<? extends java.util.List<DestinationWeaviateFieldNameMappingConfigModel>> fieldNameMappings,
            ...
            @JsonProperty("text_splitter") Optional<? extends DestinationWeaviateTextSplitter> textSplitter) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<DestinationWeaviateFieldNameMappingConfigModel>> fieldNameMappings() {
        return (Optional<java.util.List<DestinationWeaviateFieldNameMappingConfigModel>>) fieldNameMappings;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DestinationWeaviateTextSplitter> textSplitter() {
     ...
     * Size of overlap between chunks in tokens to store in vector store to better capture relevant context
     */
    public DestinationWeaviateProcessingConfigModel withChunkOverlap(long chunkOverlap) {
        Utils.checkNotNull(chunkOverlap, "chunkOverlap");
     ...
     * Size of overlap between chunks in tokens to store in vector store to better capture relevant context
     */
    public DestinationWeaviateProcessingConfigModel withChunkOverlap(Optional<? extends Long> chunkOverlap) {
        Utils.checkNotNull(chunkOverlap, "chunkOverlap");
        this.chunkOverlap = chunkOverlap;
        return this;
    }
     ...
     * Size of chunks in tokens to store in vector store (make sure it is not too big for the context if your LLM)
     */
    public DestinationWeaviateProcessingConfigModel withChunkSize(long chunkSize) {
        Utils.checkNotNull(chunkSize, "chunkSize");
        this.chunkSize = chunkSize;
        return this;
    }
     ...
     * List of fields to rename. Not applicable for nested fields, but can be used to rename fields already flattened via dot notation.
     */
    public DestinationWeaviateProcessingConfigModel withFieldNameMappings(java.util.List<DestinationWeaviateFieldNameMappingConfigModel> fieldNameMappings) {
        Utils.checkNotNull(fieldNameMappings, "fieldNameMappings");
     ...
     * List of fields to rename. Not applicable for nested fields, but can be used to rename fields already flattened via dot notation.
     */
    public DestinationWeaviateProcessingConfigModel withFieldNameMappings(Optional<? extends java.util.List<DestinationWeaviateFieldNameMappingConfigModel>> fieldNameMappings) {
        Utils.checkNotNull(fieldNameMappings, "fieldNameMappings");
        this.fieldNameMappings = fieldNameMappings;
        return this;
    }
     ...
     * List of fields in the record that should be stored as metadata. The field list is applied to all streams in the same way and non-existing fields are ignored. If none are defined, all fields are considered metadata fields. When specifying text fields, you can access nested fields in the record by using dot notation, e.g. `user.name` will access the `name` field in the `user` object. It's also possible to use wildcards to access all fields in an object, e.g. `users.*.name` will access all `names` fields in all entries of the `users` array. When specifying nested paths, all matching values are flattened into an array set to a field named by the path.
     */
    public DestinationWeaviateProcessingConfigModel withMetadataFields(java.util.List<String> metadataFields) {
        Utils.checkNotNull(metadataFields, "metadataFields");
     ...
     * List of fields in the record that should be stored as metadata. The field list is applied to all streams in the same way and non-existing fields are ignored. If none are defined, all fields are considered metadata fields. When specifying text fields, you can access nested fields in the record by using dot notation, e.g. `user.name` will access the `name` field in the `user` object. It's also possible to use wildcards to access all fields in an object, e.g. `users.*.name` will access all `names` fields in all entries of the `users` array. When specifying nested paths, all matching values are flattened into an array set to a field named by the path.
     */
    public DestinationWeaviateProcessingConfigModel withMetadataFields(Optional<? extends java.util.List<String>> metadataFields) {
        Utils.checkNotNull(metadataFields, "metadataFields");
        this.metadataFields = metadataFields;
        return this;
    }
     ...
     * List of fields in the record that should be used to calculate the embedding. The field list is applied to all streams in the same way and non-existing fields are ignored. If none are defined, all fields are considered text fields. When specifying text fields, you can access nested fields in the record by using dot notation, e.g. `user.name` will access the `name` field in the `user` object. It's also possible to use wildcards to access all fields in an object, e.g. `users.*.name` will access all `names` fields in all entries of the `users` array.
     */
    public DestinationWeaviateProcessingConfigModel withTextFields(java.util.List<String> textFields) {
        Utils.checkNotNull(textFields, "textFields");
     ...
     * List of fields in the record that should be used to calculate the embedding. The field list is applied to all streams in the same way and non-existing fields are ignored. If none are defined, all fields are considered text fields. When specifying text fields, you can access nested fields in the record by using dot notation, e.g. `user.name` will access the `name` field in the `user` object. It's also possible to use wildcards to access all fields in an object, e.g. `users.*.name` will access all `names` fields in all entries of the `users` array.
     */
    public DestinationWeaviateProcessingConfigModel withTextFields(Optional<? extends java.util.List<String>> textFields) {
        Utils.checkNotNull(textFields, "textFields");
        this.textFields = textFields;
        return this;
    }
     ...
     * Split text fields into chunks based on the specified method.
     */
    public DestinationWeaviateProcessingConfigModel withTextSplitter(DestinationWeaviateTextSplitter textSplitter) {
        Utils.checkNotNull(textSplitter, "textSplitter");
     ...
     * Split text fields into chunks based on the specified method.
     */
    public DestinationWeaviateProcessingConfigModel withTextSplitter(Optional<? extends DestinationWeaviateTextSplitter> textSplitter) {
        Utils.checkNotNull(textSplitter, "textSplitter");
        this.textSplitter = textSplitter;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(DestinationWeaviateProcessingConfigModel.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<DestinationWeaviateFieldNameMappingConfigModel>> fieldNameMappings = Optional.empty();
         ...
         * List of fields to rename. Not applicable for nested fields, but can be used to rename fields already flattened via dot notation.
         */
        public Builder fieldNameMappings(java.util.List<DestinationWeaviateFieldNameMappingConfigModel> fieldNameMappings) {
            Utils.checkNotNull(fieldNameMappings, "fieldNameMappings");
            this.fieldNameMappings = Optional.ofNullable(fieldNameMappings);
            return this;
        }
         ...
         * List of fields to rename. Not applicable for nested fields, but can be used to rename fields already flattened via dot notation.
         */
        public Builder fieldNameMappings(Optional<? extends java.util.List<DestinationWeaviateFieldNameMappingConfigModel>> fieldNameMappings) {
            Utils.checkNotNull(fieldNameMappings, "fieldNameMappings");
            this.fieldNameMappings = fieldNameMappings;
            return this;
        }
         ...
         * Split text fields into chunks based on the specified method.
         */
        public Builder textSplitter(DestinationWeaviateTextSplitter textSplitter) {
            Utils.checkNotNull(textSplitter, "textSplitter");
            this.textSplitter = Optional.ofNullable(textSplitter);
            return this;
        }
         ...
         * Split text fields into chunks based on the specified method.
         */
        public Builder textSplitter(Optional<? extends DestinationWeaviateTextSplitter> textSplitter) {
            Utils.checkNotNull(textSplitter, "textSplitter");
            this.textSplitter = textSplitter;
            return this;
        }
