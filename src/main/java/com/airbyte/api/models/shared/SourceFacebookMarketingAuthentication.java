    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceFacebookMarketingAuthentication> {
        ...
        public _Deserializer() {
            super(SourceFacebookMarketingAuthentication.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.AuthenticateViaFacebookMarketingOauth>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.ServiceAccountKeyAuthentication>() {}, JsonShape.DEFAULT));
        }
    }
