...
public class SourceAmazonSellerPartner {
    ...
    public SourceAmazonSellerPartner(
            ...
            String refreshToken) {
        this(Optional.empty(), Optional.empty(), Optional.empty(), lwaAppId, lwaClientSecret, Optional.empty(), refreshToken, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    }
