...
public class ConnectionsResponse {
    ...
    @JsonProperty("data")
    private java.util.List<ConnectionResponse> data;
    ...
    public ConnectionsResponse(
            @JsonProperty("data") java.util.List<ConnectionResponse> data,
    ...
    public ConnectionsResponse(
            java.util.List<ConnectionResponse> data) {
        this(data, Optional.empty(), Optional.empty());
    }

    @JsonIgnore
    public java.util.List<ConnectionResponse> data() {
        return data;
    }
    ...
    public ConnectionsResponse withData(java.util.List<ConnectionResponse> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public ConnectionsResponse withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public ConnectionsResponse withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<ConnectionResponse> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
