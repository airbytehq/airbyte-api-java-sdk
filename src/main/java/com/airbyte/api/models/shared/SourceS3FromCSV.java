...
public class SourceS3FromCSV {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceS3FromCSV other = (SourceS3FromCSV) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceS3FromCSV.class,
    ...
    public final static class Builder {  
        ...
        public SourceS3FromCSV build() {
            if (headerDefinitionType == null) {
                headerDefinitionType = _SINGLETON_VALUE_HeaderDefinitionType.value();
            }
            return new SourceS3FromCSV(
                );
        }

        private static final LazySingletonValue<Optional<? extends SourceS3HeaderDefinitionType>> _SINGLETON_VALUE_HeaderDefinitionType =
                new LazySingletonValue<>(
                        "header_definition_type",
                        "\"From CSV\"",
                        new TypeReference<Optional<? extends SourceS3HeaderDefinitionType>>() {});
    }
}
