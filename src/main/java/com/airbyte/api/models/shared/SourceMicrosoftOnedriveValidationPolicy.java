...
public enum SourceMicrosoftOnedriveValidationPolicy {
    ...
    public static Optional<SourceMicrosoftOnedriveValidationPolicy> fromValue(String value) {
        for (SourceMicrosoftOnedriveValidationPolicy o: SourceMicrosoftOnedriveValidationPolicy.values()) {
