...
public class DestinationSnowflakeCortexBySeparator {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("mode")
    private Optional<? extends DestinationSnowflakeCortexSchemasProcessingMode> mode;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DestinationSnowflakeCortexSchemasProcessingMode> mode() {
        return (Optional<DestinationSnowflakeCortexSchemasProcessingMode>) mode;
    }
     ...
     * Whether to keep the separator in the resulting chunks
     */
    public DestinationSnowflakeCortexBySeparator withKeepSeparator(boolean keepSeparator) {
        Utils.checkNotNull(keepSeparator, "keepSeparator");
     ...
     * Whether to keep the separator in the resulting chunks
     */
    public DestinationSnowflakeCortexBySeparator withKeepSeparator(Optional<? extends Boolean> keepSeparator) {
        Utils.checkNotNull(keepSeparator, "keepSeparator");
        this.keepSeparator = keepSeparator;
        return this;
    }
     ...
     * List of separator strings to split text fields by. The separator itself needs to be wrapped in double quotes, e.g. to split by the dot character, use ".". To split by a newline, use "\n".
     */
    public DestinationSnowflakeCortexBySeparator withSeparators(java.util.List<String> separators) {
        Utils.checkNotNull(separators, "separators");
     ...
     * List of separator strings to split text fields by. The separator itself needs to be wrapped in double quotes, e.g. to split by the dot character, use ".". To split by a newline, use "\n".
     */
    public DestinationSnowflakeCortexBySeparator withSeparators(Optional<? extends java.util.List<String>> separators) {
        Utils.checkNotNull(separators, "separators");
        this.separators = separators;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationSnowflakeCortexBySeparator other = (DestinationSnowflakeCortexBySeparator) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationSnowflakeCortexBySeparator.class,
    ...
    public final static class Builder {
        ...
        public DestinationSnowflakeCortexBySeparator build() {
            if (keepSeparator == null) {
                keepSeparator = _SINGLETON_VALUE_KeepSeparator.value();
            }
            return new DestinationSnowflakeCortexBySeparator(
                keepSeparator,
                separators);
        }
        ...
        private static final LazySingletonValue<Optional<? extends DestinationSnowflakeCortexSchemasProcessingMode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"separator\"",
                        new TypeReference<Optional<? extends DestinationSnowflakeCortexSchemasProcessingMode>>() {});
    }
}
