...
public class AuthenticateViaStorageAccountKey {
    ...
    private Optional<? extends SourceAzureBlobStorageSchemasCredentialsAuthType> authType;
    ...
    @JsonIgnore
    public Optional<SourceAzureBlobStorageSchemasCredentialsAuthType> authType() {
        return (Optional<SourceAzureBlobStorageSchemasCredentialsAuthType>) authType;
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends SourceAzureBlobStorageSchemasCredentialsAuthType>> _SINGLETON_VALUE_AuthType =
                new LazySingletonValue<>(
                        "auth_type",
                        "\"storage_account_key\"",
                        new TypeReference<Optional<? extends SourceAzureBlobStorageSchemasCredentialsAuthType>>() {});
    }
}
