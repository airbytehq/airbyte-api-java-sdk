...
public class SourceSftpBulkCSVFormat {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<SourceSftpBulkInferenceType> inferenceType() {
        return (Optional<SourceSftpBulkInferenceType>) inferenceType;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as false values.
     */
    public SourceSftpBulkCSVFormat withFalseValues(java.util.List<String> falseValues) {
        Utils.checkNotNull(falseValues, "falseValues");
     ...
     * A set of case-sensitive strings that should be interpreted as false values.
     */
    public SourceSftpBulkCSVFormat withFalseValues(Optional<? extends java.util.List<String>> falseValues) {
        Utils.checkNotNull(falseValues, "falseValues");
        this.falseValues = falseValues;
        return this;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as null values. For example, if the value 'NA' should be interpreted as null, enter 'NA' in this field.
     */
    public SourceSftpBulkCSVFormat withNullValues(java.util.List<String> nullValues) {
        Utils.checkNotNull(nullValues, "nullValues");
     ...
     * A set of case-sensitive strings that should be interpreted as null values. For example, if the value 'NA' should be interpreted as null, enter 'NA' in this field.
     */
    public SourceSftpBulkCSVFormat withNullValues(Optional<? extends java.util.List<String>> nullValues) {
        Utils.checkNotNull(nullValues, "nullValues");
        this.nullValues = nullValues;
        return this;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as true values.
     */
    public SourceSftpBulkCSVFormat withTrueValues(java.util.List<String> trueValues) {
        Utils.checkNotNull(trueValues, "trueValues");
     ...
     * A set of case-sensitive strings that should be interpreted as true values.
     */
    public SourceSftpBulkCSVFormat withTrueValues(Optional<? extends java.util.List<String>> trueValues) {
        Utils.checkNotNull(trueValues, "trueValues");
        this.trueValues = trueValues;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends SourceSftpBulkInferenceType>> _SINGLETON_VALUE_InferenceType =
                new LazySingletonValue<>(
                        "inference_type",
                        "\"None\"",
                        new TypeReference<Optional<? extends SourceSftpBulkInferenceType>>() {});
