...
public class AuthenticateViaGoogleOAuth {
    ...
    private Optional<? extends DestinationGoogleSheetsAuthType> authType;
    ...
    @JsonIgnore
    public Optional<DestinationGoogleSheetsAuthType> authType() {
        return (Optional<DestinationGoogleSheetsAuthType>) authType;
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends DestinationGoogleSheetsAuthType>> _SINGLETON_VALUE_AuthType =
                new LazySingletonValue<>(
                        "auth_type",
                        "\"oauth2.0\"",
                        new TypeReference<Optional<? extends DestinationGoogleSheetsAuthType>>() {});
    }
}
