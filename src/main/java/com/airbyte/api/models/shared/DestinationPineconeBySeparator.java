...
public class DestinationPineconeBySeparator {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("mode")
    private Optional<? extends DestinationPineconeSchemasProcessingMode> mode;
    ...
    @JsonCreator
    public DestinationPineconeBySeparator(
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DestinationPineconeSchemasProcessingMode> mode() {
        return (Optional<DestinationPineconeSchemasProcessingMode>) mode;
    }
     ...
     * Whether to keep the separator in the resulting chunks
     */
    public DestinationPineconeBySeparator withKeepSeparator(boolean keepSeparator) {
        Utils.checkNotNull(keepSeparator, "keepSeparator");
     ...
     * Whether to keep the separator in the resulting chunks
     */
    public DestinationPineconeBySeparator withKeepSeparator(Optional<? extends Boolean> keepSeparator) {
        Utils.checkNotNull(keepSeparator, "keepSeparator");
        this.keepSeparator = keepSeparator;
        return this;
    }
     ...
     * List of separator strings to split text fields by. The separator itself needs to be wrapped in double quotes, e.g. to split by the dot character, use ".". To split by a newline, use "\n".
     */
    public DestinationPineconeBySeparator withSeparators(java.util.List<String> separators) {
        Utils.checkNotNull(separators, "separators");
     ...
     * List of separator strings to split text fields by. The separator itself needs to be wrapped in double quotes, e.g. to split by the dot character, use ".". To split by a newline, use "\n".
     */
    public DestinationPineconeBySeparator withSeparators(Optional<? extends java.util.List<String>> separators) {
        Utils.checkNotNull(separators, "separators");
        this.separators = separators;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationPineconeBySeparator other = (DestinationPineconeBySeparator) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationPineconeBySeparator.class,
    ...
    public final static class Builder {
        ...
        public DestinationPineconeBySeparator build() {
            if (keepSeparator == null) {
                keepSeparator = _SINGLETON_VALUE_KeepSeparator.value();
            }
            return new DestinationPineconeBySeparator(
                keepSeparator,
                separators);
        }
        ...
        private static final LazySingletonValue<Optional<? extends DestinationPineconeSchemasProcessingMode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"separator\"",
                        new TypeReference<Optional<? extends DestinationPineconeSchemasProcessingMode>>() {});
    }
}
