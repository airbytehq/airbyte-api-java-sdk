...
public class SourceGithubAuthentication {
    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceGithubAuthentication> {

        public _Deserializer() {
            super(SourceGithubAuthentication.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.OAuth>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceGithubPersonalAccessToken>() {}, JsonShape.DEFAULT));
        }
    }
