...
public class DestinationPgvectorBySeparator {
    ...
    @JsonCreator
    public DestinationPgvectorBySeparator(
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DestinationPgvectorSchemasProcessingMode> mode() {
        return (Optional<DestinationPgvectorSchemasProcessingMode>) mode;
    }
     ...
     * Whether to keep the separator in the resulting chunks
     */
    public DestinationPgvectorBySeparator withKeepSeparator(boolean keepSeparator) {
        Utils.checkNotNull(keepSeparator, "keepSeparator");
     ...
     * Whether to keep the separator in the resulting chunks
     */
    public DestinationPgvectorBySeparator withKeepSeparator(Optional<? extends Boolean> keepSeparator) {
        Utils.checkNotNull(keepSeparator, "keepSeparator");
        this.keepSeparator = keepSeparator;
        return this;
    }
     ...
     * List of separator strings to split text fields by. The separator itself needs to be wrapped in double quotes, e.g. to split by the dot character, use ".". To split by a newline, use "\n".
     */
    public DestinationPgvectorBySeparator withSeparators(java.util.List<String> separators) {
        Utils.checkNotNull(separators, "separators");
     ...
     * List of separator strings to split text fields by. The separator itself needs to be wrapped in double quotes, e.g. to split by the dot character, use ".". To split by a newline, use "\n".
     */
    public DestinationPgvectorBySeparator withSeparators(Optional<? extends java.util.List<String>> separators) {
        Utils.checkNotNull(separators, "separators");
        this.separators = separators;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(DestinationPgvectorBySeparator.class,
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends DestinationPgvectorSchemasProcessingMode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"separator\"",
                        new TypeReference<Optional<? extends DestinationPgvectorSchemasProcessingMode>>() {});
    }
}
