...
public class DestinationDynamodb {
    ...
    public DestinationDynamodb(
            ...
            @JsonProperty("dynamodb_endpoint") Optional<String> dynamodbEndpoint,
     ...
     * This is your DynamoDB endpoint url.(if you are working with AWS DynamoDB, just leave empty).
     */
    public DestinationDynamodb withDynamodbEndpoint(Optional<String> dynamodbEndpoint) {
        Utils.checkNotNull(dynamodbEndpoint, "dynamodbEndpoint");
        this.dynamodbEndpoint = dynamodbEndpoint;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * This is your DynamoDB endpoint url.(if you are working with AWS DynamoDB, just leave empty).
         */
        public Builder dynamodbEndpoint(Optional<String> dynamodbEndpoint) {
            Utils.checkNotNull(dynamodbEndpoint, "dynamodbEndpoint");
            this.dynamodbEndpoint = dynamodbEndpoint;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_DynamodbEndpoint =
                new LazySingletonValue<>(
                        "dynamodb_endpoint",
                        "\"\"",
