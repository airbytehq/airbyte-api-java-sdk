...
public class DestinationS3JSONLinesNewlineDelimitedJSON {
    ...
    public DestinationS3JSONLinesNewlineDelimitedJSON withFlattening(DestinationS3Flattening flattening) {
        Utils.checkNotNull(flattening, "flattening");
        this.flattening = Optional.ofNullable(flattening);
        return this;
    }

    public DestinationS3JSONLinesNewlineDelimitedJSON withFlattening(Optional<? extends DestinationS3Flattening> flattening) {
        Utils.checkNotNull(flattening, "flattening");
        this.flattening = flattening;
        return this;
    }
