...
public class SourceTrustpilotAuthorizationMethod {
     ...
     * <ul>
     * <li>{@code com.airbyte.api.models.shared.SourceTrustpilotOAuth20}</li>
     * <li>{@code com.airbyte.api.models.shared.SourceTrustpilotAPIKey}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceTrustpilotAuthorizationMethod> {

        public _Deserializer() {
            super(SourceTrustpilotAuthorizationMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<SourceTrustpilotOAuth20>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<SourceTrustpilotAPIKey>() {}, JsonShape.DEFAULT));
        }
    }
