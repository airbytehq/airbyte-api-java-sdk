...
public class SourceSftpBulkAPIParameterConfigModel {
    ...
    @JsonCreator
    public SourceSftpBulkAPIParameterConfigModel(
     ...
     * The name of the unstructured API parameter to use
     */
    public SourceSftpBulkAPIParameterConfigModel withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The value of the parameter
     */
    public SourceSftpBulkAPIParameterConfigModel withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(SourceSftpBulkAPIParameterConfigModel.class,
                "name", name,
                "value", value);
    }
