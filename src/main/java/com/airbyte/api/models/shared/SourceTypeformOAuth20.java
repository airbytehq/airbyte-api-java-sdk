...
public class SourceTypeformOAuth20 {
    ...
    private Optional<? extends SourceTypeformAuthType> authType;
     ...
     * Access Token for making authenticated requests.
     */
    public SourceTypeformOAuth20 withAccessToken(String accessToken) {
        Utils.checkNotNull(accessToken, "accessToken");
        this.accessToken = accessToken;
        return this;
    }
     ...
     * The Client ID of the Typeform developer application.
     */
    public SourceTypeformOAuth20 withClientId(String clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The Client Secret the Typeform developer application.
     */
    public SourceTypeformOAuth20 withClientSecret(String clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
     ...
     * The key to refresh the expired access_token.
     */
    public SourceTypeformOAuth20 withRefreshToken(String refreshToken) {
        Utils.checkNotNull(refreshToken, "refreshToken");
        this.refreshToken = refreshToken;
        return this;
    }
     ...
     * The date-time when the access token should be refreshed.
     */
    public SourceTypeformOAuth20 withTokenExpiryDate(OffsetDateTime tokenExpiryDate) {
        Utils.checkNotNull(tokenExpiryDate, "tokenExpiryDate");
        this.tokenExpiryDate = tokenExpiryDate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceTypeformOAuth20 other = (SourceTypeformOAuth20) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceTypeformOAuth20.class,
    ...
    public final static class Builder {
        ...
        public SourceTypeformOAuth20 build() {
            return new SourceTypeformOAuth20(
                accessToken,
                clientId,
                clientSecret,
                refreshToken,
        ...
        private static final LazySingletonValue<Optional<? extends SourceTypeformAuthType>> _SINGLETON_VALUE_AuthType =
                new LazySingletonValue<>(
                        "auth_type",
                        "\"oauth2.0\"",
                        new TypeReference<Optional<? extends SourceTypeformAuthType>>() {});
    }
}
