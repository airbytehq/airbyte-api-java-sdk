...
public class SourceMyHours {
    ...
    public SourceMyHours(
            ...
            @JsonProperty("logs_batch_size") Optional<Long> logsBatchSize,
     ...
     * Pagination size used for retrieving logs in days
     */
    public SourceMyHours withLogsBatchSize(Optional<Long> logsBatchSize) {
        Utils.checkNotNull(logsBatchSize, "logsBatchSize");
        this.logsBatchSize = logsBatchSize;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Pagination size used for retrieving logs in days
         */
        public Builder logsBatchSize(Optional<Long> logsBatchSize) {
            Utils.checkNotNull(logsBatchSize, "logsBatchSize");
            this.logsBatchSize = logsBatchSize;
            return this;
        }
