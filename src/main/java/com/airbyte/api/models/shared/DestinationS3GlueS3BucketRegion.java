 ...
 */
public enum DestinationS3GlueS3BucketRegion {
    UNKNOWN(""),
    ...
    private DestinationS3GlueS3BucketRegion(String value) {
        this.value = value;
    }
    ...
    public static Optional<DestinationS3GlueS3BucketRegion> fromValue(String value) {
        for (DestinationS3GlueS3BucketRegion o: DestinationS3GlueS3BucketRegion.values()) {
