 ...
 */
public enum SourceMicrosoftOnedriveParsingStrategy {
    AUTO("auto"),
    FAST("fast"),
    OCR_ONLY("ocr_only"),
    HI_RES("hi_res");
    ...
    public static Optional<SourceMicrosoftOnedriveParsingStrategy> fromValue(String value) {
        for (SourceMicrosoftOnedriveParsingStrategy o: SourceMicrosoftOnedriveParsingStrategy.values()) {
