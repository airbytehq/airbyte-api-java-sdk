...
public class DestinationYellowbrickVerifyFull {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("mode")
    private Optional<? extends DestinationYellowbrickSchemasSSLModeSSLModes6Mode> mode;

    @JsonCreator
    public DestinationYellowbrickVerifyFull(
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DestinationYellowbrickSchemasSSLModeSSLModes6Mode> mode() {
        return (Optional<DestinationYellowbrickSchemasSSLModeSSLModes6Mode>) mode;
    }
     ...
     * CA certificate
     */
    public DestinationYellowbrickVerifyFull withCaCertificate(String caCertificate) {
        Utils.checkNotNull(caCertificate, "caCertificate");
        this.caCertificate = caCertificate;
        return this;
    }
     ...
     * Client certificate
     */
    public DestinationYellowbrickVerifyFull withClientCertificate(String clientCertificate) {
        Utils.checkNotNull(clientCertificate, "clientCertificate");
        this.clientCertificate = clientCertificate;
        return this;
    }
     ...
     * Client key
     */
    public DestinationYellowbrickVerifyFull withClientKey(String clientKey) {
        Utils.checkNotNull(clientKey, "clientKey");
        this.clientKey = clientKey;
        return this;
    }
     ...
     * Password for keystorage. This field is optional. If you do not add it - the password will be generated automatically.
     */
    public DestinationYellowbrickVerifyFull withClientKeyPassword(String clientKeyPassword) {
        Utils.checkNotNull(clientKeyPassword, "clientKeyPassword");
     ...
     * Password for keystorage. This field is optional. If you do not add it - the password will be generated automatically.
     */
    public DestinationYellowbrickVerifyFull withClientKeyPassword(Optional<? extends String> clientKeyPassword) {
        Utils.checkNotNull(clientKeyPassword, "clientKeyPassword");
        this.clientKeyPassword = clientKeyPassword;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationYellowbrickVerifyFull other = (DestinationYellowbrickVerifyFull) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationYellowbrickVerifyFull.class,
    ...
    public final static class Builder {
        ...
        public DestinationYellowbrickVerifyFull build() {
            return new DestinationYellowbrickVerifyFull(
                caCertificate,
                clientCertificate,
                clientKey,
                clientKeyPassword);
        ...
        private static final LazySingletonValue<Optional<? extends DestinationYellowbrickSchemasSSLModeSSLModes6Mode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"verify-full\"",
                        new TypeReference<Optional<? extends DestinationYellowbrickSchemasSSLModeSSLModes6Mode>>() {});
    }
}
