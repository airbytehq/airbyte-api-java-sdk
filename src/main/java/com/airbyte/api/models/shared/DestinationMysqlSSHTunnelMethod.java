    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationMysqlSSHTunnelMethod> {
        ...
        public _Deserializer() {
            super(DestinationMysqlSSHTunnelMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationMysqlPasswordAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationMysqlSSHKeyAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationMysqlNoTunnel>() {}, JsonShape.DEFAULT));
        }
    }
