...
public class EncryptedVerifyCertificate {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("name")
    private Optional<? extends DestinationMssqlSchemasName> name;
    ...
    public EncryptedVerifyCertificate(
            ...
            @JsonProperty("name") Optional<? extends DestinationMssqlSchemasName> name,
    ...
    @JsonIgnore
    public Optional<DestinationMssqlSchemasName> name() {
        return (Optional<DestinationMssqlSchemasName>) name;
    }
    ...
    @JsonAnySetter
    public EncryptedVerifyCertificate withAdditionalProperty(String key, Object value) {
    ...
    public EncryptedVerifyCertificate withAdditionalProperties(Map<String, Object> additionalProperties) {
    ...
    public EncryptedVerifyCertificate withName(DestinationMssqlSchemasName name) {
        Utils.checkNotNull(name, "name");
        this.name = Optional.ofNullable(name);
        return this;
    }

    public EncryptedVerifyCertificate withName(Optional<? extends DestinationMssqlSchemasName> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Specifies the name of the trust store.
     */
    public EncryptedVerifyCertificate withTrustStoreName(String trustStoreName) {
        Utils.checkNotNull(trustStoreName, "trustStoreName");
     ...
     * Specifies the name of the trust store.
     */
    public EncryptedVerifyCertificate withTrustStoreName(Optional<String> trustStoreName) {
        Utils.checkNotNull(trustStoreName, "trustStoreName");
        this.trustStoreName = trustStoreName;
        return this;
    }
     ...
     * Specifies the password of the trust store.
     */
    public EncryptedVerifyCertificate withTrustStorePassword(String trustStorePassword) {
        Utils.checkNotNull(trustStorePassword, "trustStorePassword");
     ...
     * Specifies the password of the trust store.
     */
    public EncryptedVerifyCertificate withTrustStorePassword(Optional<String> trustStorePassword) {
        Utils.checkNotNull(trustStorePassword, "trustStorePassword");
        this.trustStorePassword = trustStorePassword;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder name(DestinationMssqlSchemasName name) {
            Utils.checkNotNull(name, "name");
            this.name = Optional.ofNullable(name);
            return this;
        }

        public Builder name(Optional<? extends DestinationMssqlSchemasName> name) {
            Utils.checkNotNull(name, "name");
            this.name = name;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<? extends DestinationMssqlSchemasName>> _SINGLETON_VALUE_Name =
                new LazySingletonValue<>(
                        "name",
                        "\"encrypted_verify_certificate\"",
                        new TypeReference<Optional<? extends DestinationMssqlSchemasName>>() {});
    }
}
