...
public class SourceMysqlPasswordAuthentication {
    ...
    private SourceMysqlSchemasTunnelMethodTunnelMethod tunnelMethod;
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public SourceMysqlPasswordAuthentication withTunnelPort(Optional<? extends Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<SourceMysqlSchemasTunnelMethodTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_PASSWORD_AUTH\"",
                        new TypeReference<SourceMysqlSchemasTunnelMethodTunnelMethod>() {});
