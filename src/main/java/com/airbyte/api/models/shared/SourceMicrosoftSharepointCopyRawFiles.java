 ...
 */
public class SourceMicrosoftSharepointCopyRawFiles {

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("delivery_type")
    private Optional<? extends SourceMicrosoftSharepointSchemasDeliveryType> deliveryType;
    ...
    @JsonCreator
    public SourceMicrosoftSharepointCopyRawFiles(
    ...
    @JsonIgnore
    public Optional<SourceMicrosoftSharepointSchemasDeliveryType> deliveryType() {
        return (Optional<SourceMicrosoftSharepointSchemasDeliveryType>) deliveryType;
    }
     ...
     * If enabled, sends subdirectory folder structure along with source file names to the destination. Otherwise, files will be synced by their names only. This option is ignored when file-based replication is not enabled.
     */
    public SourceMicrosoftSharepointCopyRawFiles withPreserveDirectoryStructure(boolean preserveDirectoryStructure) {
        Utils.checkNotNull(preserveDirectoryStructure, "preserveDirectoryStructure");
     ...
     * If enabled, sends subdirectory folder structure along with source file names to the destination. Otherwise, files will be synced by their names only. This option is ignored when file-based replication is not enabled.
     */
    public SourceMicrosoftSharepointCopyRawFiles withPreserveDirectoryStructure(Optional<Boolean> preserveDirectoryStructure) {
        Utils.checkNotNull(preserveDirectoryStructure, "preserveDirectoryStructure");
        this.preserveDirectoryStructure = preserveDirectoryStructure;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(SourceMicrosoftSharepointCopyRawFiles.class,
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends SourceMicrosoftSharepointSchemasDeliveryType>> _SINGLETON_VALUE_DeliveryType =
                new LazySingletonValue<>(
                        "delivery_type",
                        "\"use_file_transfer\"",
                        new TypeReference<Optional<? extends SourceMicrosoftSharepointSchemasDeliveryType>>() {});
