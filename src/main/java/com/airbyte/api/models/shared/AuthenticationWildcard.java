 ...
 * 
 * <p>Choose how to authenticate to Mixpanel
 */
...
public class AuthenticationWildcard {
     ...
     * <ul>
     * <li>{@code com.airbyte.api.models.shared.ServiceAccount}</li>
     * <li>{@code com.airbyte.api.models.shared.ProjectSecret}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<AuthenticationWildcard> {

        public _Deserializer() {
            super(AuthenticationWildcard.class, false,
                  TypeReferenceWithShape.of(new TypeReference<ServiceAccount>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<ProjectSecret>() {}, JsonShape.DEFAULT));
        }
    }
