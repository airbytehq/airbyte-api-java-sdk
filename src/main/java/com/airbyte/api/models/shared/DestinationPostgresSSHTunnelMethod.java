    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationPostgresSSHTunnelMethod> {
        ...
        public _Deserializer() {
            super(DestinationPostgresSSHTunnelMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationPostgresPasswordAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationPostgresSSHKeyAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationPostgresNoTunnel>() {}, JsonShape.DEFAULT));
        }
    }
