...
public class JobsResponse {
    ...
    @JsonCreator
    public JobsResponse(
            @JsonProperty("data") java.util.List<JobResponse> data,
    ...
    public JobsResponse(
            java.util.List<JobResponse> data) {
        this(data, Optional.empty(), Optional.empty());
    }

    @JsonIgnore
    public java.util.List<JobResponse> data() {
        return data;
    }
    ...
    public JobsResponse withData(java.util.List<JobResponse> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public JobsResponse withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public JobsResponse withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<JobResponse> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
