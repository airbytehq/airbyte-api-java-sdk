...
public class SourceSlackAuthenticationMechanism {
     ...
     * <ul>
     * <li>{@code SignInViaSlackOAuth}</li>
     * <li>{@code SourceSlackAPIToken}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<SourceSlackAuthenticationMechanism> {

        public _Deserializer() {
            super(SourceSlackAuthenticationMechanism.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<SignInViaSlackOAuth>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceSlackAPIToken>() {}, Utils.JsonShape.DEFAULT));
        }
    }
