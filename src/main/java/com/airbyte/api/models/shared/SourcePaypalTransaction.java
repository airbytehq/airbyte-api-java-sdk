...
public class SourcePaypalTransaction {
    ...
    public SourcePaypalTransaction(
            ...
            @JsonProperty("dispute_start_date") Optional<OffsetDateTime> disputeStartDate,
            ...
            @JsonProperty("time_window") Optional<Long> timeWindow) {
     ...
     * Determines whether to use the sandbox or production environment.
     */
    public SourcePaypalTransaction withIsSandbox(Optional<Boolean> isSandbox) {
        Utils.checkNotNull(isSandbox, "isSandbox");
        this.isSandbox = isSandbox;
        return this;
    }
     ...
     * The key to refresh the expired access token.
     */
    public SourcePaypalTransaction withRefreshToken(Optional<String> refreshToken) {
        Utils.checkNotNull(refreshToken, "refreshToken");
        this.refreshToken = refreshToken;
        return this;
    }
     ...
     * The number of days per request. Must be a number between 1 and 31.
     */
    public SourcePaypalTransaction withTimeWindow(Optional<Long> timeWindow) {
        Utils.checkNotNull(timeWindow, "timeWindow");
        this.timeWindow = timeWindow;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * The number of days per request. Must be a number between 1 and 31.
         */
        public Builder timeWindow(Optional<Long> timeWindow) {
            Utils.checkNotNull(timeWindow, "timeWindow");
            this.timeWindow = timeWindow;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<Long>> _SINGLETON_VALUE_TimeWindow =
                new LazySingletonValue<>(
                        "time_window",
                        "7",
