...
public class SourceOutbrainAmplify {
    ...
    private Optional<? extends DefinitionOfConversionCountInReports> conversionCount;
    ...
    public SourceOutbrainAmplify(
            @JsonProperty("conversion_count") Optional<? extends DefinitionOfConversionCountInReports> conversionCount,
    ...
    @JsonIgnore
    public Optional<DefinitionOfConversionCountInReports> conversionCount() {
        return (Optional<DefinitionOfConversionCountInReports>) conversionCount;
    }
    ...
    public SourceOutbrainAmplify withConversionCount(DefinitionOfConversionCountInReports conversionCount) {
        Utils.checkNotNull(conversionCount, "conversionCount");
        this.conversionCount = Optional.ofNullable(conversionCount);
        return this;
    }
