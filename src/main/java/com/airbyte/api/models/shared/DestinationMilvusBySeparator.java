...
public class DestinationMilvusBySeparator {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("mode")
    private Optional<? extends DestinationMilvusSchemasProcessingMode> mode;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DestinationMilvusSchemasProcessingMode> mode() {
        return (Optional<DestinationMilvusSchemasProcessingMode>) mode;
    }
     ...
     * Whether to keep the separator in the resulting chunks
     */
    public DestinationMilvusBySeparator withKeepSeparator(boolean keepSeparator) {
        Utils.checkNotNull(keepSeparator, "keepSeparator");
     ...
     * Whether to keep the separator in the resulting chunks
     */
    public DestinationMilvusBySeparator withKeepSeparator(Optional<? extends Boolean> keepSeparator) {
        Utils.checkNotNull(keepSeparator, "keepSeparator");
        this.keepSeparator = keepSeparator;
        return this;
    }
     ...
     * List of separator strings to split text fields by. The separator itself needs to be wrapped in double quotes, e.g. to split by the dot character, use ".". To split by a newline, use "\n".
     */
    public DestinationMilvusBySeparator withSeparators(java.util.List<String> separators) {
        Utils.checkNotNull(separators, "separators");
     ...
     * List of separator strings to split text fields by. The separator itself needs to be wrapped in double quotes, e.g. to split by the dot character, use ".". To split by a newline, use "\n".
     */
    public DestinationMilvusBySeparator withSeparators(Optional<? extends java.util.List<String>> separators) {
        Utils.checkNotNull(separators, "separators");
        this.separators = separators;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationMilvusBySeparator other = (DestinationMilvusBySeparator) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationMilvusBySeparator.class,
    ...
    public final static class Builder {
        ...
        public DestinationMilvusBySeparator build() {
        ...
        private static final LazySingletonValue<Optional<? extends DestinationMilvusSchemasProcessingMode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"separator\"",
                        new TypeReference<Optional<? extends DestinationMilvusSchemasProcessingMode>>() {});
    }
}
