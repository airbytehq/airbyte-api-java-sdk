    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationWeaviateAuthentication> {
        ...
        public _Deserializer() {
            super(DestinationWeaviateAuthentication.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationWeaviateUsernamePassword>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationWeaviateAPIToken>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.NoAuthentication>() {}, JsonShape.DEFAULT));
        }
    }
