...
public class SourceMonday {
    /**
     * The IDs of the boards that the Items and Boards streams will extract records from. When left empty,
     * streams will extract records from all boards that exist within the account.
     */
