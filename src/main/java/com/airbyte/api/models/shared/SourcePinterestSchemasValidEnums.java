...
public enum SourcePinterestSchemasValidEnums {
    ...
    public static Optional<SourcePinterestSchemasValidEnums> fromValue(String value) {
        for (SourcePinterestSchemasValidEnums o: SourcePinterestSchemasValidEnums.values()) {
