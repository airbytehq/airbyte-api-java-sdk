...
public class SourceShipstation {
    ...
    public SourceShipstation withStartDate(OffsetDateTime startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }

    public SourceShipstation withUsername(String username) {
        Utils.checkNotNull(username, "username");
        this.username = username;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(SourceShipstation.class,
                "password", password,
