...
public class SourceSftpBulkAuthentication {
     ...
     * <ul>
     * <li>{@code AuthenticateViaPassword}</li>
     * <li>{@code AuthenticateViaPrivateKey}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<SourceSftpBulkAuthentication> {

        public _Deserializer() {
            super(SourceSftpBulkAuthentication.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<AuthenticateViaPassword>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<AuthenticateViaPrivateKey>() {}, Utils.JsonShape.DEFAULT));
        }
    }
