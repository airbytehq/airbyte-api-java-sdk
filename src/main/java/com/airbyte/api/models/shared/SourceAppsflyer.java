...
public class SourceAppsflyer {
    /**
     * Pull API token for authentication. If you change the account admin, the token changes, and you must
     * update scripts with the new token. <a
     * href="https://support.appsflyer.com/hc/en-us/articles/360004562377">Get the API token in the
     * Dashboard</a>.
     */
    ...
    /**
     * The default value to use if no bookmark exists for an endpoint. Raw Reports historical lookback is
     * limited to 90 days.
     */
    ...
    /**
     * Time zone in which date times are stored. The project timezone may be found in the App settings in
     * the AppsFlyer console.
     */
