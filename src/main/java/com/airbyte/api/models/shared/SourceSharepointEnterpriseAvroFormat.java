...
public class SourceSharepointEnterpriseAvroFormat {
    ...
    private Optional<? extends SourceSharepointEnterpriseFiletype> filetype;

    @JsonCreator
    public SourceSharepointEnterpriseAvroFormat(
    ...
    @JsonIgnore
    public Optional<SourceSharepointEnterpriseFiletype> filetype() {
        return (Optional<SourceSharepointEnterpriseFiletype>) filetype;
    }
     ...
     * Whether to convert double fields to strings. This is recommended if you have decimal numbers with a high degree of precision because there can be a loss precision when handling floating point numbers.
     */
    public SourceSharepointEnterpriseAvroFormat withDoubleAsString(boolean doubleAsString) {
        Utils.checkNotNull(doubleAsString, "doubleAsString");
     ...
     * Whether to convert double fields to strings. This is recommended if you have decimal numbers with a high degree of precision because there can be a loss precision when handling floating point numbers.
     */
    public SourceSharepointEnterpriseAvroFormat withDoubleAsString(Optional<Boolean> doubleAsString) {
        Utils.checkNotNull(doubleAsString, "doubleAsString");
        this.doubleAsString = doubleAsString;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceSharepointEnterpriseAvroFormat other = (SourceSharepointEnterpriseAvroFormat) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceSharepointEnterpriseAvroFormat.class,
    ...
    public final static class Builder {
        ...
        public SourceSharepointEnterpriseAvroFormat build() {
            if (doubleAsString == null) {
                doubleAsString = _SINGLETON_VALUE_DoubleAsString.value();
            }
            return new SourceSharepointEnterpriseAvroFormat(
                doubleAsString);
        }
        ...
        private static final LazySingletonValue<Optional<? extends SourceSharepointEnterpriseFiletype>> _SINGLETON_VALUE_Filetype =
                new LazySingletonValue<>(
                        "filetype",
                        "\"avro\"",
                        new TypeReference<Optional<? extends SourceSharepointEnterpriseFiletype>>() {});
    }
}
