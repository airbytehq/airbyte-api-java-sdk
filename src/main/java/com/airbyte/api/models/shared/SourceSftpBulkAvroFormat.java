...
public class SourceSftpBulkAvroFormat {
    ...
    private Optional<? extends SourceSftpBulkFiletype> filetype;

    @JsonCreator
    public SourceSftpBulkAvroFormat(
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<SourceSftpBulkFiletype> filetype() {
     ...
     * Whether to convert double fields to strings. This is recommended if you have decimal numbers with a high degree of precision because there can be a loss precision when handling floating point numbers.
     */
    public SourceSftpBulkAvroFormat withDoubleAsString(Optional<? extends Boolean> doubleAsString) {
        Utils.checkNotNull(doubleAsString, "doubleAsString");
        this.doubleAsString = doubleAsString;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(SourceSftpBulkAvroFormat.class,
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends SourceSftpBulkFiletype>> _SINGLETON_VALUE_Filetype =
                new LazySingletonValue<>(
                        "filetype",
                        "\"avro\"",
                        new TypeReference<Optional<? extends SourceSftpBulkFiletype>>() {});
    }
}
