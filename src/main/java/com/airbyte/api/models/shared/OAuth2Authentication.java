 ...
 * 
 * <p>Authenticate using OAuth2. This requires a consumer key, the private part of the certificate with
 * which netsuite OAuth2 Client Credentials was setup and the certificate ID for the OAuth2 setup
 * entry.
 */
public class OAuth2Authentication {
    ...
    /**
     * The private portion of the certificate with which OAuth2 was setup. ( created with openssl req -new
     * -x509 -newkey rsa:4096 -keyout private.pem -sigopt rsa_padding_mode:pss -sha256 -sigopt
     * rsa_pss_saltlen:64 -out public.pem -nodes -days 365 )
     */
