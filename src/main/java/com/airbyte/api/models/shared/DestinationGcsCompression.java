    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationGcsCompression> {
        ...
        public _Deserializer() {
            super(DestinationGcsCompression.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationGcsGZIP>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationGcsSchemasNoCompression>() {}, JsonShape.DEFAULT));
        }
    }
