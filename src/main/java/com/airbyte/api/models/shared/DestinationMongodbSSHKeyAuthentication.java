...
public class DestinationMongodbSSHKeyAuthentication {
    ...
    private DestinationMongodbSchemasTunnelMethod tunnelMethod;
    ...
    @JsonCreator
    public DestinationMongodbSSHKeyAuthentication(
     ...
     */
    @JsonIgnore
    public DestinationMongodbSchemasTunnelMethod tunnelMethod() {
        return tunnelMethod;
    }
     ...
     * OS-level user account ssh key credentials in RSA PEM format ( created with ssh-keygen -t rsa -m PEM -f myuser_rsa )
     */
    public DestinationMongodbSSHKeyAuthentication withSshKey(String sshKey) {
        Utils.checkNotNull(sshKey, "sshKey");
        this.sshKey = sshKey;
        return this;
    }
     ...
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    public DestinationMongodbSSHKeyAuthentication withTunnelHost(String tunnelHost) {
        Utils.checkNotNull(tunnelHost, "tunnelHost");
        this.tunnelHost = tunnelHost;
        return this;
    }
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationMongodbSSHKeyAuthentication withTunnelPort(long tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationMongodbSSHKeyAuthentication withTunnelPort(Optional<? extends Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
     ...
     * OS-level username for logging into the jump server host.
     */
    public DestinationMongodbSSHKeyAuthentication withTunnelUser(String tunnelUser) {
        Utils.checkNotNull(tunnelUser, "tunnelUser");
        this.tunnelUser = tunnelUser;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationMongodbSSHKeyAuthentication other = (DestinationMongodbSSHKeyAuthentication) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationMongodbSSHKeyAuthentication.class,
                "sshKey", sshKey,
    ...
    public final static class Builder {
        ...
        public DestinationMongodbSSHKeyAuthentication build() {
            if (tunnelPort == null) {
                tunnelPort = _SINGLETON_VALUE_TunnelPort.value();
            }
            return new DestinationMongodbSSHKeyAuthentication(
                sshKey,
                tunnelHost,
                tunnelPort,
                tunnelUser);
        ...
        private static final LazySingletonValue<DestinationMongodbSchemasTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_KEY_AUTH\"",
                        new TypeReference<DestinationMongodbSchemasTunnelMethod>() {});
