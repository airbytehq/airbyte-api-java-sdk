...
public enum SourceGoogleDriveValidationPolicy {
    ...
    public static Optional<SourceGoogleDriveValidationPolicy> fromValue(String value) {
        for (SourceGoogleDriveValidationPolicy o: SourceGoogleDriveValidationPolicy.values()) {
