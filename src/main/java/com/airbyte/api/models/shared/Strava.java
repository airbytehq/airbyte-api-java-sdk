...
public class Strava {
     ...
     * The Client ID of your Strava developer application.
     */
    public Strava withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The Client Secret of your Strava developer application.
     */
    public Strava withClientSecret(Optional<? extends String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Strava.class,
                "clientId", clientId,
