...
public class SourceAmazonAds {
    ...
    private Optional<? extends List<ReportRecordTypeEnum>> reportRecordTypes;
    ...
    private Optional<? extends List<StateFilterEnum>> stateFilter;
    ...
    public SourceAmazonAds(
            ...
            @JsonProperty("report_record_types") Optional<? extends List<ReportRecordTypeEnum>> reportRecordTypes,
            @JsonProperty("start_date") Optional<LocalDate> startDate,
            @JsonProperty("state_filter") Optional<? extends List<StateFilterEnum>> stateFilter) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<List<ReportRecordTypeEnum>> reportRecordTypes() {
        return (Optional<List<ReportRecordTypeEnum>>) reportRecordTypes;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<List<StateFilterEnum>> stateFilter() {
        return (Optional<List<StateFilterEnum>>) stateFilter;
    }
     ...
     * Optional configuration which accepts an array of string of record types. Leave blank for default behaviour to pull all report types. Use this config option only if you want to pull specific report type(s). See &lt;a href="https://advertising.amazon.com/API/docs/en-us/reporting/v2/report-types"&gt;docs&lt;/a&gt; for more details
     */
    public SourceAmazonAds withReportRecordTypes(List<ReportRecordTypeEnum> reportRecordTypes) {
        Utils.checkNotNull(reportRecordTypes, "reportRecordTypes");
     ...
     * Optional configuration which accepts an array of string of record types. Leave blank for default behaviour to pull all report types. Use this config option only if you want to pull specific report type(s). See &lt;a href="https://advertising.amazon.com/API/docs/en-us/reporting/v2/report-types"&gt;docs&lt;/a&gt; for more details
     */
    public SourceAmazonAds withReportRecordTypes(Optional<? extends List<ReportRecordTypeEnum>> reportRecordTypes) {
        Utils.checkNotNull(reportRecordTypes, "reportRecordTypes");
        this.reportRecordTypes = reportRecordTypes;
        return this;
    }
     ...
     * Reflects the state of the Display, Product, and Brand Campaign streams as enabled, paused, or archived. If you do not populate this field, it will be ignored completely.
     */
    public SourceAmazonAds withStateFilter(List<StateFilterEnum> stateFilter) {
        Utils.checkNotNull(stateFilter, "stateFilter");
     ...
     * Reflects the state of the Display, Product, and Brand Campaign streams as enabled, paused, or archived. If you do not populate this field, it will be ignored completely.
     */
    public SourceAmazonAds withStateFilter(Optional<? extends List<StateFilterEnum>> stateFilter) {
        Utils.checkNotNull(stateFilter, "stateFilter");
        this.stateFilter = stateFilter;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<ReportRecordTypeEnum>> reportRecordTypes = Optional.empty();
 
        private Optional<LocalDate> startDate = Optional.empty();
 
        private Optional<? extends List<StateFilterEnum>> stateFilter = Optional.empty();  
         ...
         * Optional configuration which accepts an array of string of record types. Leave blank for default behaviour to pull all report types. Use this config option only if you want to pull specific report type(s). See &lt;a href="https://advertising.amazon.com/API/docs/en-us/reporting/v2/report-types"&gt;docs&lt;/a&gt; for more details
         */
        public Builder reportRecordTypes(List<ReportRecordTypeEnum> reportRecordTypes) {
            Utils.checkNotNull(reportRecordTypes, "reportRecordTypes");
            this.reportRecordTypes = Optional.ofNullable(reportRecordTypes);
            return this;
        }
         ...
         * Optional configuration which accepts an array of string of record types. Leave blank for default behaviour to pull all report types. Use this config option only if you want to pull specific report type(s). See &lt;a href="https://advertising.amazon.com/API/docs/en-us/reporting/v2/report-types"&gt;docs&lt;/a&gt; for more details
         */
        public Builder reportRecordTypes(Optional<? extends List<ReportRecordTypeEnum>> reportRecordTypes) {
            Utils.checkNotNull(reportRecordTypes, "reportRecordTypes");
            this.reportRecordTypes = reportRecordTypes;
            return this;
        }
         ...
         * Reflects the state of the Display, Product, and Brand Campaign streams as enabled, paused, or archived. If you do not populate this field, it will be ignored completely.
         */
        public Builder stateFilter(List<StateFilterEnum> stateFilter) {
            Utils.checkNotNull(stateFilter, "stateFilter");
            this.stateFilter = Optional.ofNullable(stateFilter);
            return this;
        }
         ...
         * Reflects the state of the Display, Product, and Brand Campaign streams as enabled, paused, or archived. If you do not populate this field, it will be ignored completely.
         */
        public Builder stateFilter(Optional<? extends List<StateFilterEnum>> stateFilter) {
            Utils.checkNotNull(stateFilter, "stateFilter");
            this.stateFilter = stateFilter;
            return this;
        }
