    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationMilvusTextSplitter> {
        ...
        public _Deserializer() {
            super(DestinationMilvusTextSplitter.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationMilvusBySeparator>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationMilvusByProgrammingLanguage>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationMilvusByMarkdownHeader>() {}, JsonShape.DEFAULT));
        }
    }
