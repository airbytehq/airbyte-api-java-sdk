    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceGoogleDirectoryGoogleCredentials> {
        ...
        public _Deserializer() {
            super(SourceGoogleDirectoryGoogleCredentials.class, false,
                  TypeReferenceWithShape.of(new TypeReference<SignInViaGoogleOAuth>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<ServiceAccountKey>() {}, JsonShape.DEFAULT));
        }
    }
