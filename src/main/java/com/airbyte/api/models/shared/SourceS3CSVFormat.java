...
public class SourceS3CSVFormat {
     ...
     * The character delimiting individual cells in the CSV data. This may only be a 1-character string. For tab-delimited data enter '\t'.
     */
    public SourceS3CSVFormat withDelimiter(Optional<? extends String> delimiter) {
        Utils.checkNotNull(delimiter, "delimiter");
        this.delimiter = delimiter;
        return this;
    }
     ...
     * Whether two quotes in a quoted CSV value denote a single quote in the data.
     */
    public SourceS3CSVFormat withDoubleQuote(Optional<? extends Boolean> doubleQuote) {
        Utils.checkNotNull(doubleQuote, "doubleQuote");
        this.doubleQuote = doubleQuote;
        return this;
    }
     ...
     * The character encoding of the CSV data. Leave blank to default to &lt;strong&gt;UTF8&lt;/strong&gt;. See &lt;a href="https://docs.python.org/3/library/codecs.html#standard-encodings" target="_blank"&gt;list of python encodings&lt;/a&gt; for allowable options.
     */
    public SourceS3CSVFormat withEncoding(Optional<? extends String> encoding) {
        Utils.checkNotNull(encoding, "encoding");
        this.encoding = encoding;
        return this;
    }
     ...
     * The character used for escaping special characters. To disallow escaping, leave this field blank.
     */
    public SourceS3CSVFormat withEscapeChar(Optional<? extends String> escapeChar) {
        Utils.checkNotNull(escapeChar, "escapeChar");
        this.escapeChar = escapeChar;
        return this;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as false values.
     */
    public SourceS3CSVFormat withFalseValues(java.util.List<String> falseValues) {
        Utils.checkNotNull(falseValues, "falseValues");
     ...
     * A set of case-sensitive strings that should be interpreted as false values.
     */
    public SourceS3CSVFormat withFalseValues(Optional<? extends java.util.List<String>> falseValues) {
        Utils.checkNotNull(falseValues, "falseValues");
        this.falseValues = falseValues;
        return this;
    }
     ...
     * How to infer the types of the columns. If none, inference default to strings.
     */
    public SourceS3CSVFormat withInferenceType(SourceS3InferenceType inferenceType) {
        Utils.checkNotNull(inferenceType, "inferenceType");
     ...
     * How to infer the types of the columns. If none, inference default to strings.
     */
    public SourceS3CSVFormat withInferenceType(Optional<? extends SourceS3InferenceType> inferenceType) {
        Utils.checkNotNull(inferenceType, "inferenceType");
        this.inferenceType = inferenceType;
        return this;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as null values. For example, if the value 'NA' should be interpreted as null, enter 'NA' in this field.
     */
    public SourceS3CSVFormat withNullValues(java.util.List<String> nullValues) {
        Utils.checkNotNull(nullValues, "nullValues");
     ...
     * A set of case-sensitive strings that should be interpreted as null values. For example, if the value 'NA' should be interpreted as null, enter 'NA' in this field.
     */
    public SourceS3CSVFormat withNullValues(Optional<? extends java.util.List<String>> nullValues) {
        Utils.checkNotNull(nullValues, "nullValues");
        this.nullValues = nullValues;
        return this;
    }
     ...
     * The character used for quoting CSV values. To disallow quoting, make this field blank.
     */
    public SourceS3CSVFormat withQuoteChar(Optional<? extends String> quoteChar) {
        Utils.checkNotNull(quoteChar, "quoteChar");
        this.quoteChar = quoteChar;
        return this;
    }
     ...
     * The number of rows to skip after the header row.
     */
    public SourceS3CSVFormat withSkipRowsAfterHeader(Optional<? extends Long> skipRowsAfterHeader) {
        Utils.checkNotNull(skipRowsAfterHeader, "skipRowsAfterHeader");
        this.skipRowsAfterHeader = skipRowsAfterHeader;
        return this;
    }
     ...
     * The number of rows to skip before the header row. For example, if the header row is on the 3rd row, enter 2 in this field.
     */
    public SourceS3CSVFormat withSkipRowsBeforeHeader(Optional<? extends Long> skipRowsBeforeHeader) {
        Utils.checkNotNull(skipRowsBeforeHeader, "skipRowsBeforeHeader");
        this.skipRowsBeforeHeader = skipRowsBeforeHeader;
        return this;
    }
     ...
     * Whether strings can be interpreted as null values. If true, strings that match the null_values set will be interpreted as null. If false, strings that match the null_values set will be interpreted as the string itself.
     */
    public SourceS3CSVFormat withStringsCanBeNull(Optional<? extends Boolean> stringsCanBeNull) {
        Utils.checkNotNull(stringsCanBeNull, "stringsCanBeNull");
        this.stringsCanBeNull = stringsCanBeNull;
        return this;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as true values.
     */
    public SourceS3CSVFormat withTrueValues(java.util.List<String> trueValues) {
        Utils.checkNotNull(trueValues, "trueValues");
     ...
     * A set of case-sensitive strings that should be interpreted as true values.
     */
    public SourceS3CSVFormat withTrueValues(Optional<? extends java.util.List<String>> trueValues) {
        Utils.checkNotNull(trueValues, "trueValues");
        this.trueValues = trueValues;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * How to infer the types of the columns. If none, inference default to strings.
         */
        public Builder inferenceType(SourceS3InferenceType inferenceType) {
            Utils.checkNotNull(inferenceType, "inferenceType");
            this.inferenceType = Optional.ofNullable(inferenceType);
            return this;
        }
         ...
         * How to infer the types of the columns. If none, inference default to strings.
         */
        public Builder inferenceType(Optional<? extends SourceS3InferenceType> inferenceType) {
            Utils.checkNotNull(inferenceType, "inferenceType");
            this.inferenceType = inferenceType;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<? extends SourceS3InferenceType>> _SINGLETON_VALUE_InferenceType =
                new LazySingletonValue<>(
                        "inference_type",
                        "\"None\"",
                        new TypeReference<Optional<? extends SourceS3InferenceType>>() {});
