...
public class ViaAPI {
    ...
    private Optional<? extends List<APIParameterConfigModel>> parameters;

    @JsonCreator
    public ViaAPI(
            @JsonProperty("api_key") Optional<String> apiKey,
            @JsonProperty("api_url") Optional<String> apiUrl,
            @JsonProperty("parameters") Optional<? extends List<APIParameterConfigModel>> parameters) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<List<APIParameterConfigModel>> parameters() {
        return (Optional<List<APIParameterConfigModel>>) parameters;
    }
     ...
     * The API key to use matching the environment
     */
    public ViaAPI withApiKey(Optional<String> apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
        this.apiKey = apiKey;
        return this;
    }
     ...
     * The URL of the unstructured API to use
     */
    public ViaAPI withApiUrl(Optional<String> apiUrl) {
        Utils.checkNotNull(apiUrl, "apiUrl");
        this.apiUrl = apiUrl;
        return this;
    }
     ...
     * List of parameters send to the API
     */
    public ViaAPI withParameters(List<APIParameterConfigModel> parameters) {
        Utils.checkNotNull(parameters, "parameters");
     ...
     * List of parameters send to the API
     */
    public ViaAPI withParameters(Optional<? extends List<APIParameterConfigModel>> parameters) {
        Utils.checkNotNull(parameters, "parameters");
        this.parameters = parameters;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<APIParameterConfigModel>> parameters = Optional.empty();  
         ...
         * List of parameters send to the API
         */
        public Builder parameters(List<APIParameterConfigModel> parameters) {
            Utils.checkNotNull(parameters, "parameters");
            this.parameters = Optional.ofNullable(parameters);
            return this;
        }
         ...
         * List of parameters send to the API
         */
        public Builder parameters(Optional<? extends List<APIParameterConfigModel>> parameters) {
            Utils.checkNotNull(parameters, "parameters");
            this.parameters = parameters;
            return this;
        }
