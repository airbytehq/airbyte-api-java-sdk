...
public class SourceGoogleDriveAuthentication {
     ...
     * <ul>
     * <li>{@code SourceGoogleDriveAuthenticateViaGoogleOAuth}</li>
     * <li>{@code SourceGoogleDriveServiceAccountKeyAuthentication}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<SourceGoogleDriveAuthentication> {

        public _Deserializer() {
            super(SourceGoogleDriveAuthentication.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceGoogleDriveAuthenticateViaGoogleOAuth>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceGoogleDriveServiceAccountKeyAuthentication>() {}, Utils.JsonShape.DEFAULT));
        }
    }
