...
public class SourceOura {
    ...
    private Optional<? extends OffsetDateTime> endDatetime;
    ...
    public SourceOura(
            ...
            @JsonProperty("end_datetime") Optional<? extends OffsetDateTime> endDatetime,
    ...
    public Optional<OffsetDateTime> endDatetime() {
        return (Optional<OffsetDateTime>) endDatetime;
    }
     ...
     * End datetime to sync until. Default is current UTC datetime.
     */
    public SourceOura withEndDatetime(Optional<? extends OffsetDateTime> endDatetime) {
        Utils.checkNotNull(endDatetime, "endDatetime");
        this.endDatetime = endDatetime;
        return this;
    }
     ...
     * 
     */
    public SourceOura withStartDatetime(Optional<? extends OffsetDateTime> startDatetime) {
        Utils.checkNotNull(startDatetime, "startDatetime");
        this.startDatetime = startDatetime;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            java.util.Objects.deepEquals(this.endDatetime, other.endDatetime) &&
    ...
    public final static class Builder {
        ...
        private Optional<? extends OffsetDateTime> endDatetime = Optional.empty();
 
        private Optional<? extends OffsetDateTime> startDatetime = Optional.empty();  
         ...
         * End datetime to sync until. Default is current UTC datetime.
         */
        public Builder endDatetime(Optional<? extends OffsetDateTime> endDatetime) {
            Utils.checkNotNull(endDatetime, "endDatetime");
            this.endDatetime = endDatetime;
            return this;
        }
