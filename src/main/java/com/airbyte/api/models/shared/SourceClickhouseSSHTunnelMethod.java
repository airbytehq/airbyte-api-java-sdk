    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceClickhouseSSHTunnelMethod> {
        ...
        public _Deserializer() {
            super(SourceClickhouseSSHTunnelMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceClickhousePasswordAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceClickhouseSSHKeyAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceClickhouseNoTunnel>() {}, JsonShape.DEFAULT));
        }
    }
