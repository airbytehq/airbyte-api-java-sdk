...
public class BingAds {
     ...
     * The Client ID of your Microsoft Advertising developer application.
     */
    public BingAds withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The Client Secret of your Microsoft Advertising developer application.
     */
    public BingAds withClientSecret(Optional<? extends String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(BingAds.class,
                "clientId", clientId,
