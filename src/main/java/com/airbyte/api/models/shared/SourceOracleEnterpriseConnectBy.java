 ...
 * 
 * <p>The scheme by which to establish a database connection.
 */
@JsonDeserialize(using = SourceOracleEnterpriseConnectBy._Deserializer.class)
public class SourceOracleEnterpriseConnectBy {
     ...
     * <ul>
     * <li>{@code com.airbyte.api.models.shared.SourceOracleEnterpriseServiceName}</li>
     * <li>{@code com.airbyte.api.models.shared.SourceOracleEnterpriseSystemIDSID}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceOracleEnterpriseConnectBy> {
