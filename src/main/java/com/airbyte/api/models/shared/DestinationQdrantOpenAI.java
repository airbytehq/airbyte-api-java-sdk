...
public class DestinationQdrantOpenAI {
    ...
    @JsonCreator
    public DestinationQdrantOpenAI(
    ...
    @JsonIgnore
    public Optional<DestinationQdrantMode> mode() {
        return (Optional<DestinationQdrantMode>) mode;
    }
    ...
    public String toString() {
        return Utils.toString(DestinationQdrantOpenAI.class,
                "mode", mode,
                "openaiKey", openaiKey);
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends DestinationQdrantMode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"openai\"",
                        new TypeReference<Optional<? extends DestinationQdrantMode>>() {});
    }
}
