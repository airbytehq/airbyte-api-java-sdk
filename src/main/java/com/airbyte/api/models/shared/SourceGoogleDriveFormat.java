    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceGoogleDriveFormat> {
        ...
        public _Deserializer() {
            super(SourceGoogleDriveFormat.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceGoogleDriveCSVFormat>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceGoogleDriveDocumentFileTypeFormatExperimental>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceGoogleDriveParquetFormat>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceGoogleDriveAvroFormat>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceGoogleDriveJsonlFormat>() {}, JsonShape.DEFAULT));
        }
    }
