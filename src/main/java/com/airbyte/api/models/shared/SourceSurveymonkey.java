...
public class SourceSurveymonkey {
    ...
    private Optional<? extends SurveyMonkeyAuthorizationMethod> credentials;
    ...
    public SourceSurveymonkey(
            @JsonProperty("credentials") Optional<? extends SurveyMonkeyAuthorizationMethod> credentials,
     ...
     * The authorization method to use to retrieve data from SurveyMonkey
     */
    public Optional<? extends SurveyMonkeyAuthorizationMethod> credentials() {
        return credentials;
    }
     ...
     * The authorization method to use to retrieve data from SurveyMonkey
     */
    public SourceSurveymonkey withCredentials(Optional<? extends SurveyMonkeyAuthorizationMethod> credentials) {
        Utils.checkNotNull(credentials, "credentials");
        this.credentials = credentials;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends SurveyMonkeyAuthorizationMethod> credentials = Optional.empty();
         ...
         * The authorization method to use to retrieve data from SurveyMonkey
         */
        public Builder credentials(Optional<? extends SurveyMonkeyAuthorizationMethod> credentials) {
            Utils.checkNotNull(credentials, "credentials");
            this.credentials = credentials;
            return this;
        }
