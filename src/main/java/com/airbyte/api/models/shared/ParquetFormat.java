...
public class ParquetFormat {
     ...
     * Whether to convert decimal fields to floats. There is a loss of precision when converting decimals to floats, so this is not recommended.
     */
    public ParquetFormat withDecimalAsFloat(boolean decimalAsFloat) {
        Utils.checkNotNull(decimalAsFloat, "decimalAsFloat");
     ...
     * Whether to convert decimal fields to floats. There is a loss of precision when converting decimals to floats, so this is not recommended.
     */
    public ParquetFormat withDecimalAsFloat(Optional<? extends Boolean> decimalAsFloat) {
        Utils.checkNotNull(decimalAsFloat, "decimalAsFloat");
        this.decimalAsFloat = decimalAsFloat;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ParquetFormat other = (ParquetFormat) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ParquetFormat.class,
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends SourceAzureBlobStorageSchemasStreamsFiletype>> _SINGLETON_VALUE_Filetype =
                new LazySingletonValue<>(
                        "filetype",
                        "\"parquet\"",
                        new TypeReference<Optional<? extends SourceAzureBlobStorageSchemasStreamsFiletype>>() {});
    }
}
