...
public class SourceOraclePasswordAuthentication {
    /**
    ...
    private SourceOracleSchemasTunnelMethodTunnelMethod tunnelMethod;
    ...
    @JsonCreator
    public SourceOraclePasswordAuthentication(
     ...
     */
    @JsonIgnore
    public SourceOracleSchemasTunnelMethodTunnelMethod tunnelMethod() {
        return tunnelMethod;
    }
     ...
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    public SourceOraclePasswordAuthentication withTunnelHost(String tunnelHost) {
        Utils.checkNotNull(tunnelHost, "tunnelHost");
        this.tunnelHost = tunnelHost;
        return this;
    }
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public SourceOraclePasswordAuthentication withTunnelPort(long tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public SourceOraclePasswordAuthentication withTunnelPort(Optional<Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
     ...
     * OS-level username for logging into the jump server host
     */
    public SourceOraclePasswordAuthentication withTunnelUser(String tunnelUser) {
        Utils.checkNotNull(tunnelUser, "tunnelUser");
        this.tunnelUser = tunnelUser;
        return this;
    }
     ...
     * OS-level password for logging into the jump server host
     */
    public SourceOraclePasswordAuthentication withTunnelUserPassword(String tunnelUserPassword) {
        Utils.checkNotNull(tunnelUserPassword, "tunnelUserPassword");
        this.tunnelUserPassword = tunnelUserPassword;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceOraclePasswordAuthentication other = (SourceOraclePasswordAuthentication) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceOraclePasswordAuthentication.class,
    ...
    public final static class Builder {
        ...
        public SourceOraclePasswordAuthentication build() {
            if (tunnelPort == null) {
                tunnelPort = _SINGLETON_VALUE_TunnelPort.value();
            }

            return new SourceOraclePasswordAuthentication(
                tunnelHost, tunnelPort, tunnelUser,
                tunnelUserPassword);
        }


        private static final LazySingletonValue<SourceOracleSchemasTunnelMethodTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_PASSWORD_AUTH\"",
                        new TypeReference<SourceOracleSchemasTunnelMethodTunnelMethod>() {});
