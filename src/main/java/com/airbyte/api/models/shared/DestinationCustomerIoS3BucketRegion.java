 ...
 */
public enum DestinationCustomerIoS3BucketRegion {
    UNKNOWN(""),
    ...
    DestinationCustomerIoS3BucketRegion(String value) {
        this.value = value;
    }
    ...
    public static Optional<DestinationCustomerIoS3BucketRegion> fromValue(String value) {
        for (DestinationCustomerIoS3BucketRegion o: DestinationCustomerIoS3BucketRegion.values()) {
