...
public class SourceOpenweather {
    ...
    public SourceOpenweather(
            ...
            @JsonProperty("only_current") Optional<Boolean> onlyCurrent,
     ...
     * True for particular day
     */
    public SourceOpenweather withOnlyCurrent(Optional<Boolean> onlyCurrent) {
        Utils.checkNotNull(onlyCurrent, "onlyCurrent");
        this.onlyCurrent = onlyCurrent;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * True for particular day
         */
        public Builder onlyCurrent(Optional<Boolean> onlyCurrent) {
            Utils.checkNotNull(onlyCurrent, "onlyCurrent");
            this.onlyCurrent = onlyCurrent;
            return this;
        }
