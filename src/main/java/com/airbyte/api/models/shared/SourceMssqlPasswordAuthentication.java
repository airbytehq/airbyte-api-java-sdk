...
public class SourceMssqlPasswordAuthentication {
    /**
    ...
    private SourceMssqlSchemasTunnelMethodTunnelMethod tunnelMethod;
    ...
    @JsonCreator
    public SourceMssqlPasswordAuthentication(
     ...
     */
    @JsonIgnore
    public SourceMssqlSchemasTunnelMethodTunnelMethod tunnelMethod() {
        return tunnelMethod;
    }
     ...
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    public SourceMssqlPasswordAuthentication withTunnelHost(String tunnelHost) {
        Utils.checkNotNull(tunnelHost, "tunnelHost");
        this.tunnelHost = tunnelHost;
        return this;
    }
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public SourceMssqlPasswordAuthentication withTunnelPort(long tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public SourceMssqlPasswordAuthentication withTunnelPort(Optional<Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
     ...
     * OS-level username for logging into the jump server host
     */
    public SourceMssqlPasswordAuthentication withTunnelUser(String tunnelUser) {
        Utils.checkNotNull(tunnelUser, "tunnelUser");
        this.tunnelUser = tunnelUser;
        return this;
    }
     ...
     * OS-level password for logging into the jump server host
     */
    public SourceMssqlPasswordAuthentication withTunnelUserPassword(String tunnelUserPassword) {
        Utils.checkNotNull(tunnelUserPassword, "tunnelUserPassword");
        this.tunnelUserPassword = tunnelUserPassword;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceMssqlPasswordAuthentication other = (SourceMssqlPasswordAuthentication) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceMssqlPasswordAuthentication.class,
    ...
    public final static class Builder {
        ...
        public SourceMssqlPasswordAuthentication build() {
            if (tunnelPort == null) {
                tunnelPort = _SINGLETON_VALUE_TunnelPort.value();
            }

            return new SourceMssqlPasswordAuthentication(
                tunnelHost, tunnelPort, tunnelUser,
                tunnelUserPassword);
        }


        private static final LazySingletonValue<SourceMssqlSchemasTunnelMethodTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_PASSWORD_AUTH\"",
                        new TypeReference<SourceMssqlSchemasTunnelMethodTunnelMethod>() {});
