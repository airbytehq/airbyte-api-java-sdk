...
public class DriftCredentials {
     ...
     * The Client ID of your Drift developer application.
     */
    public DriftCredentials withClientId(String clientId) {
        Utils.checkNotNull(clientId, "clientId");
     ...
     * The Client ID of your Drift developer application.
     */
    public DriftCredentials withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The Client Secret of your Drift developer application.
     */
    public DriftCredentials withClientSecret(String clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
     ...
     * The Client Secret of your Drift developer application.
     */
    public DriftCredentials withClientSecret(Optional<? extends String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DriftCredentials other = (DriftCredentials) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DriftCredentials.class,
                "clientId", clientId,
    ...
    public final static class Builder {
        ...
        public DriftCredentials build() {
            return new DriftCredentials(
                clientId,
                clientSecret);
        }
    }
