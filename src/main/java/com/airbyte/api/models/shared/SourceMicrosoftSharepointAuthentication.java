...
public class SourceMicrosoftSharepointAuthentication {
     ...
     * <ul>
     * <li>{@code SourceMicrosoftSharepointAuthenticateViaMicrosoftOAuth}</li>
     * <li>{@code SourceMicrosoftSharepointServiceKeyAuthentication}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<SourceMicrosoftSharepointAuthentication> {
        ...
        public _Deserializer() {
            super(SourceMicrosoftSharepointAuthentication.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceMicrosoftSharepointAuthenticateViaMicrosoftOAuth>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceMicrosoftSharepointServiceKeyAuthentication>() {}, Utils.JsonShape.DEFAULT));
        }
    }
