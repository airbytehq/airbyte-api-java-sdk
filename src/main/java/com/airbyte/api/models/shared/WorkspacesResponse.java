...
public class WorkspacesResponse {
    ...
    @JsonProperty("data")
    private java.util.List<WorkspaceResponse> data;
    ...
    public WorkspacesResponse(
            @JsonProperty("data") java.util.List<WorkspaceResponse> data,
    ...
    public WorkspacesResponse(
            java.util.List<WorkspaceResponse> data) {
        this(data, Optional.empty(), Optional.empty());
    }

    @JsonIgnore
    public java.util.List<WorkspaceResponse> data() {
        return data;
    }
    ...
    public WorkspacesResponse withData(java.util.List<WorkspaceResponse> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public WorkspacesResponse withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public WorkspacesResponse withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<WorkspaceResponse> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
