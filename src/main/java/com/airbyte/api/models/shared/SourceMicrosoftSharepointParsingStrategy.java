...
public enum SourceMicrosoftSharepointParsingStrategy {
    ...
    public static Optional<SourceMicrosoftSharepointParsingStrategy> fromValue(String value) {
        for (SourceMicrosoftSharepointParsingStrategy o: SourceMicrosoftSharepointParsingStrategy.values()) {
