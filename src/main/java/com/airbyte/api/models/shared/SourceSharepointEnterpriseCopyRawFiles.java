 ...
 */
public class SourceSharepointEnterpriseCopyRawFiles {

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("delivery_type")
    private Optional<? extends SourceSharepointEnterpriseSchemasDeliveryType> deliveryType;
    ...
    @JsonCreator
    public SourceSharepointEnterpriseCopyRawFiles(
    ...
    @JsonIgnore
    public Optional<SourceSharepointEnterpriseSchemasDeliveryType> deliveryType() {
        return (Optional<SourceSharepointEnterpriseSchemasDeliveryType>) deliveryType;
    }
     ...
     * If enabled, sends subdirectory folder structure along with source file names to the destination. Otherwise, files will be synced by their names only. This option is ignored when file-based replication is not enabled.
     */
    public SourceSharepointEnterpriseCopyRawFiles withPreserveDirectoryStructure(boolean preserveDirectoryStructure) {
        Utils.checkNotNull(preserveDirectoryStructure, "preserveDirectoryStructure");
     ...
     * If enabled, sends subdirectory folder structure along with source file names to the destination. Otherwise, files will be synced by their names only. This option is ignored when file-based replication is not enabled.
     */
    public SourceSharepointEnterpriseCopyRawFiles withPreserveDirectoryStructure(Optional<Boolean> preserveDirectoryStructure) {
        Utils.checkNotNull(preserveDirectoryStructure, "preserveDirectoryStructure");
        this.preserveDirectoryStructure = preserveDirectoryStructure;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceSharepointEnterpriseCopyRawFiles other = (SourceSharepointEnterpriseCopyRawFiles) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceSharepointEnterpriseCopyRawFiles.class,
    ...
    public final static class Builder {
        ...
        public SourceSharepointEnterpriseCopyRawFiles build() {
            if (preserveDirectoryStructure == null) {
                preserveDirectoryStructure = _SINGLETON_VALUE_PreserveDirectoryStructure.value();
            }
            return new SourceSharepointEnterpriseCopyRawFiles(
                preserveDirectoryStructure);
        }

        private static final LazySingletonValue<Optional<? extends SourceSharepointEnterpriseSchemasDeliveryType>> _SINGLETON_VALUE_DeliveryType =
                new LazySingletonValue<>(
                        "delivery_type",
                        "\"use_file_transfer\"",
                        new TypeReference<Optional<? extends SourceSharepointEnterpriseSchemasDeliveryType>>() {});
