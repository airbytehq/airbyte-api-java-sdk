...
public class DestinationAzureBlobStorage {
    ...
    private Optional<String> azureBlobStorageContainerName;
    ...
    private Optional<Long> azureBlobStorageOutputBufferSize;
    ...
    public DestinationAzureBlobStorage(
            ...
            @JsonProperty("azure_blob_storage_container_name") Optional<String> azureBlobStorageContainerName,
            @JsonProperty("azure_blob_storage_endpoint_domain_name") Optional<String> azureBlobStorageEndpointDomainName,
            @JsonProperty("azure_blob_storage_output_buffer_size") Optional<Long> azureBlobStorageOutputBufferSize,
     ...
     * The name of the Azure blob storage container. If not exists - will be created automatically. May be empty, then will be created automatically airbytecontainer+timestamp
     */
    public DestinationAzureBlobStorage withAzureBlobStorageContainerName(Optional<String> azureBlobStorageContainerName) {
        Utils.checkNotNull(azureBlobStorageContainerName, "azureBlobStorageContainerName");
        this.azureBlobStorageContainerName = azureBlobStorageContainerName;
        return this;
    }
     ...
     * The amount of megabytes to buffer for the output stream to Azure. This will impact memory footprint on workers, but may need adjustment for performance and appropriate block size in Azure.
     */
    public DestinationAzureBlobStorage withAzureBlobStorageOutputBufferSize(Optional<Long> azureBlobStorageOutputBufferSize) {
        Utils.checkNotNull(azureBlobStorageOutputBufferSize, "azureBlobStorageOutputBufferSize");
        this.azureBlobStorageOutputBufferSize = azureBlobStorageOutputBufferSize;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Objects.deepEquals(this.azureBlobStorageOutputBufferSize, other.azureBlobStorageOutputBufferSize) &&
    ...
    public final static class Builder {
        ...
        private Optional<String> azureBlobStorageContainerName = Optional.empty();
         ...
         * The name of the Azure blob storage container. If not exists - will be created automatically. May be empty, then will be created automatically airbytecontainer+timestamp
         */
        public Builder azureBlobStorageContainerName(Optional<String> azureBlobStorageContainerName) {
            Utils.checkNotNull(azureBlobStorageContainerName, "azureBlobStorageContainerName");
            this.azureBlobStorageContainerName = azureBlobStorageContainerName;
            return this;
        }
         ...
         * The amount of megabytes to buffer for the output stream to Azure. This will impact memory footprint on workers, but may need adjustment for performance and appropriate block size in Azure.
         */
        public Builder azureBlobStorageOutputBufferSize(Optional<Long> azureBlobStorageOutputBufferSize) {
            Utils.checkNotNull(azureBlobStorageOutputBufferSize, "azureBlobStorageOutputBufferSize");
            this.azureBlobStorageOutputBufferSize = azureBlobStorageOutputBufferSize;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_AzureBlobStorageEndpointDomainName =
                new LazySingletonValue<>(
                        "azure_blob_storage_endpoint_domain_name",
                        "\"blob.core.windows.net\"",
                        new TypeReference<Optional<String>>() {});

        private static final LazySingletonValue<Optional<Long>> _SINGLETON_VALUE_AzureBlobStorageOutputBufferSize =
                new LazySingletonValue<>(
