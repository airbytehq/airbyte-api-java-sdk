...
public class SourcePagerduty {
    ...
    /**
     * If true, will return a subset of log entries that show only the most important changes to the
     * incident.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * Maximum number of PagerDuty API request retries to perform upon connection errors. The source will
     * pause for an exponentially increasing number of seconds before retrying.
     */
    @JsonInclude(Include.NON_ABSENT)
