    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationWeaviateTextSplitter> {
        ...
        public _Deserializer() {
            super(DestinationWeaviateTextSplitter.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationWeaviateBySeparator>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationWeaviateByProgrammingLanguage>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationWeaviateByMarkdownHeader>() {}, JsonShape.DEFAULT));
        }
    }
