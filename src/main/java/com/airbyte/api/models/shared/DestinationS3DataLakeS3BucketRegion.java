 ...
 */
public enum DestinationS3DataLakeS3BucketRegion {
    UNKNOWN(""),
    ...
    private DestinationS3DataLakeS3BucketRegion(String value) {
        this.value = value;
    }
    ...
    public static Optional<DestinationS3DataLakeS3BucketRegion> fromValue(String value) {
        for (DestinationS3DataLakeS3BucketRegion o: DestinationS3DataLakeS3BucketRegion.values()) {
