...
public class AzureBlobStorageCredentials {
    ...
    @JsonCreator
    public AzureBlobStorageCredentials(
     ...
     * Client ID of your Microsoft developer application
     */
    public AzureBlobStorageCredentials withClientId(String clientId) {
        Utils.checkNotNull(clientId, "clientId");
     ...
     * Client ID of your Microsoft developer application
     */
    public AzureBlobStorageCredentials withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * Client Secret of your Microsoft developer application
     */
    public AzureBlobStorageCredentials withClientSecret(String clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
     ...
     * Client Secret of your Microsoft developer application
     */
    public AzureBlobStorageCredentials withClientSecret(Optional<? extends String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AzureBlobStorageCredentials other = (AzureBlobStorageCredentials) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AzureBlobStorageCredentials.class,
                "clientId", clientId,
    ...
    public final static class Builder {
        ...
        public AzureBlobStorageCredentials build() {
            return new AzureBlobStorageCredentials(
                clientId,
                clientSecret);
        }
    }
