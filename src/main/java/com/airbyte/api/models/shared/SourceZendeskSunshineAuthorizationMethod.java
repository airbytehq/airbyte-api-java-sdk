...
public class SourceZendeskSunshineAuthorizationMethod {
     ...
     * <ul>
     * <li>{@code com.airbyte.api.models.shared.SourceZendeskSunshineOAuth20}</li>
     * <li>{@code com.airbyte.api.models.shared.SourceZendeskSunshineAPIToken}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceZendeskSunshineAuthorizationMethod> {

        public _Deserializer() {
            super(SourceZendeskSunshineAuthorizationMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<SourceZendeskSunshineOAuth20>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<SourceZendeskSunshineAPIToken>() {}, JsonShape.DEFAULT));
        }
    }
