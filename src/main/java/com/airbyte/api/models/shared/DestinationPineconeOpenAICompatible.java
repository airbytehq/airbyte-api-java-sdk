...
public class DestinationPineconeOpenAICompatible {
    ...
    public DestinationPineconeOpenAICompatible withApiKey(Optional<String> apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
        this.apiKey = apiKey;
        return this;
    }
     ...
     * The name of the model to use for embedding
     */
    public DestinationPineconeOpenAICompatible withModelName(Optional<String> modelName) {
        Utils.checkNotNull(modelName, "modelName");
        this.modelName = modelName;
        return this;
    }
