...
public class SourceSftpBulkDocumentFileTypeFormatExperimental {
    ...
    @JsonCreator
    public SourceSftpBulkDocumentFileTypeFormatExperimental(
     ...
     * Processing configuration
     */
    public SourceSftpBulkDocumentFileTypeFormatExperimental withProcessing(SourceSftpBulkProcessing processing) {
        Utils.checkNotNull(processing, "processing");
     ...
     * Processing configuration
     */
    public SourceSftpBulkDocumentFileTypeFormatExperimental withProcessing(Optional<? extends SourceSftpBulkProcessing> processing) {
        Utils.checkNotNull(processing, "processing");
        this.processing = processing;
        return this;
    }
     ...
     * If true, skip files that cannot be parsed and pass the error message along as the _ab_source_file_parse_error field. If false, fail the sync.
     */
    public SourceSftpBulkDocumentFileTypeFormatExperimental withSkipUnprocessableFiles(boolean skipUnprocessableFiles) {
        Utils.checkNotNull(skipUnprocessableFiles, "skipUnprocessableFiles");
     ...
     * If true, skip files that cannot be parsed and pass the error message along as the _ab_source_file_parse_error field. If false, fail the sync.
     */
    public SourceSftpBulkDocumentFileTypeFormatExperimental withSkipUnprocessableFiles(Optional<? extends Boolean> skipUnprocessableFiles) {
        Utils.checkNotNull(skipUnprocessableFiles, "skipUnprocessableFiles");
        this.skipUnprocessableFiles = skipUnprocessableFiles;
        return this;
    }
     ...
     * The strategy used to parse documents. `fast` extracts text directly from the document which doesn't work for all files. `ocr_only` is more reliable, but slower. `hi_res` is the most reliable, but requires an API key and a hosted instance of unstructured and can't be used with local mode. See the unstructured.io documentation for more details: https://unstructured-io.github.io/unstructured/core/partition.html#partition-pdf
     */
    public SourceSftpBulkDocumentFileTypeFormatExperimental withStrategy(SourceSftpBulkParsingStrategy strategy) {
        Utils.checkNotNull(strategy, "strategy");
     ...
     * The strategy used to parse documents. `fast` extracts text directly from the document which doesn't work for all files. `ocr_only` is more reliable, but slower. `hi_res` is the most reliable, but requires an API key and a hosted instance of unstructured and can't be used with local mode. See the unstructured.io documentation for more details: https://unstructured-io.github.io/unstructured/core/partition.html#partition-pdf
     */
    public SourceSftpBulkDocumentFileTypeFormatExperimental withStrategy(Optional<? extends SourceSftpBulkParsingStrategy> strategy) {
        Utils.checkNotNull(strategy, "strategy");
        this.strategy = strategy;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceSftpBulkDocumentFileTypeFormatExperimental other = (SourceSftpBulkDocumentFileTypeFormatExperimental) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceSftpBulkDocumentFileTypeFormatExperimental.class,
                "filetype", filetype,
    ...
    public final static class Builder {
        ...
        public SourceSftpBulkDocumentFileTypeFormatExperimental build() {
            ...
            return new SourceSftpBulkDocumentFileTypeFormatExperimental(
                processing,
                skipUnprocessableFiles,
                strategy);
        }
