    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationMongodbSSHTunnelMethod> {
        ...
        public _Deserializer() {
            super(DestinationMongodbSSHTunnelMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationMongodbPasswordAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationMongodbSSHKeyAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationMongodbNoTunnel>() {}, JsonShape.DEFAULT));
        }
    }
