...
public class DestinationPostgresPasswordAuthentication {
    ...
    private DestinationPostgresSchemasTunnelMethodTunnelMethod tunnelMethod;
     ...
     */
    @JsonIgnore
    public DestinationPostgresSchemasTunnelMethodTunnelMethod tunnelMethod() {
        return tunnelMethod;
    }
     ...
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    public DestinationPostgresPasswordAuthentication withTunnelHost(String tunnelHost) {
        Utils.checkNotNull(tunnelHost, "tunnelHost");
        this.tunnelHost = tunnelHost;
        return this;
    }
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationPostgresPasswordAuthentication withTunnelPort(long tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationPostgresPasswordAuthentication withTunnelPort(Optional<Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
     ...
     * OS-level username for logging into the jump server host
     */
    public DestinationPostgresPasswordAuthentication withTunnelUser(String tunnelUser) {
        Utils.checkNotNull(tunnelUser, "tunnelUser");
        this.tunnelUser = tunnelUser;
        return this;
    }
     ...
     * OS-level password for logging into the jump server host
     */
    public DestinationPostgresPasswordAuthentication withTunnelUserPassword(String tunnelUserPassword) {
        Utils.checkNotNull(tunnelUserPassword, "tunnelUserPassword");
        this.tunnelUserPassword = tunnelUserPassword;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationPostgresPasswordAuthentication other = (DestinationPostgresPasswordAuthentication) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationPostgresPasswordAuthentication.class,
    ...
    public final static class Builder {
        ...
        public DestinationPostgresPasswordAuthentication build() {
            if (tunnelPort == null) {
                tunnelPort = _SINGLETON_VALUE_TunnelPort.value();
            }

            return new DestinationPostgresPasswordAuthentication(
                tunnelHost, tunnelPort, tunnelUser,
                tunnelUserPassword);
        }


        private static final LazySingletonValue<DestinationPostgresSchemasTunnelMethodTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_PASSWORD_AUTH\"",
                        new TypeReference<DestinationPostgresSchemasTunnelMethodTunnelMethod>() {});
