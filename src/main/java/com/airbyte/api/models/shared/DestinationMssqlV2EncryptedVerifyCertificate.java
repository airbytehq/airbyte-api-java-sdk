...
public class DestinationMssqlV2EncryptedVerifyCertificate {
    ...
    public DestinationMssqlV2EncryptedVerifyCertificate withName(DestinationMssqlV2SchemasName name) {
        Utils.checkNotNull(name, "name");
        this.name = Optional.ofNullable(name);
        return this;
    }

    public DestinationMssqlV2EncryptedVerifyCertificate withName(Optional<? extends DestinationMssqlV2SchemasName> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
