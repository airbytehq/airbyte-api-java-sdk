...
public class LoadingMethod {
     ...
     * <li>{@code com.airbyte.api.models.shared.StandardInserts}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<LoadingMethod> {
        ...
        public _Deserializer() {
            super(LoadingMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.GCSStaging>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.StandardInserts>() {}, JsonShape.DEFAULT));
        }
    }
