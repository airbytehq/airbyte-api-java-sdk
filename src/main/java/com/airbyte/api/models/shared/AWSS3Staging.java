...
public class AWSS3Staging {
    ...
    private Optional<String> s3BucketPath;
    ...
    public AWSS3Staging(
            ...
            @JsonProperty("s3_bucket_path") Optional<String> s3BucketPath,
     ...
     * The pattern allows you to set the file-name format for the S3 staging file(s)
     */
    public AWSS3Staging withFileNamePattern(Optional<String> fileNamePattern) {
        Utils.checkNotNull(fileNamePattern, "fileNamePattern");
        this.fileNamePattern = fileNamePattern;
        return this;
    }
