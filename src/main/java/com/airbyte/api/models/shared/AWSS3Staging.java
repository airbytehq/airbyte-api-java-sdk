...
public class AWSS3Staging {
    ...
    private Optional<? extends Long> fileBufferCount;
    ...
    public AWSS3Staging(
            ...
            @JsonProperty("file_buffer_count") Optional<? extends Long> fileBufferCount,
        ...
        Utils.checkNotNull(fileBufferCount, "fileBufferCount");
     ...
     * Number of file buffers allocated for writing data. Increasing this number is beneficial for connections using Change Data Capture (CDC) and up to the number of streams within a connection. Increasing the number of file buffers past the maximum number of streams has deteriorating effects
     */
    public Optional<? extends Long> fileBufferCount() {
        return fileBufferCount;
    }
     ...
     * Number of file buffers allocated for writing data. Increasing this number is beneficial for connections using Change Data Capture (CDC) and up to the number of streams within a connection. Increasing the number of file buffers past the maximum number of streams has deteriorating effects
     */
    public AWSS3Staging withFileBufferCount(long fileBufferCount) {
        Utils.checkNotNull(fileBufferCount, "fileBufferCount");
        this.fileBufferCount = Optional.ofNullable(fileBufferCount);
        return this;
    }
     ...
     * Number of file buffers allocated for writing data. Increasing this number is beneficial for connections using Change Data Capture (CDC) and up to the number of streams within a connection. Increasing the number of file buffers past the maximum number of streams has deteriorating effects
     */
    public AWSS3Staging withFileBufferCount(Optional<? extends Long> fileBufferCount) {
        Utils.checkNotNull(fileBufferCount, "fileBufferCount");
        this.fileBufferCount = fileBufferCount;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            java.util.Objects.deepEquals(this.fileBufferCount, other.fileBufferCount) &&
    ...
    public final static class Builder {
         ...
         * Number of file buffers allocated for writing data. Increasing this number is beneficial for connections using Change Data Capture (CDC) and up to the number of streams within a connection. Increasing the number of file buffers past the maximum number of streams has deteriorating effects
         */
        public Builder fileBufferCount(long fileBufferCount) {
            Utils.checkNotNull(fileBufferCount, "fileBufferCount");
            this.fileBufferCount = Optional.ofNullable(fileBufferCount);
            return this;
        }
         ...
         * Number of file buffers allocated for writing data. Increasing this number is beneficial for connections using Change Data Capture (CDC) and up to the number of streams within a connection. Increasing the number of file buffers past the maximum number of streams has deteriorating effects
         */
        public Builder fileBufferCount(Optional<? extends Long> fileBufferCount) {
            Utils.checkNotNull(fileBufferCount, "fileBufferCount");
            this.fileBufferCount = fileBufferCount;
            return this;
        }
        ...
        public AWSS3Staging build() {
            if (fileBufferCount == null) {
                fileBufferCount = _SINGLETON_VALUE_FileBufferCount.value();
            }
        ...
        private static final LazySingletonValue<Optional<? extends Long>> _SINGLETON_VALUE_FileBufferCount =
