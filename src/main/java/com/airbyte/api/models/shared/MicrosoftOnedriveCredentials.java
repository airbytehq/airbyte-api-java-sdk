...
public class MicrosoftOnedriveCredentials {
     ...
     * Client ID of your Microsoft developer application
     */
    public MicrosoftOnedriveCredentials withClientId(Optional<String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * Client Secret of your Microsoft developer application
     */
    public MicrosoftOnedriveCredentials withClientSecret(Optional<String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
