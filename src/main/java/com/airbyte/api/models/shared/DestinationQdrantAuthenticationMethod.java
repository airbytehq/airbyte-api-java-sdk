    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationQdrantAuthenticationMethod> {
        ...
        public _Deserializer() {
            super(DestinationQdrantAuthenticationMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.ApiKeyAuth>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationQdrantNoAuth>() {}, JsonShape.DEFAULT));
        }
    }
