 ...
 */
public class SourceGoogleDriveUnstructuredDocumentFormat {
    ...
    @JsonCreator
    public SourceGoogleDriveUnstructuredDocumentFormat(
     ...
     * Processing configuration
     */
    public SourceGoogleDriveUnstructuredDocumentFormat withProcessing(SourceGoogleDriveProcessing processing) {
        Utils.checkNotNull(processing, "processing");
     ...
     * Processing configuration
     */
    public SourceGoogleDriveUnstructuredDocumentFormat withProcessing(Optional<? extends SourceGoogleDriveProcessing> processing) {
        Utils.checkNotNull(processing, "processing");
        this.processing = processing;
        return this;
    }
     ...
     * The strategy used to parse documents. `fast` extracts text directly from the document which doesn't work for all files. `ocr_only` is more reliable, but slower. `hi_res` is the most reliable, but requires an API key and a hosted instance of unstructured and can't be used with local mode. See the unstructured.io documentation for more details: https://unstructured-io.github.io/unstructured/core/partition.html#partition-pdf
     */
    public SourceGoogleDriveUnstructuredDocumentFormat withStrategy(SourceGoogleDriveParsingStrategy strategy) {
        Utils.checkNotNull(strategy, "strategy");
     ...
     * The strategy used to parse documents. `fast` extracts text directly from the document which doesn't work for all files. `ocr_only` is more reliable, but slower. `hi_res` is the most reliable, but requires an API key and a hosted instance of unstructured and can't be used with local mode. See the unstructured.io documentation for more details: https://unstructured-io.github.io/unstructured/core/partition.html#partition-pdf
     */
    public SourceGoogleDriveUnstructuredDocumentFormat withStrategy(Optional<? extends SourceGoogleDriveParsingStrategy> strategy) {
        Utils.checkNotNull(strategy, "strategy");
        this.strategy = strategy;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceGoogleDriveUnstructuredDocumentFormat other = (SourceGoogleDriveUnstructuredDocumentFormat) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceGoogleDriveUnstructuredDocumentFormat.class,
                "filetype", filetype,
    ...
    public final static class Builder {
        ...
        public SourceGoogleDriveUnstructuredDocumentFormat build() {
            ...
            return new SourceGoogleDriveUnstructuredDocumentFormat(
                processing,
                skipUnprocessableFiles,
                strategy);
        }
