...
public class DestinationQdrantOpenAICompatible {
    ...
    public DestinationQdrantOpenAICompatible withApiKey(Optional<? extends String> apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
        this.apiKey = apiKey;
        return this;
    }
     ...
     * The name of the model to use for embedding
     */
    public DestinationQdrantOpenAICompatible withModelName(Optional<? extends String> modelName) {
        Utils.checkNotNull(modelName, "modelName");
        this.modelName = modelName;
        return this;
    }
