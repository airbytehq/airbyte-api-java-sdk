 ...
 */
public enum SourceSftpBulkParsingStrategy {
    AUTO("auto"),
    FAST("fast"),
    OCR_ONLY("ocr_only"),
    HI_RES("hi_res");
    ...
    public static Optional<SourceSftpBulkParsingStrategy> fromValue(String value) {
        for (SourceSftpBulkParsingStrategy o: SourceSftpBulkParsingStrategy.values()) {
