...
public class LeverHiringCredentials {
     ...
     * The Client ID of your Lever Hiring developer application.
     */
    public LeverHiringCredentials withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The Client Secret of your Lever Hiring developer application.
     */
    public LeverHiringCredentials withClientSecret(Optional<? extends String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
