...
public class SourceTypeformAuthorizationMethod {
     ...
     * <ul>
     * <li>{@code SourceTypeformOAuth20}</li>
     * <li>{@code SourceTypeformPrivateToken}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<SourceTypeformAuthorizationMethod> {

        public _Deserializer() {
            super(SourceTypeformAuthorizationMethod.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceTypeformOAuth20>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceTypeformPrivateToken>() {}, Utils.JsonShape.DEFAULT));
        }
    }
