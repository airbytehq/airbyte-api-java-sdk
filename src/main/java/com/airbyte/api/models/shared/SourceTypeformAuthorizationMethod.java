...
public class SourceTypeformAuthorizationMethod {
     ...
     * <ul>
     * <li>{@code com.airbyte.api.models.shared.SourceTypeformOAuth20}</li>
     * <li>{@code com.airbyte.api.models.shared.SourceTypeformPrivateToken}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceTypeformAuthorizationMethod> {

        public _Deserializer() {
            super(SourceTypeformAuthorizationMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<SourceTypeformOAuth20>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<SourceTypeformPrivateToken>() {}, JsonShape.DEFAULT));
        }
    }
