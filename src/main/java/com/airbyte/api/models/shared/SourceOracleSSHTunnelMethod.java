...
public class SourceOracleSSHTunnelMethod {
     ...
     * <ul>
     * <li>{@code SourceOracleNoTunnel}</li>
     * <li>{@code SourceOracleSSHKeyAuthentication}</li>
     * <li>{@code SourceOraclePasswordAuthentication}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<SourceOracleSSHTunnelMethod> {

        public _Deserializer() {
            super(SourceOracleSSHTunnelMethod.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceOracleNoTunnel>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceOracleSSHKeyAuthentication>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceOraclePasswordAuthentication>() {}, Utils.JsonShape.DEFAULT));
        }
    }
