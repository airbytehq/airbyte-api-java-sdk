...
public enum TheTargetedActionResourceForTheFetch {
    ...
    public static Optional<TheTargetedActionResourceForTheFetch> fromValue(String value) {
        for (TheTargetedActionResourceForTheFetch o: TheTargetedActionResourceForTheFetch.values()) {
