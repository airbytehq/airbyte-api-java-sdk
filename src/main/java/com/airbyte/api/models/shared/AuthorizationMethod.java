    ...
    public static final class _Deserializer extends OneOfDeserializer<AuthorizationMethod> {
        ...
        public _Deserializer() {
            super(AuthorizationMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationSnowflakeOAuth20>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.KeyPairAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.UsernameAndPassword>() {}, JsonShape.DEFAULT));
        }
    }
