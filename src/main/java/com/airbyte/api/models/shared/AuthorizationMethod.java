...
public class AuthorizationMethod {
     ...
     * <ul>
     * <li>{@code KeyPairAuthentication}</li>
     * <li>{@code UsernameAndPassword}</li>
     * <li>{@code DestinationSnowflakeOAuth20}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<AuthorizationMethod> {

        public _Deserializer() {
            super(AuthorizationMethod.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<KeyPairAuthentication>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<UsernameAndPassword>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationSnowflakeOAuth20>() {}, Utils.JsonShape.DEFAULT));
        }
    }
