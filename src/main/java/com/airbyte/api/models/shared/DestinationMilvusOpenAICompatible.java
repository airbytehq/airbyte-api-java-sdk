...
public class DestinationMilvusOpenAICompatible {
    ...
    @JsonIgnore
    public Optional<DestinationMilvusSchemasEmbeddingEmbedding5Mode> mode() {
        return (Optional<DestinationMilvusSchemasEmbeddingEmbedding5Mode>) mode;
    }
    ...
    public DestinationMilvusOpenAICompatible withApiKey(Optional<String> apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
        this.apiKey = apiKey;
        return this;
    }
     ...
     * The name of the model to use for embedding
     */
    public DestinationMilvusOpenAICompatible withModelName(Optional<String> modelName) {
        Utils.checkNotNull(modelName, "modelName");
        this.modelName = modelName;
        return this;
    }
