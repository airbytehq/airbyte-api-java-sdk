...
public class SourceDriftAuthorizationMethod {
     ...
     * <ul>
     * <li>{@code com.airbyte.api.models.shared.SourceDriftOAuth20}</li>
     * <li>{@code com.airbyte.api.models.shared.AccessToken}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceDriftAuthorizationMethod> {

        public _Deserializer() {
            super(SourceDriftAuthorizationMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<SourceDriftOAuth20>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<AccessToken>() {}, JsonShape.DEFAULT));
        }
    }
