...
public class SourceDriftAuthorizationMethod {
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<SourceDriftAuthorizationMethod> {

        public _Deserializer() {
            super(SourceDriftAuthorizationMethod.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceDriftOAuth20>() {}, Utils.JsonShape.DEFAULT),
