...
public class SourceGoogleDriveUserProvided {
     ...
     * The column names that will be used while emitting the CSV records
     */
    public SourceGoogleDriveUserProvided withColumnNames(java.util.List<String> columnNames) {
        Utils.checkNotNull(columnNames, "columnNames");
        this.columnNames = columnNames;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceGoogleDriveUserProvided other = (SourceGoogleDriveUserProvided) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceGoogleDriveUserProvided.class,
    ...
    public final static class Builder {
        ...
        public SourceGoogleDriveUserProvided build() {
            if (headerDefinitionType == null) {
                headerDefinitionType = _SINGLETON_VALUE_HeaderDefinitionType.value();
            }
            return new SourceGoogleDriveUserProvided(
                columnNames);
        }

        private static final LazySingletonValue<Optional<? extends SourceGoogleDriveSchemasStreamsHeaderDefinitionType>> _SINGLETON_VALUE_HeaderDefinitionType =
                new LazySingletonValue<>(
                        "header_definition_type",
                        "\"User Provided\"",
                        new TypeReference<Optional<? extends SourceGoogleDriveSchemasStreamsHeaderDefinitionType>>() {});
    }
}
