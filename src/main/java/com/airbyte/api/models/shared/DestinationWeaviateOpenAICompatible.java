...
public class DestinationWeaviateOpenAICompatible {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("mode")
    private Optional<? extends DestinationWeaviateSchemasEmbeddingEmbedding7Mode> mode;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DestinationWeaviateSchemasEmbeddingEmbedding7Mode> mode() {
        return (Optional<DestinationWeaviateSchemasEmbeddingEmbedding7Mode>) mode;
    }
    ...
    public DestinationWeaviateOpenAICompatible withApiKey(Optional<? extends String> apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
        this.apiKey = apiKey;
        return this;
    }
     ...
     * The base URL for your OpenAI-compatible service
     */
    public DestinationWeaviateOpenAICompatible withBaseUrl(String baseUrl) {
        Utils.checkNotNull(baseUrl, "baseUrl");
        this.baseUrl = baseUrl;
        return this;
    }
     ...
     * The number of dimensions the embedding model is generating
     */
    public DestinationWeaviateOpenAICompatible withDimensions(long dimensions) {
        Utils.checkNotNull(dimensions, "dimensions");
        this.dimensions = dimensions;
        return this;
    }
     ...
     * The name of the model to use for embedding
     */
    public DestinationWeaviateOpenAICompatible withModelName(String modelName) {
        Utils.checkNotNull(modelName, "modelName");
     ...
     * The name of the model to use for embedding
     */
    public DestinationWeaviateOpenAICompatible withModelName(Optional<? extends String> modelName) {
        Utils.checkNotNull(modelName, "modelName");
        this.modelName = modelName;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(DestinationWeaviateOpenAICompatible.class,
                "apiKey", apiKey,
                "baseUrl", baseUrl,
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends DestinationWeaviateSchemasEmbeddingEmbedding7Mode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"openai_compatible\"",
                        new TypeReference<Optional<? extends DestinationWeaviateSchemasEmbeddingEmbedding7Mode>>() {});
