...
public class DestinationOracle {
     ...
     * The password associated with the username.
     */
    public DestinationOracle withPassword(Optional<String> password) {
        Utils.checkNotNull(password, "password");
        this.password = password;
        return this;
    }
     ...
     * The port of the database.
     */
    public DestinationOracle withPort(Optional<Long> port) {
        Utils.checkNotNull(port, "port");
        this.port = port;
        return this;
    }
     ...
     * The schema to write raw tables into (default: airbyte_internal)
     */
    public DestinationOracle withRawDataSchema(Optional<String> rawDataSchema) {
        Utils.checkNotNull(rawDataSchema, "rawDataSchema");
        this.rawDataSchema = rawDataSchema;
        return this;
    }
