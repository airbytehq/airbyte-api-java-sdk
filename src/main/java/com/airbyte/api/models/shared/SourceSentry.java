...
public class SourceSentry {
    /**
     * Log into Sentry and then <a href="https://sentry.io/settings/account/api/auth-tokens/">create
     * authentication tokens</a>.For self-hosted, you can find or create authentication tokens by visiting
     * "{instance_url_prefix}/settings/account/api/auth-tokens/"
     */
    ...
    /**
     * Host name of Sentry API server.For self-hosted, specify your host name here. Otherwise, leave it
     * empty.
     */
    @JsonInclude(Include.NON_ABSENT)
