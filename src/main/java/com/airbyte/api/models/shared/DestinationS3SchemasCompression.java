    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationS3SchemasCompression> {
        ...
        public _Deserializer() {
            super(DestinationS3SchemasCompression.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationS3SchemasGZIP>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationS3SchemasNoCompression>() {}, JsonShape.DEFAULT));
        }
    }
