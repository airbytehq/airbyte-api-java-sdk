...
public class DestinationS3SchemasCompression {
     ...
     * <ul>
     * <li>{@code DestinationS3SchemasNoCompression}</li>
     * <li>{@code DestinationS3SchemasGZIP}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<DestinationS3SchemasCompression> {

        public _Deserializer() {
            super(DestinationS3SchemasCompression.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationS3SchemasNoCompression>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationS3SchemasGZIP>() {}, Utils.JsonShape.DEFAULT));
        }
    }
