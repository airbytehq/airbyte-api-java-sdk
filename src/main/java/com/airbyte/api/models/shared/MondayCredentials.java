...
public class MondayCredentials {
     ...
     * The Client ID of your OAuth application.
     */
    public MondayCredentials withClientId(String clientId) {
        Utils.checkNotNull(clientId, "clientId");
     ...
     * The Client ID of your OAuth application.
     */
    public MondayCredentials withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The Client Secret of your OAuth application.
     */
    public MondayCredentials withClientSecret(String clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
     ...
     * The Client Secret of your OAuth application.
     */
    public MondayCredentials withClientSecret(Optional<? extends String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MondayCredentials other = (MondayCredentials) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MondayCredentials.class,
                "clientId", clientId,
    ...
    public final static class Builder {
        ...
        public MondayCredentials build() {
            return new MondayCredentials(
                clientId,
                clientSecret);
        }
    }
