...
public class SourceSharepointEnterprise {
    ...
    /**
     * Input additional query to search files. It will make search files step faster if your Sharepoint
     * account has a lot of files and folders. This query text will be used in the request that will look
     * for files which properties contains inserted text.
     * 
     * <p>You can use multiple query texts, they will be applied in search request one by one.
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("file_contains_query")
    private Optional<? extends List<String>> fileContainsQuery;
    ...
    /**
     * Specifies the location(s) to search for files. Valid options are 'ACCESSIBLE_DRIVES' for all
    ...
    /**
     * Url of SharePoint site to search for files. Leave empty to search in the main site. Use
     * 'https://&lt;tenant_name&gt;.sharepoint.com/sites/' to iterate over all sites.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public SourceSharepointEnterprise(
            ...
            @JsonProperty("file_contains_query") Optional<? extends List<String>> fileContainsQuery,
        ...
        Utils.checkNotNull(fileContainsQuery, "fileContainsQuery");
        ...
        this.fileContainsQuery = fileContainsQuery;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<List<String>> fileContainsQuery() {
        return (Optional<List<String>>) fileContainsQuery;
    }
     ...
     * <p>You can use multiple query texts, they will be applied in search request one by one.
     */
    public SourceSharepointEnterprise withFileContainsQuery(List<String> fileContainsQuery) {
        Utils.checkNotNull(fileContainsQuery, "fileContainsQuery");
        this.fileContainsQuery = Optional.ofNullable(fileContainsQuery);
        return this;
    }
     ...
     * <p>You can use multiple query texts, they will be applied in search request one by one.
     */
    public SourceSharepointEnterprise withFileContainsQuery(Optional<? extends List<String>> fileContainsQuery) {
        Utils.checkNotNull(fileContainsQuery, "fileContainsQuery");
        this.fileContainsQuery = fileContainsQuery;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.fileContainsQuery, other.fileContainsQuery) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            credentials, deliveryMethod, fileContainsQuery,
            folderPath, searchScope, siteUrl,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<String>> fileContainsQuery = Optional.empty();
         ...
         * <p>You can use multiple query texts, they will be applied in search request one by one.
         */
        public Builder fileContainsQuery(List<String> fileContainsQuery) {
            Utils.checkNotNull(fileContainsQuery, "fileContainsQuery");
            this.fileContainsQuery = Optional.ofNullable(fileContainsQuery);
            return this;
        }
         ...
         * <p>You can use multiple query texts, they will be applied in search request one by one.
         */
        public Builder fileContainsQuery(Optional<? extends List<String>> fileContainsQuery) {
            Utils.checkNotNull(fileContainsQuery, "fileContainsQuery");
            this.fileContainsQuery = fileContainsQuery;
            return this;
        }
