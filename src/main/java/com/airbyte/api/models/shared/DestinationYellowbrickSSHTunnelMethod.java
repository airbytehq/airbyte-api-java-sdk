...
public class DestinationYellowbrickSSHTunnelMethod {
     ...
     * <ul>
     * <li>{@code DestinationYellowbrickNoTunnel}</li>
     * <li>{@code DestinationYellowbrickSSHKeyAuthentication}</li>
     * <li>{@code DestinationYellowbrickPasswordAuthentication}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<DestinationYellowbrickSSHTunnelMethod> {

        public _Deserializer() {
            super(DestinationYellowbrickSSHTunnelMethod.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationYellowbrickNoTunnel>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationYellowbrickSSHKeyAuthentication>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationYellowbrickPasswordAuthentication>() {}, Utils.JsonShape.DEFAULT));
        }
    }
