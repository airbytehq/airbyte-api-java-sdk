    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationYellowbrickSSHTunnelMethod> {
        ...
        public _Deserializer() {
            super(DestinationYellowbrickSSHTunnelMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationYellowbrickPasswordAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationYellowbrickSSHKeyAuthentication>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationYellowbrickNoTunnel>() {}, JsonShape.DEFAULT));
        }
    }
