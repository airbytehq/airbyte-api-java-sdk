...
public class DestinationYellowbrick {
     ...
     * Password associated with the username.
     */
    public DestinationYellowbrick withPassword(Optional<String> password) {
        Utils.checkNotNull(password, "password");
        this.password = password;
        return this;
    }
     ...
     * Port of the database.
     */
    public DestinationYellowbrick withPort(Optional<Long> port) {
        Utils.checkNotNull(port, "port");
        this.port = port;
        return this;
    }
     ...
     * Encrypt data using SSL. When activating SSL, please select one of the connection modes.
     */
    public DestinationYellowbrick withSsl(Optional<Boolean> ssl) {
        Utils.checkNotNull(ssl, "ssl");
        this.ssl = ssl;
        return this;
    }
