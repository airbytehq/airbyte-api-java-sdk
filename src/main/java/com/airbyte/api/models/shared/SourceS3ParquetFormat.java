...
public class SourceS3ParquetFormat {
    ...
    public Optional<? extends SourceS3SchemasStreamsFormatFormat4Filetype> filetype() {
        return filetype;
    }
     ...
     * Whether to convert decimal fields to floats. There is a loss of precision when converting decimals to floats, so this is not recommended.
     */
    public SourceS3ParquetFormat withDecimalAsFloat(Optional<? extends Boolean> decimalAsFloat) {
        Utils.checkNotNull(decimalAsFloat, "decimalAsFloat");
        this.decimalAsFloat = decimalAsFloat;
        return this;
    }
