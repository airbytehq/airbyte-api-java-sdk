...
public enum SourceSftpBulkValidationPolicy {
    ...
    public static Optional<SourceSftpBulkValidationPolicy> fromValue(String value) {
        for (SourceSftpBulkValidationPolicy o: SourceSftpBulkValidationPolicy.values()) {
