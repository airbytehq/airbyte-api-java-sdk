    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationSnowflakeCortexTextSplitter> {
        ...
        public _Deserializer() {
            super(DestinationSnowflakeCortexTextSplitter.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationSnowflakeCortexBySeparator>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationSnowflakeCortexByProgrammingLanguage>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationSnowflakeCortexByMarkdownHeader>() {}, JsonShape.DEFAULT));
        }
    }
