...
public class SourceClockodo {
    ...
    /**
     * Identification of the calling application, including the email address of a technical contact
     * person. Format: [name of application or company];[email address].
     */
