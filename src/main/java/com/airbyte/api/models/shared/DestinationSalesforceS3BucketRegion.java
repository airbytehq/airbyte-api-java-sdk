 ...
 */
public enum DestinationSalesforceS3BucketRegion {
    UNKNOWN(""),
    ...
    DestinationSalesforceS3BucketRegion(String value) {
        this.value = value;
    }
    ...
    public static Optional<DestinationSalesforceS3BucketRegion> fromValue(String value) {
        for (DestinationSalesforceS3BucketRegion o: DestinationSalesforceS3BucketRegion.values()) {
