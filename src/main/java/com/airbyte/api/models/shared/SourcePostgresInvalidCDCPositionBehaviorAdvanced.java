...
public enum SourcePostgresInvalidCDCPositionBehaviorAdvanced {
    ...
    public static Optional<SourcePostgresInvalidCDCPositionBehaviorAdvanced> fromValue(String value) {
        for (SourcePostgresInvalidCDCPositionBehaviorAdvanced o: SourcePostgresInvalidCDCPositionBehaviorAdvanced.values()) {
