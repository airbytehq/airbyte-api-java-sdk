...
public class SmartsheetsCredentials {
     ...
     * The API ID of the SmartSheets developer application.
     */
    public SmartsheetsCredentials withClientId(String clientId) {
        Utils.checkNotNull(clientId, "clientId");
     ...
     * The API ID of the SmartSheets developer application.
     */
    public SmartsheetsCredentials withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The API Secret the SmartSheets developer application.
     */
    public SmartsheetsCredentials withClientSecret(String clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
     ...
     * The API Secret the SmartSheets developer application.
     */
    public SmartsheetsCredentials withClientSecret(Optional<? extends String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SmartsheetsCredentials other = (SmartsheetsCredentials) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SmartsheetsCredentials.class,
                "clientId", clientId,
    ...
    public final static class Builder {
        ...
        public SmartsheetsCredentials build() {
            return new SmartsheetsCredentials(
                clientId,
                clientSecret);
        }
    }
