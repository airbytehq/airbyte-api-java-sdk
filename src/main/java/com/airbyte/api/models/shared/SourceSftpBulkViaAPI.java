...
public class SourceSftpBulkViaAPI {
    ...
    private Optional<? extends java.util.List<SourceSftpBulkAPIParameterConfigModel>> parameters;
    ...
    public SourceSftpBulkViaAPI(
            ...
            @JsonProperty("parameters") Optional<? extends java.util.List<SourceSftpBulkAPIParameterConfigModel>> parameters) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<SourceSftpBulkAPIParameterConfigModel>> parameters() {
        return (Optional<java.util.List<SourceSftpBulkAPIParameterConfigModel>>) parameters;
    }
     ...
     * The API key to use matching the environment
     */
    public SourceSftpBulkViaAPI withApiKey(Optional<? extends String> apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
        this.apiKey = apiKey;
        return this;
    }
     ...
     * The URL of the unstructured API to use
     */
    public SourceSftpBulkViaAPI withApiUrl(Optional<? extends String> apiUrl) {
        Utils.checkNotNull(apiUrl, "apiUrl");
        this.apiUrl = apiUrl;
        return this;
    }
     ...
     * List of parameters send to the API
     */
    public SourceSftpBulkViaAPI withParameters(java.util.List<SourceSftpBulkAPIParameterConfigModel> parameters) {
        Utils.checkNotNull(parameters, "parameters");
     ...
     * List of parameters send to the API
     */
    public SourceSftpBulkViaAPI withParameters(Optional<? extends java.util.List<SourceSftpBulkAPIParameterConfigModel>> parameters) {
        Utils.checkNotNull(parameters, "parameters");
        this.parameters = parameters;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<SourceSftpBulkAPIParameterConfigModel>> parameters = Optional.empty();  
         ...
         * List of parameters send to the API
         */
        public Builder parameters(java.util.List<SourceSftpBulkAPIParameterConfigModel> parameters) {
            Utils.checkNotNull(parameters, "parameters");
            this.parameters = Optional.ofNullable(parameters);
            return this;
        }
         ...
         * List of parameters send to the API
         */
        public Builder parameters(Optional<? extends java.util.List<SourceSftpBulkAPIParameterConfigModel>> parameters) {
            Utils.checkNotNull(parameters, "parameters");
            this.parameters = parameters;
            return this;
        }
