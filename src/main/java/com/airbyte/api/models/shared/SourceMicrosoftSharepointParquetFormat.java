...
public class SourceMicrosoftSharepointParquetFormat {
    ...
    private Optional<? extends SourceMicrosoftSharepointSchemasStreamsFormatFiletype> filetype;

    public SourceMicrosoftSharepointParquetFormat(
    ...
    public Optional<? extends SourceMicrosoftSharepointSchemasStreamsFormatFiletype> filetype() {
        return filetype;
    }
     ...
     * Whether to convert decimal fields to floats. There is a loss of precision when converting decimals to floats, so this is not recommended.
     */
    public SourceMicrosoftSharepointParquetFormat withDecimalAsFloat(boolean decimalAsFloat) {
        Utils.checkNotNull(decimalAsFloat, "decimalAsFloat");
     ...
     * Whether to convert decimal fields to floats. There is a loss of precision when converting decimals to floats, so this is not recommended.
     */
    public SourceMicrosoftSharepointParquetFormat withDecimalAsFloat(Optional<? extends Boolean> decimalAsFloat) {
        Utils.checkNotNull(decimalAsFloat, "decimalAsFloat");
        this.decimalAsFloat = decimalAsFloat;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(SourceMicrosoftSharepointParquetFormat.class,
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends SourceMicrosoftSharepointSchemasStreamsFormatFiletype>> _SINGLETON_VALUE_Filetype =
                new LazySingletonValue<>(
                        "filetype",
                        "\"parquet\"",
                        new TypeReference<Optional<? extends SourceMicrosoftSharepointSchemasStreamsFormatFiletype>>() {});
    }
}
