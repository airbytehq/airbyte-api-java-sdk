...
public class FacebookMarketingCredentials {
     ...
     * The Client Id for your OAuth app
     */
    public FacebookMarketingCredentials withClientId(Optional<String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The Client Secret for your OAuth app
     */
    public FacebookMarketingCredentials withClientSecret(Optional<String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
