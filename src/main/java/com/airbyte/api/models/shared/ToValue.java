...
public class ToValue {
     ...
     * <ul>
     * <li>{@code SourceGoogleAnalyticsDataApiSchemasInt64Value}</li>
     * <li>{@code SourceGoogleAnalyticsDataApiSchemasDoubleValue}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<ToValue> {

        public _Deserializer() {
            super(ToValue.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceGoogleAnalyticsDataApiSchemasInt64Value>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceGoogleAnalyticsDataApiSchemasDoubleValue>() {}, Utils.JsonShape.DEFAULT));
        }
    }
