...
public class DestinationYellowbrickPasswordAuthentication {
    ...
    private DestinationYellowbrickSchemasTunnelMethodTunnelMethod tunnelMethod;
    ...
    @JsonCreator
    public DestinationYellowbrickPasswordAuthentication(
     ...
     */
    @JsonIgnore
    public DestinationYellowbrickSchemasTunnelMethodTunnelMethod tunnelMethod() {
        return tunnelMethod;
    }
     ...
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    public DestinationYellowbrickPasswordAuthentication withTunnelHost(String tunnelHost) {
        Utils.checkNotNull(tunnelHost, "tunnelHost");
        this.tunnelHost = tunnelHost;
        return this;
    }
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationYellowbrickPasswordAuthentication withTunnelPort(long tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationYellowbrickPasswordAuthentication withTunnelPort(Optional<Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
     ...
     * OS-level username for logging into the jump server host
     */
    public DestinationYellowbrickPasswordAuthentication withTunnelUser(String tunnelUser) {
        Utils.checkNotNull(tunnelUser, "tunnelUser");
        this.tunnelUser = tunnelUser;
        return this;
    }
     ...
     * OS-level password for logging into the jump server host
     */
    public DestinationYellowbrickPasswordAuthentication withTunnelUserPassword(String tunnelUserPassword) {
        Utils.checkNotNull(tunnelUserPassword, "tunnelUserPassword");
        this.tunnelUserPassword = tunnelUserPassword;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationYellowbrickPasswordAuthentication other = (DestinationYellowbrickPasswordAuthentication) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationYellowbrickPasswordAuthentication.class,
    ...
    public final static class Builder {
        ...
        public DestinationYellowbrickPasswordAuthentication build() {
            if (tunnelPort == null) {
                tunnelPort = _SINGLETON_VALUE_TunnelPort.value();
            }

            return new DestinationYellowbrickPasswordAuthentication(
                tunnelHost, tunnelPort, tunnelUser,
                tunnelUserPassword);
        }


        private static final LazySingletonValue<DestinationYellowbrickSchemasTunnelMethodTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_PASSWORD_AUTH\"",
                        new TypeReference<DestinationYellowbrickSchemasTunnelMethodTunnelMethod>() {});
