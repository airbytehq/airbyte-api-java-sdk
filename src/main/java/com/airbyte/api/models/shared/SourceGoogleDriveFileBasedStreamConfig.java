...
public class SourceGoogleDriveFileBasedStreamConfig {
     ...
     * The number of resent files which will be used to discover the schema for this stream.
     */
    public SourceGoogleDriveFileBasedStreamConfig withRecentNFilesToReadForSchemaDiscovery(long recentNFilesToReadForSchemaDiscovery) {
        Utils.checkNotNull(recentNFilesToReadForSchemaDiscovery, "recentNFilesToReadForSchemaDiscovery");
     ...
     * The number of resent files which will be used to discover the schema for this stream.
     */
    public SourceGoogleDriveFileBasedStreamConfig withRecentNFilesToReadForSchemaDiscovery(Optional<Long> recentNFilesToReadForSchemaDiscovery) {
        Utils.checkNotNull(recentNFilesToReadForSchemaDiscovery, "recentNFilesToReadForSchemaDiscovery");
        this.recentNFilesToReadForSchemaDiscovery = recentNFilesToReadForSchemaDiscovery;
        return this;
    }
