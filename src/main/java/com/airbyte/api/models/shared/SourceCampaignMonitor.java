...
public class SourceCampaignMonitor {
    ...
    public SourceCampaignMonitor withPassword(Optional<? extends String> password) {
        Utils.checkNotNull(password, "password");
        this.password = password;
        return this;
    }
     ...
     * Date from when the sync should start
     */
    public SourceCampaignMonitor withStartDate(Optional<? extends String> startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
