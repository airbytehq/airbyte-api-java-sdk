...
public class DestinationOracleSSHKeyAuthentication {
    ...
    private DestinationOracleSchemasTunnelMethod tunnelMethod;
    ...
    public DestinationOracleSSHKeyAuthentication(
     ...
     * Connect through a jump server tunnel host using username and ssh key
     */
    public DestinationOracleSchemasTunnelMethod tunnelMethod() {
        return tunnelMethod;
    }
     ...
     * OS-level user account ssh key credentials in RSA PEM format ( created with ssh-keygen -t rsa -m PEM -f myuser_rsa )
     */
    public DestinationOracleSSHKeyAuthentication withSshKey(String sshKey) {
        Utils.checkNotNull(sshKey, "sshKey");
        this.sshKey = sshKey;
        return this;
    }
     ...
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    public DestinationOracleSSHKeyAuthentication withTunnelHost(String tunnelHost) {
        Utils.checkNotNull(tunnelHost, "tunnelHost");
        this.tunnelHost = tunnelHost;
        return this;
    }
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationOracleSSHKeyAuthentication withTunnelPort(long tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationOracleSSHKeyAuthentication withTunnelPort(Optional<? extends Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
     ...
     * OS-level username for logging into the jump server host.
     */
    public DestinationOracleSSHKeyAuthentication withTunnelUser(String tunnelUser) {
        Utils.checkNotNull(tunnelUser, "tunnelUser");
        this.tunnelUser = tunnelUser;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationOracleSSHKeyAuthentication other = (DestinationOracleSSHKeyAuthentication) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationOracleSSHKeyAuthentication.class,
                "sshKey", sshKey,
    ...
    public final static class Builder {
        ...
        public DestinationOracleSSHKeyAuthentication build() {
            if (tunnelPort == null) {
        ...
        private static final LazySingletonValue<DestinationOracleSchemasTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_KEY_AUTH\"",
                        new TypeReference<DestinationOracleSchemasTunnelMethod>() {});
