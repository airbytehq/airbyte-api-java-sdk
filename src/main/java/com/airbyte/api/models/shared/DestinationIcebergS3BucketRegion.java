 ...
 */
public enum DestinationIcebergS3BucketRegion {
    UNKNOWN(""),
    ...
    private DestinationIcebergS3BucketRegion(String value) {
        this.value = value;
    }
    ...
    public static Optional<DestinationIcebergS3BucketRegion> fromValue(String value) {
        for (DestinationIcebergS3BucketRegion o: DestinationIcebergS3BucketRegion.values()) {
