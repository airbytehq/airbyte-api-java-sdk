    ...
    public static final class _Deserializer extends OneOfDeserializer<SourceLinkedinAdsAuthentication> {
        ...
        public _Deserializer() {
            super(SourceLinkedinAdsAuthentication.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceLinkedinAdsOAuth20>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.AccessToken>() {}, JsonShape.DEFAULT));
        }
    }
