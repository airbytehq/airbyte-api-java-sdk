...
@JsonDeserialize(using = OutputFormat._Deserializer.class)
public class OutputFormat {
     ...
     * <ul>
     * <li>{@code com.airbyte.api.models.shared.CSVCommaSeparatedValues}</li>
     * <li>{@code com.airbyte.api.models.shared.DestinationAzureBlobStorageJSONLinesNewlineDelimitedJSON}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<OutputFormat> {

        public _Deserializer() {
            super(OutputFormat.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.CSVCommaSeparatedValues>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationAzureBlobStorageJSONLinesNewlineDelimitedJSON>() {}, JsonShape.DEFAULT));
        }
    }
