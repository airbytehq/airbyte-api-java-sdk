...
public class OutputFormat {
     ...
     * <ul>
     * <li>{@code CSVCommaSeparatedValues}</li>
     * <li>{@code DestinationAzureBlobStorageJSONLinesNewlineDelimitedJSON}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<OutputFormat> {

        public _Deserializer() {
            super(OutputFormat.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<CSVCommaSeparatedValues>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationAzureBlobStorageJSONLinesNewlineDelimitedJSON>() {}, Utils.JsonShape.DEFAULT));
        }
    }
