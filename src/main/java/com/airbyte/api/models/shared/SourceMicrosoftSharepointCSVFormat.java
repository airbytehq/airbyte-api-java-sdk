...
public class SourceMicrosoftSharepointCSVFormat {
    /**
    ...
    private Optional<? extends SourceMicrosoftSharepointSchemasFiletype> filetype;
    ...
    private Optional<? extends SourceMicrosoftSharepointCSVHeaderDefinition> headerDefinition;
    ...
    @JsonCreator
    public SourceMicrosoftSharepointCSVFormat(
            ...
            @JsonProperty("header_definition") Optional<? extends SourceMicrosoftSharepointCSVHeaderDefinition> headerDefinition,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<SourceMicrosoftSharepointSchemasFiletype> filetype() {
        return (Optional<SourceMicrosoftSharepointSchemasFiletype>) filetype;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<SourceMicrosoftSharepointCSVHeaderDefinition> headerDefinition() {
        return (Optional<SourceMicrosoftSharepointCSVHeaderDefinition>) headerDefinition;
    }
     ...
     * For tab-delimited data enter '\t'.
     */
    public SourceMicrosoftSharepointCSVFormat withDelimiter(String delimiter) {
        Utils.checkNotNull(delimiter, "delimiter");
     ...
     * For tab-delimited data enter '\t'.
     */
    public SourceMicrosoftSharepointCSVFormat withDelimiter(Optional<String> delimiter) {
        Utils.checkNotNull(delimiter, "delimiter");
        this.delimiter = delimiter;
        return this;
    }
     ...
     * Whether two quotes in a quoted CSV value denote a single quote in the data.
     */
    public SourceMicrosoftSharepointCSVFormat withDoubleQuote(boolean doubleQuote) {
        Utils.checkNotNull(doubleQuote, "doubleQuote");
     ...
     * Whether two quotes in a quoted CSV value denote a single quote in the data.
     */
    public SourceMicrosoftSharepointCSVFormat withDoubleQuote(Optional<Boolean> doubleQuote) {
        Utils.checkNotNull(doubleQuote, "doubleQuote");
        this.doubleQuote = doubleQuote;
        return this;
    }
     ...
     * for allowable options.
     */
    public SourceMicrosoftSharepointCSVFormat withEncoding(String encoding) {
        Utils.checkNotNull(encoding, "encoding");
     ...
     * for allowable options.
     */
    public SourceMicrosoftSharepointCSVFormat withEncoding(Optional<String> encoding) {
        Utils.checkNotNull(encoding, "encoding");
        this.encoding = encoding;
        return this;
    }
     ...
     * The character used for escaping special characters. To disallow escaping, leave this field blank.
     */
    public SourceMicrosoftSharepointCSVFormat withEscapeChar(String escapeChar) {
        Utils.checkNotNull(escapeChar, "escapeChar");
     ...
     * The character used for escaping special characters. To disallow escaping, leave this field blank.
     */
    public SourceMicrosoftSharepointCSVFormat withEscapeChar(Optional<String> escapeChar) {
        Utils.checkNotNull(escapeChar, "escapeChar");
        this.escapeChar = escapeChar;
        return this;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as false values.
     */
    public SourceMicrosoftSharepointCSVFormat withFalseValues(List<String> falseValues) {
        Utils.checkNotNull(falseValues, "falseValues");
     ...
     * A set of case-sensitive strings that should be interpreted as false values.
     */
    public SourceMicrosoftSharepointCSVFormat withFalseValues(Optional<? extends List<String>> falseValues) {
        Utils.checkNotNull(falseValues, "falseValues");
        this.falseValues = falseValues;
        return this;
    }
     ...
     * rows.
     */
    public SourceMicrosoftSharepointCSVFormat withHeaderDefinition(SourceMicrosoftSharepointCSVHeaderDefinition headerDefinition) {
        Utils.checkNotNull(headerDefinition, "headerDefinition");
     ...
     * rows.
     */
    public SourceMicrosoftSharepointCSVFormat withHeaderDefinition(Optional<? extends SourceMicrosoftSharepointCSVHeaderDefinition> headerDefinition) {
        Utils.checkNotNull(headerDefinition, "headerDefinition");
        this.headerDefinition = headerDefinition;
        return this;
    }
     ...
     * of columns in the schema.
     */
    public SourceMicrosoftSharepointCSVFormat withIgnoreErrorsOnFieldsMismatch(boolean ignoreErrorsOnFieldsMismatch) {
        Utils.checkNotNull(ignoreErrorsOnFieldsMismatch, "ignoreErrorsOnFieldsMismatch");
     ...
     * of columns in the schema.
     */
    public SourceMicrosoftSharepointCSVFormat withIgnoreErrorsOnFieldsMismatch(Optional<Boolean> ignoreErrorsOnFieldsMismatch) {
        Utils.checkNotNull(ignoreErrorsOnFieldsMismatch, "ignoreErrorsOnFieldsMismatch");
        this.ignoreErrorsOnFieldsMismatch = ignoreErrorsOnFieldsMismatch;
        return this;
    }
     ...
     * 'NA' should be interpreted as null, enter 'NA' in this field.
     */
    public SourceMicrosoftSharepointCSVFormat withNullValues(List<String> nullValues) {
        Utils.checkNotNull(nullValues, "nullValues");
     ...
     * 'NA' should be interpreted as null, enter 'NA' in this field.
     */
    public SourceMicrosoftSharepointCSVFormat withNullValues(Optional<? extends List<String>> nullValues) {
        Utils.checkNotNull(nullValues, "nullValues");
        this.nullValues = nullValues;
        return this;
    }
     ...
     * The character used for quoting CSV values. To disallow quoting, make this field blank.
     */
    public SourceMicrosoftSharepointCSVFormat withQuoteChar(String quoteChar) {
        Utils.checkNotNull(quoteChar, "quoteChar");
     ...
     * The character used for quoting CSV values. To disallow quoting, make this field blank.
     */
    public SourceMicrosoftSharepointCSVFormat withQuoteChar(Optional<String> quoteChar) {
        Utils.checkNotNull(quoteChar, "quoteChar");
        this.quoteChar = quoteChar;
        return this;
    }
     ...
     * The number of rows to skip after the header row.
     */
    public SourceMicrosoftSharepointCSVFormat withSkipRowsAfterHeader(long skipRowsAfterHeader) {
        Utils.checkNotNull(skipRowsAfterHeader, "skipRowsAfterHeader");
     ...
     * The number of rows to skip after the header row.
     */
    public SourceMicrosoftSharepointCSVFormat withSkipRowsAfterHeader(Optional<Long> skipRowsAfterHeader) {
        Utils.checkNotNull(skipRowsAfterHeader, "skipRowsAfterHeader");
        this.skipRowsAfterHeader = skipRowsAfterHeader;
        return this;
    }
     ...
     * enter 2 in this field.
     */
    public SourceMicrosoftSharepointCSVFormat withSkipRowsBeforeHeader(long skipRowsBeforeHeader) {
        Utils.checkNotNull(skipRowsBeforeHeader, "skipRowsBeforeHeader");
     ...
     * enter 2 in this field.
     */
    public SourceMicrosoftSharepointCSVFormat withSkipRowsBeforeHeader(Optional<Long> skipRowsBeforeHeader) {
        Utils.checkNotNull(skipRowsBeforeHeader, "skipRowsBeforeHeader");
        this.skipRowsBeforeHeader = skipRowsBeforeHeader;
        return this;
    }
     ...
     * the string itself.
     */
    public SourceMicrosoftSharepointCSVFormat withStringsCanBeNull(boolean stringsCanBeNull) {
        Utils.checkNotNull(stringsCanBeNull, "stringsCanBeNull");
     ...
     * the string itself.
     */
    public SourceMicrosoftSharepointCSVFormat withStringsCanBeNull(Optional<Boolean> stringsCanBeNull) {
        Utils.checkNotNull(stringsCanBeNull, "stringsCanBeNull");
        this.stringsCanBeNull = stringsCanBeNull;
        return this;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as true values.
     */
    public SourceMicrosoftSharepointCSVFormat withTrueValues(List<String> trueValues) {
        Utils.checkNotNull(trueValues, "trueValues");
     ...
     * A set of case-sensitive strings that should be interpreted as true values.
     */
    public SourceMicrosoftSharepointCSVFormat withTrueValues(Optional<? extends List<String>> trueValues) {
        Utils.checkNotNull(trueValues, "trueValues");
        this.trueValues = trueValues;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceMicrosoftSharepointCSVFormat other = (SourceMicrosoftSharepointCSVFormat) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceMicrosoftSharepointCSVFormat.class,
                "delimiter", delimiter,
    ...
    public final static class Builder {
        ...
        private Optional<? extends SourceMicrosoftSharepointCSVHeaderDefinition> headerDefinition = Optional.empty();
         ...
         * rows.
         */
        public Builder headerDefinition(SourceMicrosoftSharepointCSVHeaderDefinition headerDefinition) {
            Utils.checkNotNull(headerDefinition, "headerDefinition");
            this.headerDefinition = Optional.ofNullable(headerDefinition);
            return this;
        }
         ...
         * rows.
         */
        public Builder headerDefinition(Optional<? extends SourceMicrosoftSharepointCSVHeaderDefinition> headerDefinition) {
            Utils.checkNotNull(headerDefinition, "headerDefinition");
            this.headerDefinition = headerDefinition;
            return this;
        }
        ...
        public SourceMicrosoftSharepointCSVFormat build() {
            if (delimiter == null) {
            ...
            return new SourceMicrosoftSharepointCSVFormat(
                delimiter, doubleQuote, encoding,
        ...
        private static final LazySingletonValue<Optional<? extends SourceMicrosoftSharepointSchemasFiletype>> _SINGLETON_VALUE_Filetype =
                new LazySingletonValue<>(
                        "filetype",
                        "\"csv\"",
                        new TypeReference<Optional<? extends SourceMicrosoftSharepointSchemasFiletype>>() {});
