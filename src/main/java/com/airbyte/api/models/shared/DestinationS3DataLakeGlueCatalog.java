...
public class DestinationS3DataLakeGlueCatalog {
    ...
    @JsonCreator
    public DestinationS3DataLakeGlueCatalog(
    ...
    @JsonAnySetter
    public DestinationS3DataLakeGlueCatalog withAdditionalProperty(String key, Object value) {
    ...
    public DestinationS3DataLakeGlueCatalog withAdditionalProperties(Map<String, Object> additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = additionalProperties;
        return this;
    }

    public DestinationS3DataLakeGlueCatalog withCatalogType(DestinationS3DataLakeCatalogType catalogType) {
        Utils.checkNotNull(catalogType, "catalogType");
        this.catalogType = Optional.ofNullable(catalogType);
        return this;
    }

    public DestinationS3DataLakeGlueCatalog withCatalogType(Optional<? extends DestinationS3DataLakeCatalogType> catalogType) {
        Utils.checkNotNull(catalogType, "catalogType");
        this.catalogType = catalogType;
        return this;
    }
     ...
     * The Glue database name. This will ONLY be used if the `Destination Namespace` setting for the connection is set to `Destination-defined` or `Source-defined`
     */
    public DestinationS3DataLakeGlueCatalog withDatabaseName(String databaseName) {
        Utils.checkNotNull(databaseName, "databaseName");
        this.databaseName = databaseName;
        return this;
    }
     ...
     * The AWS Account ID associated with the Glue service used by the Iceberg catalog.
     */
    public DestinationS3DataLakeGlueCatalog withGlueId(String glueId) {
        Utils.checkNotNull(glueId, "glueId");
        this.glueId = glueId;
        return this;
    }
     ...
     * The ARN of the AWS role to assume. Only usable in Airbyte Cloud.
     */
    public DestinationS3DataLakeGlueCatalog withRoleArn(String roleArn) {
        Utils.checkNotNull(roleArn, "roleArn");
     ...
     * The ARN of the AWS role to assume. Only usable in Airbyte Cloud.
     */
    public DestinationS3DataLakeGlueCatalog withRoleArn(Optional<String> roleArn) {
        Utils.checkNotNull(roleArn, "roleArn");
        this.roleArn = roleArn;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationS3DataLakeGlueCatalog other = (DestinationS3DataLakeGlueCatalog) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationS3DataLakeGlueCatalog.class,
    ...
    public final static class Builder {
        ...
        public DestinationS3DataLakeGlueCatalog build() {
            if (catalogType == null) {
                catalogType = _SINGLETON_VALUE_CatalogType.value();
            }            return new DestinationS3DataLakeGlueCatalog(
                catalogType,
                databaseName,
                glueId,
                roleArn)
