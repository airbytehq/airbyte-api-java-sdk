...
public class SourceMysqlSSHKeyAuthentication {
    ...
    private SourceMysqlSchemasTunnelMethod tunnelMethod;
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public SourceMysqlSSHKeyAuthentication withTunnelPort(Optional<? extends Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<SourceMysqlSchemasTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_KEY_AUTH\"",
                        new TypeReference<SourceMysqlSchemasTunnelMethod>() {});
