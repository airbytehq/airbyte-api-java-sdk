...
public class DestinationS3OutputFormat {
     ...
     * <ul>
     * <li>{@code DestinationS3CSVCommaSeparatedValues}</li>
     * <li>{@code DestinationS3JSONLinesNewlineDelimitedJSON}</li>
     * <li>{@code DestinationS3AvroApacheAvro}</li>
     * <li>{@code DestinationS3ParquetColumnarStorage}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<DestinationS3OutputFormat> {

        public _Deserializer() {
            super(DestinationS3OutputFormat.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationS3CSVCommaSeparatedValues>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationS3JSONLinesNewlineDelimitedJSON>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationS3AvroApacheAvro>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationS3ParquetColumnarStorage>() {}, Utils.JsonShape.DEFAULT));
        }
    }
