    ...
    public static final class _Deserializer extends OneOfDeserializer<FromValue> {
        ...
        public _Deserializer() {
            super(FromValue.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceGoogleAnalyticsDataApiDoubleValue>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SourceGoogleAnalyticsDataApiInt64Value>() {}, JsonShape.DEFAULT));
        }
    }
