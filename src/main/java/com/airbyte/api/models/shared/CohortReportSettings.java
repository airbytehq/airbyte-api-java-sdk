...
public class CohortReportSettings {
    ...
    private Optional<Boolean> accumulate;

    @JsonCreator
    public CohortReportSettings(
            @JsonProperty("accumulate") Optional<Boolean> accumulate) {
     ...
     * If true, accumulates the result from first touch day to the end day
     */
    public CohortReportSettings withAccumulate(Optional<Boolean> accumulate) {
        Utils.checkNotNull(accumulate, "accumulate");
        this.accumulate = accumulate;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * If true, accumulates the result from first touch day to the end day
         */
        public Builder accumulate(Optional<Boolean> accumulate) {
            Utils.checkNotNull(accumulate, "accumulate");
            this.accumulate = accumulate;
            return this;
        }
