...
public class DestinationS3CSVCommaSeparatedValues {
    ...
    public DestinationS3CSVCommaSeparatedValues withFlattening(Flattening flattening) {
        Utils.checkNotNull(flattening, "flattening");
        this.flattening = Optional.ofNullable(flattening);
        return this;
    }

    public DestinationS3CSVCommaSeparatedValues withFlattening(Optional<? extends Flattening> flattening) {
        Utils.checkNotNull(flattening, "flattening");
        this.flattening = flattening;
        return this;
    }
