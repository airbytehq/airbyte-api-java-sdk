...
public enum InvalidCDCPositionBehaviorAdvanced {
    ...
    InvalidCDCPositionBehaviorAdvanced(String value) {
        this.value = value;
    }
    ...
    public static Optional<InvalidCDCPositionBehaviorAdvanced> fromValue(String value) {
        for (InvalidCDCPositionBehaviorAdvanced o: InvalidCDCPositionBehaviorAdvanced.values()) {
