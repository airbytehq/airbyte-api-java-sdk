...
public class SourceWufoo {
    /**
     * Your Wufoo API Key. You can find it by logging into your Wufoo account, selecting 'API Information'
     * from the 'More' dropdown on any form, and locating the 16-digit code.
     */
