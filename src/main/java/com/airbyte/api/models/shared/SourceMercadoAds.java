...
public class SourceMercadoAds {
    ...
    /**
     * Cannot exceed 90 days from current day for Product Ads, and 90 days from "End Date" on Brand and
     * Display Ads
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            endDate, lookbackDays, sourceType,
            startDate);
    }
    ...
    public final static class Builder {
        ...
        public SourceMercadoAds build() {
            ...
            return new SourceMercadoAds(
                clientId, clientRefreshToken, clientSecret,
                endDate, lookbackDays, startDate);
        }
