...
public class DestinationQdrantProcessingConfigModel {
    ...
    public DestinationQdrantProcessingConfigModel(
            ...
            @JsonProperty("field_name_mappings") Optional<? extends List<DestinationQdrantFieldNameMappingConfigModel>> fieldNameMappings,
    ...
    @JsonIgnore
    public Optional<List<DestinationQdrantFieldNameMappingConfigModel>> fieldNameMappings() {
        return (Optional<List<DestinationQdrantFieldNameMappingConfigModel>>) fieldNameMappings;
    }
     ...
     * Size of overlap between chunks in tokens to store in vector store to better capture relevant context
     */
    public DestinationQdrantProcessingConfigModel withChunkOverlap(Optional<Long> chunkOverlap) {
        Utils.checkNotNull(chunkOverlap, "chunkOverlap");
        this.chunkOverlap = chunkOverlap;
        return this;
    }
