...
public class DestinationQdrantProcessingConfigModel {
     ...
     * List of fields to rename. Not applicable for nested fields, but can be used to rename fields already flattened via dot notation.
     */
    public Optional<? extends java.util.List<DestinationQdrantFieldNameMappingConfigModel>> fieldNameMappings() {
     ...
     * Split text fields into chunks based on the specified method.
     */
    public Optional<? extends DestinationQdrantTextSplitter> textSplitter() {
        return textSplitter;
    }
