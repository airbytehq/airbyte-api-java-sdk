...
public class SourcePabblySubscriptionsBilling {
    ...
    @JsonCreator
    public SourcePabblySubscriptionsBilling(
    ...
    @JsonIgnore
    public PabblySubscriptionsBilling sourceType() {
        return sourceType;
    }
    ...
    public SourcePabblySubscriptionsBilling withUsername(String username) {
        Utils.checkNotNull(username, "username");
        this.username = username;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(SourcePabblySubscriptionsBilling.class,
                "password", password,
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<PabblySubscriptionsBilling> _SINGLETON_VALUE_SourceType =
                new LazySingletonValue<>(
                        ...
                        new TypeReference<PabblySubscriptionsBilling>() {});
    }
}
