    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationFireboltLoadingMethod> {
        ...
        public _Deserializer() {
            super(DestinationFireboltLoadingMethod.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.ExternalTableViaS3>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.SQLInserts>() {}, JsonShape.DEFAULT));
        }
    }
