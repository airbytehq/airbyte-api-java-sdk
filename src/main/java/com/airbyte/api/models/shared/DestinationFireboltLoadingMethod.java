...
public class DestinationFireboltLoadingMethod {
     ...
     * <ul>
     * <li>{@code SQLInserts}</li>
     * <li>{@code ExternalTableViaS3}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<DestinationFireboltLoadingMethod> {

        public _Deserializer() {
            super(DestinationFireboltLoadingMethod.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<SQLInserts>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<ExternalTableViaS3>() {}, Utils.JsonShape.DEFAULT));
        }
    }
