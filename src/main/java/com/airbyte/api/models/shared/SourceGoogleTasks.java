...
public class SourceGoogleTasks {
    ...
    public SourceGoogleTasks(
            ...
            @JsonProperty("records_limit") Optional<String> recordsLimit,
     ...
     * The maximum number of records to be returned per request
     */
    public SourceGoogleTasks withRecordsLimit(Optional<String> recordsLimit) {
        Utils.checkNotNull(recordsLimit, "recordsLimit");
        this.recordsLimit = recordsLimit;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * The maximum number of records to be returned per request
         */
        public Builder recordsLimit(Optional<String> recordsLimit) {
            Utils.checkNotNull(recordsLimit, "recordsLimit");
            this.recordsLimit = recordsLimit;
            return this;
        }
