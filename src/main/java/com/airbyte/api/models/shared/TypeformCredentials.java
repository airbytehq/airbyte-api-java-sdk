...
public class TypeformCredentials {
     ...
     * The Client ID of the Typeform developer application.
     */
    public TypeformCredentials withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The Client Secret the Typeform developer application.
     */
    public TypeformCredentials withClientSecret(Optional<? extends String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
