...
public class DestinationPineconeTextSplitter {
     ...
     * <ul>
     * <li>{@code DestinationPineconeBySeparator}</li>
     * <li>{@code DestinationPineconeByMarkdownHeader}</li>
     * <li>{@code DestinationPineconeByProgrammingLanguage}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<DestinationPineconeTextSplitter> {

        public _Deserializer() {
            super(DestinationPineconeTextSplitter.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationPineconeBySeparator>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationPineconeByMarkdownHeader>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationPineconeByProgrammingLanguage>() {}, Utils.JsonShape.DEFAULT));
        }
    }
