...
public class SourceRecurly {
    /**
     * Days in length for each API call to get data from the accounts stream. Smaller values will result in
     * more API calls but better concurrency.
     */
    ...
    /**
     * Recurly API Key. See the  <a href="https://docs.airbyte.com/integrations/sources/recurly">docs</a>
    ...
    /**
     * ISO8601 timestamp to which the replication from Recurly API will stop. Records after that date won't
     * be imported.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * Set to true for sandbox accounts (400 requests/min, all types). Defaults to false for production
     * accounts (1,000 GET requests/min).
     */
    @JsonInclude(Include.NON_ABSENT)
