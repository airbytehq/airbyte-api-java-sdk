...
public class SourceRecurly {
    ...
    private Optional<? extends String> beginTime;
    ...
    private Optional<? extends String> endTime;
    ...
    public SourceRecurly(
            ...
            @JsonProperty("end_time") Optional<? extends String> endTime) {
     ...
     * ISO8601 timestamp from which the replication from Recurly API will start from.
     */
    public SourceRecurly withBeginTime(Optional<? extends String> beginTime) {
        Utils.checkNotNull(beginTime, "beginTime");
        this.beginTime = beginTime;
        return this;
    }
     ...
     * ISO8601 timestamp to which the replication from Recurly API will stop. Records after that date won't be imported.
     */
    public SourceRecurly withEndTime(Optional<? extends String> endTime) {
        Utils.checkNotNull(endTime, "endTime");
        this.endTime = endTime;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            java.util.Objects.deepEquals(this.beginTime, other.beginTime) &&
    ...
    public final static class Builder {
        ...
        private Optional<? extends String> beginTime = Optional.empty();
 
        private Optional<? extends String> endTime = Optional.empty();  
         ...
         * ISO8601 timestamp from which the replication from Recurly API will start from.
         */
        public Builder beginTime(Optional<? extends String> beginTime) {
            Utils.checkNotNull(beginTime, "beginTime");
            this.beginTime = beginTime;
            return this;
        }
         ...
         * ISO8601 timestamp to which the replication from Recurly API will stop. Records after that date won't be imported.
         */
        public Builder endTime(Optional<? extends String> endTime) {
            Utils.checkNotNull(endTime, "endTime");
            this.endTime = endTime;
            return this;
        }
