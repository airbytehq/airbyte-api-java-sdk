...
public class SurveymonkeyCredentials {
     ...
     * The Client ID of the SurveyMonkey developer application.
     */
    public SurveymonkeyCredentials withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * The Client Secret of the SurveyMonkey developer application.
     */
    public SurveymonkeyCredentials withClientSecret(Optional<? extends String> clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }
