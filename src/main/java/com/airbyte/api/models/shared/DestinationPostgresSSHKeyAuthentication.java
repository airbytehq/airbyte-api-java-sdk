...
public class DestinationPostgresSSHKeyAuthentication {
    ...
    private DestinationPostgresSchemasTunnelMethod tunnelMethod;
    ...
    public DestinationPostgresSSHKeyAuthentication(
     ...
     * Connect through a jump server tunnel host using username and ssh key
     */
    public DestinationPostgresSchemasTunnelMethod tunnelMethod() {
        return tunnelMethod;
    }
     ...
     * OS-level user account ssh key credentials in RSA PEM format ( created with ssh-keygen -t rsa -m PEM -f myuser_rsa )
     */
    public DestinationPostgresSSHKeyAuthentication withSshKey(String sshKey) {
        Utils.checkNotNull(sshKey, "sshKey");
        this.sshKey = sshKey;
        return this;
    }
     ...
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    public DestinationPostgresSSHKeyAuthentication withTunnelHost(String tunnelHost) {
        Utils.checkNotNull(tunnelHost, "tunnelHost");
        this.tunnelHost = tunnelHost;
        return this;
    }
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationPostgresSSHKeyAuthentication withTunnelPort(long tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationPostgresSSHKeyAuthentication withTunnelPort(Optional<? extends Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
     ...
     * OS-level username for logging into the jump server host.
     */
    public DestinationPostgresSSHKeyAuthentication withTunnelUser(String tunnelUser) {
        Utils.checkNotNull(tunnelUser, "tunnelUser");
        this.tunnelUser = tunnelUser;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationPostgresSSHKeyAuthentication other = (DestinationPostgresSSHKeyAuthentication) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationPostgresSSHKeyAuthentication.class,
                "sshKey", sshKey,
    ...
    public final static class Builder {
        ...
        public DestinationPostgresSSHKeyAuthentication build() {
            if (tunnelPort == null) {
        ...
        private static final LazySingletonValue<DestinationPostgresSchemasTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_KEY_AUTH\"",
                        new TypeReference<DestinationPostgresSchemasTunnelMethod>() {});
