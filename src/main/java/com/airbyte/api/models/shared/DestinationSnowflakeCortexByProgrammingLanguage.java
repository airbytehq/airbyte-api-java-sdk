...
public class DestinationSnowflakeCortexByProgrammingLanguage {
    ...
    @JsonProperty("mode")
    private Optional<? extends DestinationSnowflakeCortexSchemasProcessingTextSplitterTextSplitterMode> mode;

    @JsonCreator
    public DestinationSnowflakeCortexByProgrammingLanguage(
            @JsonProperty("language") DestinationSnowflakeCortexLanguage language) {
     ...
     */
    @JsonIgnore
    public DestinationSnowflakeCortexLanguage language() {
        return language;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DestinationSnowflakeCortexSchemasProcessingTextSplitterTextSplitterMode> mode() {
     ...
     * Split code in suitable places based on the programming language
     */
    public DestinationSnowflakeCortexByProgrammingLanguage withLanguage(DestinationSnowflakeCortexLanguage language) {
        Utils.checkNotNull(language, "language");
        this.language = language;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(DestinationSnowflakeCortexByProgrammingLanguage.class,
                "language", language,
                "mode", mode);
    }
    ...
    public final static class Builder {
         ...
         * Split code in suitable places based on the programming language
         */
        public Builder language(DestinationSnowflakeCortexLanguage language) {
            Utils.checkNotNull(language, "language");
            this.language = language;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<? extends DestinationSnowflakeCortexSchemasProcessingTextSplitterTextSplitterMode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"code\"",
                        new TypeReference<Optional<? extends DestinationSnowflakeCortexSchemasProcessingTextSplitterTextSplitterMode>>() {});
    }
}
