...
public class ByMarkdownHeader {

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("mode")
    private Optional<? extends DestinationAstraSchemasProcessingTextSplitterMode> mode;
     ...
     * Level of markdown headers to split text fields by. Headings down to the specified level will be used as split points
     */
    public ByMarkdownHeader withSplitLevel(long splitLevel) {
        Utils.checkNotNull(splitLevel, "splitLevel");
     ...
     * Level of markdown headers to split text fields by. Headings down to the specified level will be used as split points
     */
    public ByMarkdownHeader withSplitLevel(Optional<? extends Long> splitLevel) {
        Utils.checkNotNull(splitLevel, "splitLevel");
        this.splitLevel = splitLevel;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ByMarkdownHeader other = (ByMarkdownHeader) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ByMarkdownHeader.class,
                "mode", mode,
    ...
    public final static class Builder {
        ...
        public ByMarkdownHeader build() {
            if (splitLevel == null) {
                splitLevel = _SINGLETON_VALUE_SplitLevel.value();
            }
            return new ByMarkdownHeader(
                splitLevel);
        }

        private static final LazySingletonValue<Optional<? extends DestinationAstraSchemasProcessingTextSplitterMode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"markdown\"",
                        new TypeReference<Optional<? extends DestinationAstraSchemasProcessingTextSplitterMode>>() {});
