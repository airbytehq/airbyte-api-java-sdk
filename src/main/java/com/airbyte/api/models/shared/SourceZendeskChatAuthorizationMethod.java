...
public class SourceZendeskChatAuthorizationMethod {
     ...
     * <ul>
     * <li>{@code SourceZendeskChatOAuth20}</li>
     * <li>{@code SourceZendeskChatAccessToken}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<SourceZendeskChatAuthorizationMethod> {

        public _Deserializer() {
            super(SourceZendeskChatAuthorizationMethod.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceZendeskChatOAuth20>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<SourceZendeskChatAccessToken>() {}, Utils.JsonShape.DEFAULT));
        }
    }
