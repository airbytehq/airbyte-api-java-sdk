 ...
 */
public enum DestinationHubspotS3BucketRegion {
    UNKNOWN(""),
    ...
    DestinationHubspotS3BucketRegion(String value) {
        this.value = value;
    }
    ...
    public static Optional<DestinationHubspotS3BucketRegion> fromValue(String value) {
        for (DestinationHubspotS3BucketRegion o: DestinationHubspotS3BucketRegion.values()) {
