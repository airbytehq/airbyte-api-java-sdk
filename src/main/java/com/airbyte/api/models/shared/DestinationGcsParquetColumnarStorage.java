...
public class DestinationGcsParquetColumnarStorage {
     ...
     * The compression algorithm used to compress data pages.
     */
    public Optional<? extends DestinationGcsCompressionCodec> compressionCodec() {
    ...
    public Optional<? extends DestinationGcsSchemasFormatOutputFormatFormatType> formatType() {
        return formatType;
    }
