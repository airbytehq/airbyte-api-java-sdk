...
public class SourcePerigon {
    /**
     * Your API key for authenticating with the Perigon API. Obtain it by creating an account at
     * https://www.perigon.io/sign-up and verifying your email. The API key will be visible on your account
     * dashboard.
     */
