    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationSnowflakeCortexEmbedding> {
        ...
        public _Deserializer() {
            super(DestinationSnowflakeCortexEmbedding.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationSnowflakeCortexOpenAICompatible>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationSnowflakeCortexAzureOpenAI>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationSnowflakeCortexCohere>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationSnowflakeCortexOpenAI>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationSnowflakeCortexFake>() {}, JsonShape.DEFAULT));
        }
    }
