...
public class SourceBambooHr {
    ...
    /**
     * If true, the custom reports endpoint will include the default fields defined here:
    ...
    public SourceBambooHr(
            ...
            @JsonProperty("employee_fields") Optional<String> employeeFields,
        ...
        Utils.checkNotNull(employeeFields, "employeeFields");
     ...
     */
    @JsonIgnore
    public Optional<String> employeeFields() {
     ...
     * Comma-separated list of fields to include for employees.
     */
    public SourceBambooHr withEmployeeFields(String employeeFields) {
        Utils.checkNotNull(employeeFields, "employeeFields");
        this.employeeFields = Optional.ofNullable(employeeFields);
        return this;
    }
     ...
     * Comma-separated list of fields to include for employees.
     */
    public SourceBambooHr withEmployeeFields(Optional<String> employeeFields) {
        Utils.checkNotNull(employeeFields, "employeeFields");
        this.employeeFields = employeeFields;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Comma-separated list of fields to include for employees.
         */
        public Builder employeeFields(String employeeFields) {
            Utils.checkNotNull(employeeFields, "employeeFields");
            this.employeeFields = Optional.ofNullable(employeeFields);
            return this;
        }
         ...
         * Comma-separated list of fields to include for employees.
         */
        public Builder employeeFields(Optional<String> employeeFields) {
            Utils.checkNotNull(employeeFields, "employeeFields");
            this.employeeFields = employeeFields;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_EmployeeFields =
                new LazySingletonValue<>(
                        "employee_fields",
                        "\"firstName,lastName\"",
