    ...
    public static final class _Deserializer extends OneOfDeserializer<MongoDbInstanceType> {
        ...
        public _Deserializer() {
            super(MongoDbInstanceType.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.ReplicaSet>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.StandaloneMongoDbInstance>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.MongoDBAtlas>() {}, JsonShape.DEFAULT));
        }
    }
