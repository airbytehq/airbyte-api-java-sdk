...
public class SourceGoogleDriveCSVFormat {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<SourceGoogleDriveSchemasFiletype> filetype() {
        return (Optional<SourceGoogleDriveSchemasFiletype>) filetype;
    }
     ...
     * For tab-delimited data enter '\t'.
     */
    public SourceGoogleDriveCSVFormat withDelimiter(Optional<String> delimiter) {
        Utils.checkNotNull(delimiter, "delimiter");
        this.delimiter = delimiter;
        return this;
    }
     ...
     * Whether two quotes in a quoted CSV value denote a single quote in the data.
     */
    public SourceGoogleDriveCSVFormat withDoubleQuote(Optional<Boolean> doubleQuote) {
        Utils.checkNotNull(doubleQuote, "doubleQuote");
        this.doubleQuote = doubleQuote;
        return this;
    }
     ...
     * for allowable options.
     */
    public SourceGoogleDriveCSVFormat withEncoding(Optional<String> encoding) {
        Utils.checkNotNull(encoding, "encoding");
        this.encoding = encoding;
        return this;
    }
     ...
     * The character used for escaping special characters. To disallow escaping, leave this field blank.
     */
    public SourceGoogleDriveCSVFormat withEscapeChar(Optional<String> escapeChar) {
        Utils.checkNotNull(escapeChar, "escapeChar");
        this.escapeChar = escapeChar;
        return this;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as false values.
     */
    public SourceGoogleDriveCSVFormat withFalseValues(List<String> falseValues) {
        Utils.checkNotNull(falseValues, "falseValues");
     ...
     * A set of case-sensitive strings that should be interpreted as false values.
     */
    public SourceGoogleDriveCSVFormat withFalseValues(Optional<? extends List<String>> falseValues) {
        Utils.checkNotNull(falseValues, "falseValues");
        this.falseValues = falseValues;
        return this;
    }
     ...
     * of columns in the schema.
     */
    public SourceGoogleDriveCSVFormat withIgnoreErrorsOnFieldsMismatch(Optional<Boolean> ignoreErrorsOnFieldsMismatch) {
        Utils.checkNotNull(ignoreErrorsOnFieldsMismatch, "ignoreErrorsOnFieldsMismatch");
        this.ignoreErrorsOnFieldsMismatch = ignoreErrorsOnFieldsMismatch;
        return this;
    }
     ...
     * 'NA' should be interpreted as null, enter 'NA' in this field.
     */
    public SourceGoogleDriveCSVFormat withNullValues(List<String> nullValues) {
        Utils.checkNotNull(nullValues, "nullValues");
     ...
     * 'NA' should be interpreted as null, enter 'NA' in this field.
     */
    public SourceGoogleDriveCSVFormat withNullValues(Optional<? extends List<String>> nullValues) {
        Utils.checkNotNull(nullValues, "nullValues");
        this.nullValues = nullValues;
        return this;
    }
     ...
     * The character used for quoting CSV values. To disallow quoting, make this field blank.
     */
    public SourceGoogleDriveCSVFormat withQuoteChar(Optional<String> quoteChar) {
        Utils.checkNotNull(quoteChar, "quoteChar");
        this.quoteChar = quoteChar;
        return this;
    }
     ...
     * The number of rows to skip after the header row.
     */
    public SourceGoogleDriveCSVFormat withSkipRowsAfterHeader(Optional<Long> skipRowsAfterHeader) {
        Utils.checkNotNull(skipRowsAfterHeader, "skipRowsAfterHeader");
        this.skipRowsAfterHeader = skipRowsAfterHeader;
        return this;
    }
     ...
     * enter 2 in this field.
     */
    public SourceGoogleDriveCSVFormat withSkipRowsBeforeHeader(Optional<Long> skipRowsBeforeHeader) {
        Utils.checkNotNull(skipRowsBeforeHeader, "skipRowsBeforeHeader");
        this.skipRowsBeforeHeader = skipRowsBeforeHeader;
        return this;
    }
     ...
     * the string itself.
     */
    public SourceGoogleDriveCSVFormat withStringsCanBeNull(Optional<Boolean> stringsCanBeNull) {
        Utils.checkNotNull(stringsCanBeNull, "stringsCanBeNull");
        this.stringsCanBeNull = stringsCanBeNull;
        return this;
    }
     ...
     * A set of case-sensitive strings that should be interpreted as true values.
     */
    public SourceGoogleDriveCSVFormat withTrueValues(List<String> trueValues) {
        Utils.checkNotNull(trueValues, "trueValues");
     ...
     * A set of case-sensitive strings that should be interpreted as true values.
     */
    public SourceGoogleDriveCSVFormat withTrueValues(Optional<? extends List<String>> trueValues) {
        Utils.checkNotNull(trueValues, "trueValues");
        this.trueValues = trueValues;
        return this;
    }
