...
public class DestinationRedisSSHKeyAuthentication {
    ...
    private DestinationRedisSchemasTunnelMethod tunnelMethod;
    ...
    public DestinationRedisSSHKeyAuthentication(
     ...
     * Connect through a jump server tunnel host using username and ssh key
     */
    public DestinationRedisSchemasTunnelMethod tunnelMethod() {
        return tunnelMethod;
    }
     ...
     * OS-level user account ssh key credentials in RSA PEM format ( created with ssh-keygen -t rsa -m PEM -f myuser_rsa )
     */
    public DestinationRedisSSHKeyAuthentication withSshKey(String sshKey) {
        Utils.checkNotNull(sshKey, "sshKey");
        this.sshKey = sshKey;
        return this;
    }
     ...
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    public DestinationRedisSSHKeyAuthentication withTunnelHost(String tunnelHost) {
        Utils.checkNotNull(tunnelHost, "tunnelHost");
        this.tunnelHost = tunnelHost;
        return this;
    }
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationRedisSSHKeyAuthentication withTunnelPort(long tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public DestinationRedisSSHKeyAuthentication withTunnelPort(Optional<? extends Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
     ...
     * OS-level username for logging into the jump server host.
     */
    public DestinationRedisSSHKeyAuthentication withTunnelUser(String tunnelUser) {
        Utils.checkNotNull(tunnelUser, "tunnelUser");
        this.tunnelUser = tunnelUser;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestinationRedisSSHKeyAuthentication other = (DestinationRedisSSHKeyAuthentication) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestinationRedisSSHKeyAuthentication.class,
                "sshKey", sshKey,
    ...
    public final static class Builder {
        ...
        public DestinationRedisSSHKeyAuthentication build() {
            if (tunnelPort == null) {
        ...
        private static final LazySingletonValue<DestinationRedisSchemasTunnelMethod> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_KEY_AUTH\"",
                        new TypeReference<DestinationRedisSchemasTunnelMethod>() {});
