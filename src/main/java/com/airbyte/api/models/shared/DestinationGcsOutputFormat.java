...
public class DestinationGcsOutputFormat {
     ...
     * <ul>
     * <li>{@code AvroApacheAvro}</li>
     * <li>{@code DestinationGcsCSVCommaSeparatedValues}</li>
     * <li>{@code DestinationGcsJSONLinesNewlineDelimitedJSON}</li>
     * <li>{@code DestinationGcsParquetColumnarStorage}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<DestinationGcsOutputFormat> {

        public _Deserializer() {
            super(DestinationGcsOutputFormat.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<AvroApacheAvro>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationGcsCSVCommaSeparatedValues>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationGcsJSONLinesNewlineDelimitedJSON>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DestinationGcsParquetColumnarStorage>() {}, Utils.JsonShape.DEFAULT));
        }
    }
