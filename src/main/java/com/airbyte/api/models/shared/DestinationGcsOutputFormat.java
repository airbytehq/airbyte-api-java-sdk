    ...
    public static final class _Deserializer extends OneOfDeserializer<DestinationGcsOutputFormat> {
        ...
        public _Deserializer() {
            super(DestinationGcsOutputFormat.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationGcsParquetColumnarStorage>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationGcsCSVCommaSeparatedValues>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DestinationGcsJSONLinesNewlineDelimitedJSON>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.AvroApacheAvro>() {}, JsonShape.DEFAULT));
        }
    }
