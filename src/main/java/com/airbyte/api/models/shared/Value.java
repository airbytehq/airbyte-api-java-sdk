...
public class Value {
    ...
    public static final class _Deserializer extends com.airbyte.api.utils.OneOfDeserializer<Value> {

        public _Deserializer() {
            super(Value.class,
                  Utils.TypeReferenceWithShape.of(new TypeReference<Int64Value>() {}, Utils.JsonShape.DEFAULT),
                  Utils.TypeReferenceWithShape.of(new TypeReference<DoubleValue>() {}, Utils.JsonShape.DEFAULT));
        }
    }
