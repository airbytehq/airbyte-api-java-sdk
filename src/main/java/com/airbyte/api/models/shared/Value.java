    ...
    public static final class _Deserializer extends OneOfDeserializer<Value> {
        ...
        public _Deserializer() {
            super(Value.class, false,
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.DoubleValue>() {}, JsonShape.DEFAULT),
                  TypeReferenceWithShape.of(new TypeReference<com.airbyte.api.models.shared.Int64Value>() {}, JsonShape.DEFAULT));
        }
    }
