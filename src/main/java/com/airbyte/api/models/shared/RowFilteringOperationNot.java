...
public class RowFilteringOperationNot implements RowFilteringOperation {
    /**
    ...
    @JsonCreator
    public RowFilteringOperationNot(
     ...
     * Conditions to evaluate with the NOT operator.
     */
    public RowFilteringOperationNot withConditions(List<RowFilteringOperation> conditions) {
        Utils.checkNotNull(conditions, "conditions");
        this.conditions = conditions;
        return this;
    }

    public RowFilteringOperationNot withType(RowFilteringOperationType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RowFilteringOperationNot other = (RowFilteringOperationNot) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RowFilteringOperationNot.class,
    ...
    public final static class Builder {
        ...
        public RowFilteringOperationNot build() {

            return new RowFilteringOperationNot(
                conditions, type);
        }
