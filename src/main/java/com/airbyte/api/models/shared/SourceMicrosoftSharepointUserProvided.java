...
public class SourceMicrosoftSharepointUserProvided {
     ...
     * The column names that will be used while emitting the CSV records
     */
    public SourceMicrosoftSharepointUserProvided withColumnNames(java.util.List<String> columnNames) {
        Utils.checkNotNull(columnNames, "columnNames");
        this.columnNames = columnNames;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceMicrosoftSharepointUserProvided other = (SourceMicrosoftSharepointUserProvided) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceMicrosoftSharepointUserProvided.class,
    ...
    public final static class Builder {
        ...
        public SourceMicrosoftSharepointUserProvided build() {
            if (headerDefinitionType == null) {
                headerDefinitionType = _SINGLETON_VALUE_HeaderDefinitionType.value();
            }
            return new SourceMicrosoftSharepointUserProvided(
                columnNames);
        }

        private static final LazySingletonValue<Optional<? extends SourceMicrosoftSharepointSchemasStreamsHeaderDefinitionType>> _SINGLETON_VALUE_HeaderDefinitionType =
                new LazySingletonValue<>(
                        "header_definition_type",
                        "\"User Provided\"",
                        new TypeReference<Optional<? extends SourceMicrosoftSharepointSchemasStreamsHeaderDefinitionType>>() {});
    }
}
