...
public class SourceGoogleAnalyticsDataApiSchemasCustomReportsArrayDimensionFilterStringFilter {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<SourceGoogleAnalyticsDataApiSchemasCustomReportsArrayDimensionFilterDimensionsFilter2ValidEnums>> matchType() {
        return (Optional<java.util.List<SourceGoogleAnalyticsDataApiSchemasCustomReportsArrayDimensionFilterDimensionsFilter2ValidEnums>>) matchType;
    }
