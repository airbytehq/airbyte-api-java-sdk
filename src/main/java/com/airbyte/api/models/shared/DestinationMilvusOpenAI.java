...
public class DestinationMilvusOpenAI {
    ...
    @JsonCreator
    public DestinationMilvusOpenAI(
    ...
    @JsonIgnore
    public Optional<DestinationMilvusMode> mode() {
        return (Optional<DestinationMilvusMode>) mode;
    }
    ...
    public String toString() {
        return Utils.toString(DestinationMilvusOpenAI.class,
                "mode", mode,
                "openaiKey", openaiKey);
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends DestinationMilvusMode>> _SINGLETON_VALUE_Mode =
                new LazySingletonValue<>(
                        "mode",
                        "\"openai\"",
                        new TypeReference<Optional<? extends DestinationMilvusMode>>() {});
    }
}
