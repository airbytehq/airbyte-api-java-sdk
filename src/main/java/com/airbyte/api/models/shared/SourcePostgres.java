...
public class SourcePostgres {
    ...
    public SourcePostgres(
            ...
            @JsonProperty("ssl_mode") Optional<? extends SourcePostgresSSLModes> sslMode,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<SourcePostgresSSLModes> sslMode() {
        return (Optional<SourcePostgresSSLModes>) sslMode;
    }
     ...
     * Password associated with the username.
     */
    public SourcePostgres withPassword(Optional<String> password) {
        Utils.checkNotNull(password, "password");
        this.password = password;
        return this;
    }
     ...
     * Port of the database.
     */
    public SourcePostgres withPort(Optional<Long> port) {
        Utils.checkNotNull(port, "port");
        this.port = port;
        return this;
    }
     ...
     * The list of schemas (case sensitive) to sync from. Defaults to public.
     */
    public SourcePostgres withSchemas(List<String> schemas) {
        Utils.checkNotNull(schemas, "schemas");
     ...
     * The list of schemas (case sensitive) to sync from. Defaults to public.
     */
    public SourcePostgres withSchemas(Optional<? extends List<String>> schemas) {
        Utils.checkNotNull(schemas, "schemas");
        this.schemas = schemas;
        return this;
    }
