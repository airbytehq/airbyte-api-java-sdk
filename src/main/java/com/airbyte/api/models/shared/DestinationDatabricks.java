...
public class DestinationDatabricks {
    ...
    private Optional<String> databricksPort;
    ...
    private Optional<Boolean> enableSchemaEvolution;
    ...
    public DestinationDatabricks(
            ...
            @JsonProperty("databricks_port") Optional<String> databricksPort,
            @JsonProperty("databricks_server_hostname") String databricksServerHostname,
            @JsonProperty("enable_schema_evolution") Optional<Boolean> enableSchemaEvolution,
     ...
     * The name of the catalog. If not specified otherwise, the "hive_metastore" will be used.
     */
    public DestinationDatabricks withDatabase(Optional<String> database) {
        Utils.checkNotNull(database, "database");
        this.database = database;
        return this;
    }
     ...
     * Databricks Cluster Port.
     */
    public DestinationDatabricks withDatabricksPort(Optional<String> databricksPort) {
        Utils.checkNotNull(databricksPort, "databricksPort");
        this.databricksPort = databricksPort;
        return this;
    }
     ...
     * Support schema evolution for all streams. If "false", the connector might fail when a stream's schema changes.
     */
    public DestinationDatabricks withEnableSchemaEvolution(Optional<Boolean> enableSchemaEvolution) {
        Utils.checkNotNull(enableSchemaEvolution, "enableSchemaEvolution");
        this.enableSchemaEvolution = enableSchemaEvolution;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Objects.deepEquals(this.databricksHttpPath, other.databricksHttpPath) &&
            Objects.deepEquals(this.databricksPersonalAccessToken, other.databricksPersonalAccessToken) &&
            Objects.deepEquals(this.databricksPort, other.databricksPort) &&
            Objects.deepEquals(this.databricksServerHostname, other.databricksServerHostname) &&
            Objects.deepEquals(this.destinationType, other.destinationType) &&
            Objects.deepEquals(this.enableSchemaEvolution, other.enableSchemaEvolution) &&
    ...
    public final static class Builder {
         ...
         * Databricks Cluster Port.
         */
        public Builder databricksPort(Optional<String> databricksPort) {
            Utils.checkNotNull(databricksPort, "databricksPort");
            this.databricksPort = databricksPort;
            return this;
        }
         ...
         * Support schema evolution for all streams. If "false", the connector might fail when a stream's schema changes.
         */
        public Builder enableSchemaEvolution(Optional<Boolean> enableSchemaEvolution) {
            Utils.checkNotNull(enableSchemaEvolution, "enableSchemaEvolution");
            this.enableSchemaEvolution = enableSchemaEvolution;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<String>> _SINGLETON_VALUE_DatabricksPort =
                new LazySingletonValue<>(
                        "databricks_port",
                        "\"443\"",
        ...
        private static final LazySingletonValue<Optional<Boolean>> _SINGLETON_VALUE_EnableSchemaEvolution =
                new LazySingletonValue<>(
