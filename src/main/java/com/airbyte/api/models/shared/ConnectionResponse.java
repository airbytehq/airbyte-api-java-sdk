...
public class ConnectionResponse {
    ...
    public ConnectionResponse(
            ...
            List<Tag> tags,
            String workspaceId) {
        this(configurations, connectionId, createdAt, Optional.empty(), destinationId, name, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), schedule, sourceId, status, tags, workspaceId);
    }
