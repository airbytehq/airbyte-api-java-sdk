...
public class SourceUppromote {
    /**
     * For developing your own custom integration with UpPromote, you can create an API key. This is
     * available from Professional plan. Simply go to Settings &gt; Integration &gt; API &gt; Create API
     * Key.
     */
