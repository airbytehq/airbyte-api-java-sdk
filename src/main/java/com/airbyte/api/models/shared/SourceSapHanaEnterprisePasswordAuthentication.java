 ...
 */
public class SourceSapHanaEnterprisePasswordAuthentication {
    ...
    @JsonCreator
    public SourceSapHanaEnterprisePasswordAuthentication(
            @JsonProperty("tunnel_host") String tunnelHost,
            @JsonProperty("tunnel_method") Optional<? extends SourceSapHanaEnterpriseSchemasTunnelMethodTunnelMethod> tunnelMethod,
    ...
    @JsonIgnore
    public Optional<SourceSapHanaEnterpriseSchemasTunnelMethodTunnelMethod> tunnelMethod() {
        return (Optional<SourceSapHanaEnterpriseSchemasTunnelMethodTunnelMethod>) tunnelMethod;
    }
     ...
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    public SourceSapHanaEnterprisePasswordAuthentication withTunnelHost(String tunnelHost) {
        Utils.checkNotNull(tunnelHost, "tunnelHost");
        this.tunnelHost = tunnelHost;
        return this;
    }

    public SourceSapHanaEnterprisePasswordAuthentication withTunnelMethod(SourceSapHanaEnterpriseSchemasTunnelMethodTunnelMethod tunnelMethod) {
        Utils.checkNotNull(tunnelMethod, "tunnelMethod");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public SourceSapHanaEnterprisePasswordAuthentication withTunnelPort(long tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
     ...
     * Port on the proxy/jump server that accepts inbound ssh connections.
     */
    public SourceSapHanaEnterprisePasswordAuthentication withTunnelPort(Optional<Long> tunnelPort) {
        Utils.checkNotNull(tunnelPort, "tunnelPort");
        this.tunnelPort = tunnelPort;
        return this;
    }
     ...
     * OS-level username for logging into the jump server host
     */
    public SourceSapHanaEnterprisePasswordAuthentication withTunnelUser(String tunnelUser) {
        Utils.checkNotNull(tunnelUser, "tunnelUser");
        this.tunnelUser = tunnelUser;
        return this;
    }
     ...
     * OS-level password for logging into the jump server host
     */
    public SourceSapHanaEnterprisePasswordAuthentication withTunnelUserPassword(String tunnelUserPassword) {
        Utils.checkNotNull(tunnelUserPassword, "tunnelUserPassword");
        this.tunnelUserPassword = tunnelUserPassword;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(SourceSapHanaEnterprisePasswordAuthentication.class,
    ...
    public final static class Builder {
        ...
        public Builder tunnelMethod(Optional<? extends SourceSapHanaEnterpriseSchemasTunnelMethodTunnelMethod> tunnelMethod) {
            Utils.checkNotNull(tunnelMethod, "tunnelMethod");
            this.tunnelMethod = tunnelMethod;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<? extends SourceSapHanaEnterpriseSchemasTunnelMethodTunnelMethod>> _SINGLETON_VALUE_TunnelMethod =
                new LazySingletonValue<>(
                        "tunnel_method",
                        "\"SSH_PASSWORD_AUTH\"",
                        new TypeReference<Optional<? extends SourceSapHanaEnterpriseSchemasTunnelMethodTunnelMethod>>() {});
