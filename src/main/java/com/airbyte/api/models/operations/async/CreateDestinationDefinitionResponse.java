...
public class CreateDestinationDefinitionResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public CreateDestinationDefinitionResponse(
            String contentType,
     ...
     * Success
     */
    public CreateDestinationDefinitionResponse withDefinitionResponse(DefinitionResponse definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
     ...
     * Success
     */
    public CreateDestinationDefinitionResponse withDefinitionResponse(Optional<? extends DefinitionResponse> definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
        this.definitionResponse = definitionResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public CreateDestinationDefinitionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateDestinationDefinitionResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateDestinationDefinitionResponse other = (CreateDestinationDefinitionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateDestinationDefinitionResponse.class,
    ...
    public final static class Builder {
        ...
        public CreateDestinationDefinitionResponse build() {

            return new CreateDestinationDefinitionResponse(
                contentType, definitionResponse, statusCode,
                rawResponse);
        }
