...
public class ListDestinationsRequest {
     ...
     * Include deleted destinations in the returned results.
     */
    public ListDestinationsRequest withIncludeDeleted(Optional<? extends Boolean> includeDeleted) {
        Utils.checkNotNull(includeDeleted, "includeDeleted");
        this.includeDeleted = includeDeleted;
        return this;
    }
     ...
     * Set the limit on the number of destinations returned. The default is 20.
     */
    public ListDestinationsRequest withLimit(Optional<? extends Integer> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * Set the offset to start at when returning destinations. The default is 0
     */
    public ListDestinationsRequest withOffset(Optional<? extends Integer> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }
     ...
     * The UUIDs of the workspaces you wish to list destinations for. Empty list will retrieve all allowed workspaces.
     */
    public ListDestinationsRequest withWorkspaceIds(java.util.List<String> workspaceIds) {
        Utils.checkNotNull(workspaceIds, "workspaceIds");
     ...
     * The UUIDs of the workspaces you wish to list destinations for. Empty list will retrieve all allowed workspaces.
     */
    public ListDestinationsRequest withWorkspaceIds(Optional<? extends java.util.List<String>> workspaceIds) {
        Utils.checkNotNull(workspaceIds, "workspaceIds");
        this.workspaceIds = workspaceIds;
        return this;
    }
