...
public class GetSourceDefinitionResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public GetSourceDefinitionResponse(
            String contentType,
     ...
     * Success
     */
    public GetSourceDefinitionResponse withDefinitionResponse(DefinitionResponse definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
     ...
     * Success
     */
    public GetSourceDefinitionResponse withDefinitionResponse(Optional<? extends DefinitionResponse> definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
        this.definitionResponse = definitionResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetSourceDefinitionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSourceDefinitionResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSourceDefinitionResponse other = (GetSourceDefinitionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSourceDefinitionResponse.class,
    ...
    public final static class Builder {
        ...
        public GetSourceDefinitionResponse build() {

            return new GetSourceDefinitionResponse(
                contentType, definitionResponse, statusCode,
                rawResponse);
        }
