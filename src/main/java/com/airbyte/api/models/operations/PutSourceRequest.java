...
public class PutSourceRequest {
    ...
    @JsonIgnore
    public Optional<com.airbyte.api.models.shared.SourcePutRequest> sourcePutRequest() {
        return (Optional<com.airbyte.api.models.shared.SourcePutRequest>) sourcePutRequest;
    }
