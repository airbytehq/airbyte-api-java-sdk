...
public class PutSourceRequest {
    ...
    public PutSourceRequest(
            Optional<? extends SourcePutRequest> sourcePutRequest,
            String sourceId) {
    ...
    @JsonIgnore
    public Optional<SourcePutRequest> sourcePutRequest() {
        return (Optional<SourcePutRequest>) sourcePutRequest;
    }
    ...
    public final static class Builder {
        ...
        public Builder sourcePutRequest(Optional<? extends SourcePutRequest> sourcePutRequest) {
            Utils.checkNotNull(sourcePutRequest, "sourcePutRequest");
            this.sourcePutRequest = sourcePutRequest;
            return this;
        }
