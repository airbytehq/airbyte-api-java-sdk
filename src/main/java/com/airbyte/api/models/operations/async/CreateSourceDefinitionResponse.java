...
public class CreateSourceDefinitionResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public CreateSourceDefinitionResponse(
            String contentType,
     ...
     * Success
     */
    public CreateSourceDefinitionResponse withDefinitionResponse(DefinitionResponse definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
     ...
     * Success
     */
    public CreateSourceDefinitionResponse withDefinitionResponse(Optional<? extends DefinitionResponse> definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
        this.definitionResponse = definitionResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public CreateSourceDefinitionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateSourceDefinitionResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateSourceDefinitionResponse other = (CreateSourceDefinitionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateSourceDefinitionResponse.class,
    ...
    public final static class Builder {
        ...
        public CreateSourceDefinitionResponse build() {

            return new CreateSourceDefinitionResponse(
                contentType, definitionResponse, statusCode,
                rawResponse);
        }
