...
public class UpdateSourceDefinitionResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public UpdateSourceDefinitionResponse(
            String contentType,
     ...
     * Success
     */
    public UpdateSourceDefinitionResponse withDefinitionResponse(DefinitionResponse definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
     ...
     * Success
     */
    public UpdateSourceDefinitionResponse withDefinitionResponse(Optional<? extends DefinitionResponse> definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
        this.definitionResponse = definitionResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public UpdateSourceDefinitionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateSourceDefinitionResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateSourceDefinitionResponse other = (UpdateSourceDefinitionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateSourceDefinitionResponse.class,
    ...
    public final static class Builder {
        ...
        public UpdateSourceDefinitionResponse build() {

            return new UpdateSourceDefinitionResponse(
                contentType, definitionResponse, statusCode,
                rawResponse);
        }
