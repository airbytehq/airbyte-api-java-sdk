...
public class ListConnectionsRequest {
     ...
     * Include deleted connections in the returned results.
     */
    public ListConnectionsRequest withIncludeDeleted(Optional<? extends Boolean> includeDeleted) {
        Utils.checkNotNull(includeDeleted, "includeDeleted");
        this.includeDeleted = includeDeleted;
        return this;
    }
     ...
     * Set the limit on the number of Connections returned. The default is 20.
     */
    public ListConnectionsRequest withLimit(Optional<? extends Integer> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * Set the offset to start at when returning Connections. The default is 0
     */
    public ListConnectionsRequest withOffset(Optional<? extends Integer> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }
     ...
     * The UUIDs of the workspaces you wish to list connections for. Empty list will retrieve all allowed workspaces.
     */
    public ListConnectionsRequest withWorkspaceIds(java.util.List<String> workspaceIds) {
        Utils.checkNotNull(workspaceIds, "workspaceIds");
     ...
     * The UUIDs of the workspaces you wish to list connections for. Empty list will retrieve all allowed workspaces.
     */
    public ListConnectionsRequest withWorkspaceIds(Optional<? extends java.util.List<String>> workspaceIds) {
        Utils.checkNotNull(workspaceIds, "workspaceIds");
        this.workspaceIds = workspaceIds;
        return this;
    }
