...
public class CreateJobRequestBuilder {
    ...
    private com.airbyte.api.models.shared.JobCreateRequest request;
    ...
    public CreateJobRequestBuilder request(com.airbyte.api.models.shared.JobCreateRequest request) {
