...
public class GetDestinationDefinitionResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public GetDestinationDefinitionResponse(
            String contentType,
     ...
     * Success
     */
    public GetDestinationDefinitionResponse withDefinitionResponse(DefinitionResponse definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
     ...
     * Success
     */
    public GetDestinationDefinitionResponse withDefinitionResponse(Optional<? extends DefinitionResponse> definitionResponse) {
        Utils.checkNotNull(definitionResponse, "definitionResponse");
        this.definitionResponse = definitionResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetDestinationDefinitionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetDestinationDefinitionResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetDestinationDefinitionResponse other = (GetDestinationDefinitionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetDestinationDefinitionResponse.class,
    ...
    public final static class Builder {
        ...
        public GetDestinationDefinitionResponse build() {

            return new GetDestinationDefinitionResponse(
                contentType, definitionResponse, statusCode,
                rawResponse);
        }
