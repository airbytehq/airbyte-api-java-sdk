...
public class ListSourcesRequest {
     ...
     * Include deleted sources in the returned results.
     */
    public ListSourcesRequest withIncludeDeleted(Optional<? extends Boolean> includeDeleted) {
        Utils.checkNotNull(includeDeleted, "includeDeleted");
        this.includeDeleted = includeDeleted;
        return this;
    }
     ...
     * Set the limit on the number of sources returned. The default is 20.
     */
    public ListSourcesRequest withLimit(int limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Set the limit on the number of sources returned. The default is 20.
     */
    public ListSourcesRequest withLimit(Optional<? extends Integer> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * Set the offset to start at when returning sources. The default is 0
     */
    public ListSourcesRequest withOffset(int offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * Set the offset to start at when returning sources. The default is 0
     */
    public ListSourcesRequest withOffset(Optional<? extends Integer> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }
     ...
     * The UUIDs of the workspaces you wish to list sources for. Empty list will retrieve all allowed workspaces.
     */
    public ListSourcesRequest withWorkspaceIds(java.util.List<String> workspaceIds) {
        Utils.checkNotNull(workspaceIds, "workspaceIds");
     ...
     * The UUIDs of the workspaces you wish to list sources for. Empty list will retrieve all allowed workspaces.
     */
    public ListSourcesRequest withWorkspaceIds(Optional<? extends java.util.List<String>> workspaceIds) {
        Utils.checkNotNull(workspaceIds, "workspaceIds");
        this.workspaceIds = workspaceIds;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(ListSourcesRequest.class,
