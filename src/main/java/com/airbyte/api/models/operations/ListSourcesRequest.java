...
public class ListSourcesRequest {
    ...
    /**
     * The UUIDs of the workspaces you wish to list sources for. Empty list will retrieve all allowed
     * workspaces.
     */
     ...
     * Include deleted sources in the returned results.
     */
    public ListSourcesRequest withIncludeDeleted(Optional<Boolean> includeDeleted) {
        Utils.checkNotNull(includeDeleted, "includeDeleted");
        this.includeDeleted = includeDeleted;
        return this;
    }
     ...
     * Set the limit on the number of sources returned. The default is 20.
     */
    public ListSourcesRequest withLimit(Optional<Integer> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * Set the offset to start at when returning sources. The default is 0
     */
    public ListSourcesRequest withOffset(Optional<Integer> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }
     ...
     * workspaces.
     */
    public ListSourcesRequest withWorkspaceIds(List<String> workspaceIds) {
        Utils.checkNotNull(workspaceIds, "workspaceIds");
     ...
     * workspaces.
     */
    public ListSourcesRequest withWorkspaceIds(Optional<? extends List<String>> workspaceIds) {
        Utils.checkNotNull(workspaceIds, "workspaceIds");
        this.workspaceIds = workspaceIds;
        return this;
    }
