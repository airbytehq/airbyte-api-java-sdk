...
<!-- UsageSnippet language="java" operationID="createDeclarativeSourceDefinition" method="post" path="/workspaces/{workspaceId}/definitions/declarative_sources" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (res.declarativeSourceDefinitionResponse().isPresent()) {
            System.out.println(res.declarativeSourceDefinitionResponse().get());
        }
    }
}
```
...
<!-- UsageSnippet language="java" operationID="deleteDeclarativeSourceDefinition" method="delete" path="/workspaces/{workspaceId}/definitions/declarative_sources/{definitionId}" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="getDeclarativeSourceDefinition" method="get" path="/workspaces/{workspaceId}/definitions/declarative_sources/{definitionId}" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="listDeclarativeSourceDefinitions" method="get" path="/workspaces/{workspaceId}/definitions/declarative_sources" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (res.declarativeSourceDefinitionsResponse().isPresent()) {
            System.out.println(res.declarativeSourceDefinitionsResponse().get());
        }
    }
}
```
...
<!-- UsageSnippet language="java" operationID="updateDeclarativeSourceDefinition" method="put" path="/workspaces/{workspaceId}/definitions/declarative_sources/{definitionId}" -->
```java
package hello.world;
