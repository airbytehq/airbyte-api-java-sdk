...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DestinationCreateRequest req = DestinationCreateRequest.builder()
                .configuration(DestinationConfiguration.of(DestinationDynamodb.builder()
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchDestinationRequest req = PatchDestinationRequest.builder()
                ...
                .destinationPatchRequest(DestinationPatchRequest.builder()
                    .configuration(DestinationConfiguration.of(DestinationDevNull.builder()
                        .testDestination(TestDestination.of(Throttled.builder()
                            .millisPerRecord(415622L)
                            .build()))
                        .build()))
                    .name("My Destination")
                    .build())
