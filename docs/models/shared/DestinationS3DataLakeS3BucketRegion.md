...
```java
import com.airbyte.api.models.shared.DestinationS3DataLakeS3BucketRegion;

DestinationS3DataLakeS3BucketRegion value = DestinationS3DataLakeS3BucketRegion.UNKNOWN;
```
