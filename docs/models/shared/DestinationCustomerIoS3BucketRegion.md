...
```java
import com.airbyte.api.models.shared.DestinationCustomerIoS3BucketRegion;

DestinationCustomerIoS3BucketRegion value = DestinationCustomerIoS3BucketRegion.UNKNOWN;
```
