...
SourceGoogleAnalyticsDataApiSchemasCustomReportsArrayMetricFilterValidEnums value = SourceGoogleAnalyticsDataApiSchemasCustomReportsArrayMetricFilterValidEnums.OPERATION_UNSPECIFIED;
```
