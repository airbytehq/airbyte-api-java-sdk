...
```java
import com.airbyte.api.models.shared.SourceFacebookMarketingValidActionBreakdowns;

SourceFacebookMarketingValidActionBreakdowns value = SourceFacebookMarketingValidActionBreakdowns.ACTION_CANVAS_COMPONENT_NAME;
```
