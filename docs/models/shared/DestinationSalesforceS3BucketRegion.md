...
```java
import com.airbyte.api.models.shared.DestinationSalesforceS3BucketRegion;

DestinationSalesforceS3BucketRegion value = DestinationSalesforceS3BucketRegion.UNKNOWN;
```
