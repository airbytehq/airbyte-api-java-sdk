...
```java
import com.airbyte.api.models.shared.DefinitionOfConversionCountInReports;

DefinitionOfConversionCountInReports value = DefinitionOfConversionCountInReports.CLICK_VIEW_TIME;
```
