...
SourceFacebookMarketingValidEnums value = SourceFacebookMarketingValidEnums.ACCOUNT_CURRENCY;
```
...
| `PRODUCT_CUSTOM_LABEL0`                                                | product_custom_label_0                                                 |
| `PRODUCT_CUSTOM_LABEL1`                                                | product_custom_label_1                                                 |
| `PRODUCT_CUSTOM_LABEL2`                                                | product_custom_label_2                                                 |
| `PRODUCT_CUSTOM_LABEL3`                                                | product_custom_label_3                                                 |
| `PRODUCT_CUSTOM_LABEL4`                                                | product_custom_label_4                                                 |
