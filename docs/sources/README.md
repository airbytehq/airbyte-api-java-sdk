...
import com.airbyte.api.models.shared.SourceHubspotCredentialsOAuthCredentials;
import com.airbyte.api.models.shared.SourceHubspotCredentialsPrivateApp;
import com.airbyte.api.models.shared.SourceHubspotCredentialsPrivateAppCredentials;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            com.airbyte.api.models.shared.SourceCreateRequest req = new SourceCreateRequest(                new SourceGreenhouse("totam", SourceGreenhouseGreenhouse.GREENHOUSE) {{
                                apiKey = "repellendus";
                                sourceType = SourceGreenhouseGreenhouse.GREENHOUSE;
